<table class="content-layout-edit">
    ...
    <tr>
        <td id="widget_col_1" class="content-area" style="width: 33%">
        ...
        <td id="widget_col_2" class="content-area" style="width: 33%">
        ...
        <td id="widget_col_3" class="content-area" style="width: 33%">
