<table class="content-layout-edit">
    ...
    <tr>
        <td id="widget_col_1" class="content-area" style="width: 50%">
    ...
    <tr>
        <td id="widget_col_4" class="content-area" style="width: 50%">
        ...
        <td id="widget_col_5" class="content-area" style="width: 50%">
    ...
    <tr>
        <td id="widget_col_6" class="content-area" colspan="2">
    ...
    <tr>
        <td id="widget_col_7" class="content-area" style="width: 50%">
        ...
        <td id="widget_col_8" class="content-area" style="width: 50%">
    ...
    <tr>
        <td id="widget_col_9" class="content-area" colspan="2">
