...
<form class="z-form" action="{modurl modname='IWusers' type='admin' func='deleteUsers'}" method="post" enctype="application/x-www-form-urlencoded">
    <div>
        ...
        {foreach from=$users item='user' key='key' name='users'}
            ...
            <div class="z-formrow">
                ...
                <span><strong>{$user.uname|safetext}</strong>&nbsp;&nbsp;({$user.email|safetext})</span>
            </div>
        ...
        <div class="z-formbuttons z-buttons">
            ...
            <a class="z-btred" href="{modurl modname='IWusers' type='admin' func='main'}" title="{gt text='Cancel'}">{img modname='core' src='button_cancel.png' set='icons/extrasmall' __alt='Cancel' __title='Cancel'} {gt text='Cancel'}</a>
        </div>
    </div>
</form>
{adminfooter}
