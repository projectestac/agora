...
class Pages_Controller_User extends Zikula_AbstractController
{
    ...
    public function view($args)
    {
        ...
        $this->view->setCacheId("$cat|$startnum");
    ...
    public function display($args)
    {
        ...
        if (isset($pageid)) {
            $this->view->setCacheId($pageid.'|'.$page);
        ...
        // Get the page
        if (isset($pageid)) {
            $item = ModUtil::apiFunc('Pages', 'user', 'get', array('pageid' => $pageid, 'parse' => true, 'catregistry' => (isset($catregistry)) ? $catregistry : null));
        } else {
            $item = ModUtil::apiFunc('Pages', 'user', 'get', array('title' => $title, 'parse' => true, 'catregistry' => (isset($catregistry)) ? $catregistry : null));
