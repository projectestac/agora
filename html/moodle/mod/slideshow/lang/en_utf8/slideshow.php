<?PHP // $Id: slideshow.php,v 1.1.2.2 2010/09/01 21:00:03 arborrow Exp $ 
...
$string['keeporiginals'] = 'If originals are to be kept, the original image will be copied to a separate folder if it is resized. Otherwise only the resized version of the image is kept and server space is maximised.';
...
//for mod_form.php
$string['header_slideshow'] = 'Slideshow settings';
//************ FI
?>
