...
//unit
        ...
        if (ajaxenabled()){
  	        $attrs = array('onchange' => 'javascript:rcontent_load_activity_list(YAHOO.util.Dom.get("id_isbn").value,this.value)');
        }else{
  	        $attrs = array('onchange' => 'javascript:this.form.issubmit.value=0;this.form.submit()');
        }
...
//-----------------------------------------------------------------------------
//Other settings 
        $mform->addElement('header', 'displaysettings', get_string('display', 'rcontent'));
      
// What Grade
        $mform->addElement('select', 'whatgrade', get_string('whatgrade', 'rcontent'), rcontent_get_what_grade_array());
        $mform->setHelpButton('whatgrade', array('whatgrade', get_string('whatgrade', 'rcontent'), 'rcontent'));
...
//forcedownload
        ...
        $mform->setHelpButton('forcedownload', array('forcedownload', get_string('forcedownload', 'rcontent'), 'resource'));
...
//keepnavigationvisibleorno
        ...
        $mform->setHelpButton('framepage', array('frameifpossible', get_string('keepnavigationvisible', 'rcontent'), 'rcontent'));
