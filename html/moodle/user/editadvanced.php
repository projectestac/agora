<?php // $Id: editadvanced.php,v 1.21.2.12 2008/12/22 03:16:51 tjhunt Exp $
    ...
    if ($usernew = $userform->get_data()) {
        ...
        //XTEC ************ AFEGIT - To solve the problem with city length
		//2010.07.07 @pferre22
		if (strlen($usernew->city)>=17) {
			$textlib = textlib_get_instance();
            $usernew->city = $textlib->specialtoascii($usernew->city);
			$usernew->city = substr($usernew->city, 0, 20);
		}
		//************ FI
