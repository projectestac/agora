<?PHP // $Id: attforblock.php,v 1.9 2010/07/20 19:44:47 mits Exp $ 
...
$string['indetail'] = '詳細 ...';
$string['moduledescription'] = 'あなたは1コースあたり1つの出欠モジュールのみ追加することができます。<br />このモジュールを削除したとしても、データが削除されるわけではありません!';
...
$string['notfound'] = 'このコースには出欠活動はありません!';
$string['olddate'] = '古い出欠日';
$string['period'] = '頻度';
$string['remarks'] = '備考';
$string['report'] = 'レポート';
$string['resetdescription'] = '出欠を削除することで、データベースから情報が削除されることに留意してください。あなたはコースの開始日を変更することで、古いセッションを隠すことができます!';
...
$string['sessionalreadyexists'] = 'この日にはすでにセッションが追加されています。';
