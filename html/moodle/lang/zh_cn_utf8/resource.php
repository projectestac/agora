<?PHP // $Id$ 
      // resource.php - created with Moodle 1.9.5 (Build: 20090520) (2007101550)
...
$string['configallowlocalfiles'] = '允许在创建新文件资源时使用指向本地文件系统的链接，如光驱或者硬盘。这对于学生都在一个教室内访问网络驱动器或 CD 上的文件是很有用出的。是用这个功能可能要修改您的浏览器的安全设置。';
...
$string['keepnavigationvisibleno'] = '不用';
$string['keepnavigationvisibleyesframe'] = '是的，通过页框显示';
$string['keepnavigationvisibleyesobject'] = '是的，不通过页框显示';
$string['localfile'] = '本地文件';
$string['localfilechoose'] = '选择一个本地文件(CD-ROM)';
$string['localfilehelp'] = '帮助显示本地文件';
$string['localfileinfo'] = '<p>从您的计算机上选择一个本地文件。这个文件将不会被上传到 Web 站点上，但 Moodle 会在想要浏览此资源的的计算机的同样位置寻找它。</p><p>当您有很大的多媒体文件存储在 CD-ROM 并发给参与者时，这个功能是很有用的。每个参与者都可以通过<a href=\"{$a}\" target=\"_blank\">修改个人信息</a>来选择他自己的本地路径。</p>';
