...
$string['customtitles'] = 'Без заголовков';
...
$string['importing'] = 'Импортирование';
$string['importingchapters'] = 'Импортирование глав в книгу';
...
$string['printedby'] = 'Напечатана';
$string['relinking'] = 'Преобразование ссылок';
$string['subchapter'] = 'Подглава';
$string['toc'] = 'Содержание';
$string['tocwidth'] = 'Выберите ширину Содержания для всех книг';
$string['top'] = 'наверх';
