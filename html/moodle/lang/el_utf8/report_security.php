...
$string['check_courserole_anything'] = 'Η ικανότητα \\"doanything\\" δεν θα πρέπει να επιτρέπεται σε αυτό το <a href=\\"$a\\">πλαίσιο</a>.';
$string['check_courserole_details'] = '<p>Κάθε μάθημα έχει καθορισμένο έναν προεπιλεγμένο ρόλο εγγραφής. Παρακαλούμε εξασφαλίστε οτι δεν επιτρέπονται ριψοκίνδυνες ικανότητες για αυτό το ρόλο.</p>
<p>Ο μόνος απαρχαιωμένος τύπος που επιτρέπεται για τον προεπιλεγμένο ρόλο μαθήματος είναι ο <em>Μαθητής</em>.</p>';
$string['check_courserole_error'] = 'Εντοπίστηκαν λάθος ορισμένοι προεπιλεγμένοι ρόλοι μαθήματος!';
$string['check_courserole_name'] = 'Προεπιλεγμένοι ρόλοι (μαθήματα)';
$string['check_courserole_notyet'] = 'Χρήση μόνο προεπιλεγμένων ρόλων μαθήματος.';
$string['check_courserole_ok'] = 'Οι ορισμοί των προεπιλεγμένων ρόλων μαθήματων είναι εντάξει.';
$string['check_courserole_risky'] = 'Εντοπίστηκαν ριψοκίνδυνες ικανότητες στο <a href=\\"$a\\">πλαίσιο</a>.';
$string['check_courserole_riskylegacy'] = 'Εντοπίστηκε ριψοκίνδυνος απαρχαιωμένος τύπος στο <a href=\\"$a->url\\">$a->shortname</a>.';
$string['check_defaultcourserole_anything'] = 'Η ικανότητα \\"doanything\\" δεν θα πρέπει να επιτρέπεται σε αυτό το <a href=\\"$a\\">πλαίσιο</a>.';
$string['check_defaultcourserole_details'] = '<p>Ο προεπιλεγμένος ρόλος μαθητή για εγγραφή στα μαθήματα καθορίζει τον προεπιλεγμένο ρόλο για τα μαθήματα. Παρακαλούμε εξασφαλίστε οτι δεν επιτρέπονται ριψοκίνδυνες ικανότητες για αυτό το ρόλο.</p>
<p>Ο μόνος απαρχαιωμένος τύπος που επιτρέπεται για τον προεπιλεγμένο ρόλο είναι ο <em>Μαθητής</em>.</p>';
$string['check_defaultcourserole_error'] = 'Εντοπίστηκαν λάθος ορισμένοι προεπιλεγμένοι ρόλοι μαθήματος \\"$a\\"!';
$string['check_defaultcourserole_legacy'] = 'Εντοπίστηκε ριψοκίνδυνος απαρχαιωμένος τύπος.';
$string['check_defaultcourserole_name'] = 'Προεπιλεγμένος ρόλος μαθήματος (γενικά)';
$string['check_defaultcourserole_notset'] = 'Ο προεπιλεγμένος ρόλος δεν έχει οριστεί.';
$string['check_defaultcourserole_ok'] = 'Ο ορισμός του προεπιλεγμένου ρόλου για τον ιστοχώρο είναι εντάξει.';
$string['check_defaultcourserole_risky'] = 'Εντοπίστηκαν ριψοκίνδυνες ικανότητες στο <a href=\\"$a\\">πλαίσιο</a>.';
...
$string['issue'] = 'Θέμα';
$string['reportsecurity'] = 'Επισκόπηση ασφάλειας';
