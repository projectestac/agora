...
/// and configure some other specific variables for each db BEFORE attempting the connection
    ...
    // XTEC ************** AFEGIT - Registre d'errors d'ADODB
	// 2011.04.06 @aginard
...
/// Load up standard libraries
    ...
    //XTEC ************ AFEGIT - To add Agora functions
    require_once($CFG->libdir .'/agora.php');        // Agora specific functions
	//************ FI
...
/// Set up session handling
    if(empty($CFG->respectsessionsettings)) {
        if (empty($CFG->dbsessions)) {   /// File-based sessions
			...
			//XTEC ************ ELIMINAT - To save sessions in application server
			//2010.11.10 @sarjona
			/* 
