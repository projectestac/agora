    ...
    this.toolbar = [
        ...
        [ "justifyleft", "justifycenter", "justifyright", "justifyfull", "separator",
          ...
          "insertimage", "inserttable",
			...
			//2010.07.01
			"insertdragmath", "insertsmile", "insertchar", "search_replace",
			//************ ORIGINAL
...
//XTEC ************ AFEGIT - DragMath Plugin
//2010.07.01 - Moodle hack - insertdragmath
HTMLArea.prototype._insertDragMath = function() {
    ...
    var range = this._createRange(sel);
    var editor = this;  // for nested functions
    this._popupDialog("dlg_ins_dragmath.php?id=<?php echo $id; ?>", function(imgString) {
        if(!imgString) {
            return false;
        }
        if (HTMLArea.is_ie) {
...
HTMLArea.prototype._searchReplace = function() {
	...
	//XTEC ************ MODIFICAT - searchnotfound quotation problem
	//2010.07.01
...
//XTEC ************ MODIFICAT - DragMath Plugin
