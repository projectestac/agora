...
//************ FI
    ...
    //XTEC ****************** AFEGIT - To add "Clean backups" option
    //2011.08.03 @fcasanel
    $ADMIN->add('courses', new admin_externalpage('clean_backup', get_string('clean_backup','backup'), $CFG->wwwroot.'/backup/clean_backup.php'));
