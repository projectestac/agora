...
//XTEC ************ AFEGIT - Impedeix que es pugui accedir a les dades de connexió amb les bases de dades de les intranet
//2010.06.30
if($_REQUEST['auth']=='db' && is_agora()){
	header('location:settings.php?section=manageauths');
}
//************ FI
