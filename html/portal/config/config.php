...
$ZConfig['DBInfo']['databases']['default']['user']        = $agora['admin']['username'];
$ZConfig['DBInfo']['databases']['default']['password']    = $agora['admin']['userpwd'];
$ZConfig['DBInfo']['databases']['default']['dbname']      = $agora['admin']['database'];
