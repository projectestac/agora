        ...
        <div class="panel-body">
            <form class="form-inline form-inline-multiline" name="filterForm" id="filterForm">
                <div class="form-group">
                    <label for="actionCode">{gt text="Cerca per tipus d'acció"}</label>
                ...
                <div class="form-group">
                    <label for="from_inpt">{gt text="Cerca per data"}</label>
                    {gt text="des de: "}
                ...
                {if $isAdmin}
                    <div class="form-group">
                        <label for="uname">{gt text="Cerca per nom d'usuari"}</label>
