...
<form class="form-horizontal" enctype="application/x-www-form-urlencoded" method="post" id="editRequestType" action="{modurl modname='Agoraportal' type='admin' func='editRequestType'}" onsubmit="return sendEditRequestType();">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input class="form-control" id="requestTypeName" type="text" name="requestTypeName" size="100" maxlength="150" value="{$requestType->name}"/>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-4 control-label" for="requestTypeDescription">{gt text="Descripció del Tipus de sol·licitud"}:</label>
        <div class="col-sm-8">
            <textarea class="form-control" id="requestTypeDescription" cols="50" rows="3" name="requestTypeDescription">{$requestType->description}</textarea>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea class="form-control" id="requestTypeUserCommentsText" cols="50" rows="3" name="requestTypeUserCommentsText">{$requestType->userCommentsText}</textarea>
        </div>
    </div>
