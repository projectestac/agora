...
<ul class="nav nav-tabs">
    <li {if $action eq 'uploadFiles'}class="active"{/if}>
        <a data-toggle="tab" href="{modurl modname='Agoraportal' type='user' func='files' action='uploadFiles' clientCode=$client->clientCode}" >{gt text="Puja un fitxer"}</a>
    </li>
    <li {if $action eq 'm2x'}class="active"{/if}>
        <a data-toggle="tab" href="{modurl modname='Agoraportal' type='user' func='files' action='m2x' clientCode=$client->clientCode}">{gt text="Llista de fitxers"}</a>
    </li>
</ul>
...
<div class="tab-content">
    ...
    <div id="uploadFiles">
        <h3>{gt text="Enviament de fitxers grans al repositori de Moodle"}</h3>
        ...
        {if $service->disk_percentage < 100}
            ...
            <div class="alert alert-info">
                ...
                <ul>
                    <li>{gt text="Només s'admeten fitxers comprimits en format ZIP i MBZ que tinguin una mida compresa entre 10 i 350 MB."}</li>
    ...
    {if $action eq 'm2x'}
    <div id="m2x">
        <h3>{gt text="Llistat de fitxers"}</h3>
        <span id="reload"></span>
