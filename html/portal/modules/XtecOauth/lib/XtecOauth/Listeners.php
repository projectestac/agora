...
class XtecOauth_Listeners
{
    ...
    /**
     * Log in user via oAuth after the Zikula authentication has failed and create it if necessary
     *
     * @param Zikula_Event $event
     * @return bool true authentication successful
     ...
     * @author Toni Ginard
     */
    public static function tryXtecOauthListener(Zikula_Event $event)
    {
        ...
        if (XtecOauth_Listeners::isUserSchool($uname)) {
        ...
        if (!XtecOauth_Listeners::createClient(
            array(
                'uname' => $uname,
                'uid' => $uid,
