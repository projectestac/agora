...
if($GLOBALS['PNConfig']['Multisites']['multi'] == 1){
    $folderPath = $GLOBALS['PNConfig']['Multisites']['filesRealPath'] . '/' . $GLOBALS['PNConfig']['Multisites']['siteFilesFolder'] . '/';
} else {
...
$fileNameNoPath = substr($fileName, $pos - strlen($fileNameGet) + 1);
...
header("Content-Disposition: inline; filename=$fileNameNoPath");
