 ...
 * @version $Id: menu.php 27230 2009-10-27 17:29:53Z mateo $
 ...
 */
function Blocks_menublock_init()
{
    // Security
 ...
 */
function Blocks_menublock_info()
{
    return array('module' => 'Blocks',
                 'text_type' => __('Menu'),
                 'text_type_long' => __('Menu block'),
                 'allow_multiple' => true,
                 'form_content' => false,
                 'form_refresh' => false,
                 'show_preview' => true,
 ...
 */
function Blocks_menublock_display($blockinfo)
{
    // security check
 ...
 */
function blocks_menu_addMenuItem($title, $url, $comment)
{
    static $uri;
 ...
 */
function Blocks_menublock_update($blockinfo)
{
