 ...
 * @version $Id: topics.php 9 2008-11-05 21:42:16Z Guite $
 ...
 *
 */
function stats_pluginapi_topics()
{
    // Security check
    ...
    // execute the query
    $result = $dbconn->Execute("SELECT count(*) AS count FROM $pntable[topics]");
    ...
    $pnRender->assign(array('image' => 'topics.gif', 'string' => __('Active topics:', $dom), 'value' => $count));
