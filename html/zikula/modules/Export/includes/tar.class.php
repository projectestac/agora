...
class tar {
	...
	function addFile($filename, $filename_dest) {
		// Make sure the file we are adding exists!
		if(!file_exists($filename))
			return false;
		
		// If the filename in the tar file is not defined, take the current filename	
		if(!isset($filename_dest)) $filename_dest = $filename;
