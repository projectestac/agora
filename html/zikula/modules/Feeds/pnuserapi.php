 ...
 */
function Feeds_userapi_getall($args)
{
    // Optional arguments.
 ...
 */
function Feeds_userapi_get($args)
{
    // optional arguments
 ...
 */
function Feeds_userapi_countitems($args)
{
    $args['catFilter'] = array();
    if (isset($args['category']) && !empty($args['category'])){
        if (is_array($args['category'])) { 
 ...
 */
function Feeds_userapi_getfeed($args)
{
    // Argument check
    if ((!isset($args['fid']) || !is_numeric($args['fid']))
 ...
 */
function Feeds_userapi_encodeurl($args)
{
 ...
 */
function Feeds_userapi_decodeurl($args)
{
 ...
 */
function Feeds_userapi_getmodulemeta()
{
