...
function iw_moodle_pntables()
{
    // Initialise table array
	$pntable = array();
		
	// iw_webbox table definition
	$pntable['iw_moodle'] = DBUtil::getLimitedTablename('iw_moodle');
	$pntable['iw_moodle_column'] = array('mid' => 'iw_mid',
						'mcid' => 'iw_mcid',
						'uid' => 'iw_uid',
						'role' => 'iw_role');

	$pntable['iw_moodle_column_def'] = array('mid' => "INT(11) NOTNULL AUTOINCREMENT KEY",
...
*/
	...
	ObjectUtil::addStandardFieldsToTableDefinition ($pntable['iw_moodle_column'], 'pn_');
	ObjectUtil::addStandardFieldsToTableDataDefinition($pntable['iw_moodle_column_def'], 'iw_');
