...
$files[] = array('filename' => $agora['server']['root'] . $agora['intranet']['datadir'] . $agora['intranet']['diskusagefile'], 'perms' => 0640, 'link' => false,
    'message' => 'Error a la informació de disc de les intranets o el cron no funciona', 'old' => 86400);
$files[] = array('filename' => $agora['server']['root'] . $agora['moodle2']['datadir'] . $agora['moodle2']['diskusagefile'], 'perms' => 0640, 'link' => false,
    'message' => 'Error a la informació de disc dels Moodles o el cron no funciona', 'old' => 86400);
$files[] = array('filename' => $agora['server']['root'] . $agora['nodes']['datadir'] . $agora['nodes']['diskusagefile'], 'perms' => 0640, 'link' => false,
    'message' => 'Error a la informació de disc dels nodes o el cron no funciona', 'old' => 86400);
$files[] = array('filename' => $agora['server']['root'] . 'adminInfo/cronIntranet.txt', 'perms' => 0640, 'link' => false,
    'message' => 'Error als crons de la intranet', 'old' => 86400);
$files[] = array('filename' => $agora['server']['root'] . 'adminInfo/cronMoodle2.txt', 'perms' => 0640, 'link' => false,
