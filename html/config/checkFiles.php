...
$fixcacheconfig = isset($_GET['fixcacheconfig']);
...
$files[] = array('filename' => $agora['server']['root'] . 'html/config/sync-config.sh', 'perms' => 0750, 'link' => false, 'message' => 'Error al cron de l\'allschools');
$files[] = array('filename' => $agora['server']['root'] . 'html/config/sync.sh', 'perms' => 0750, 'link' => false, 'message' => 'Error al cron de l\'allschools');
$files[] = array('filename' => $agora['server']['root'] . 'html/moodle2/config.php', 'perms' => 0640, 'link' => false, 'message' => 'Error en la configuració dels Moodle');
$files[] = array('filename' => $agora['server']['root'] . 'html/moodle2/filter/tex/mimetex.linux', 'perms' => 0750, 'link' => false, 'message' => 'El filtre Latex a Moodle no funcionarà');
$files[] = array('filename' => $agora['server']['root'] . 'html/moodle2/local/agora/muc/', 'perms' => 0770, 'link' => false, 'message' => 'Error en la caché de Moodle');
$files[] = array('filename' => $agora['server']['root'] . 'html/moodle2/local/agora/muc/cacheconfig.php', 'perms' => 0660, 'link' => false, 'message' => 'Error en la caché de Moodle');
$files[] = array('filename' => $agora['server']['root'] . 'html/wordpress/.htaccess', 'perms' => 0640, 'link' => false, 'message' => 'Error en la configuració dels nodes');
$files[] = array('filename' => $agora['server']['root'] . 'html/wordpress/wp-config.php', 'perms' => 0640, 'link' => false, 'message' => 'Error en la configuració dels nodes');
$files[] = array('filename' => $agora['server']['root'] . 'html/wordpress/wp-content/uploads', 'perms' => 0770, 'link' => true, 'message' => 'Error als fitxers de dades de nodes');
...
function comparePermissions($perms, $expectedperms) {
    ...
    $fileperms = [];
    $fileperms['ur'] = (bool)(($perms & 0x0100));
    $fileperms['uw'] = (bool)(($perms & 0x0080));
    $fileperms['ux'] = (bool)(($perms & 0x0040));
    $fileperms['gr'] = (bool)(($perms & 0x0020));
    $fileperms['gw'] = (bool)(($perms & 0x0010));
    $fileperms['gx'] = (bool)(($perms & 0x0008));
    $fileperms['or'] = (bool)(($perms & 0x0004));
    $fileperms['ow'] = (bool)(($perms & 0x0002));
    $fileperms['ox'] = (bool)(($perms & 0x0001));

    $expected = [];
    $expected['ur'] = (bool)(($expectedperms & 0x0100));
    $expected['uw'] = (bool)(($expectedperms & 0x0080));
    $expected['ux'] = (bool)(($expectedperms & 0x0040));
    $expected['gr'] = (bool)(($expectedperms & 0x0020));
    $expected['gw'] = (bool)(($expectedperms & 0x0010));
    $expected['gx'] = (bool)(($expectedperms & 0x0008));
    $expected['or'] = (bool)(($expectedperms & 0x0004));
    $expected['ow'] = (bool)(($expectedperms & 0x0002));
    $expected['ox'] = (bool)(($expectedperms & 0x0001));
...
function getPermissionsString($perms): string {
