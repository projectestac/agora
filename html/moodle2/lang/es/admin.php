...
/**
 * Strings for component 'admin', language 'es', branch 'MOODLE_24_STABLE'
 *
 * @package   admin
...
$string['manageformats'] = 'Hay {$a->count} cursos que usan {$a->format}. Sus formatos serán cambiados a {$a->defaultformat} (el formato por defecto para este sitio). Algunos datos específicos de este formato se pueden perder. ¿Está Usted seguro de querer hacerlo?';
