...
$string['feedback:addinstance'] = 'Añadir nueva retroalimentación';
...
$string['modulename_help'] = 'El módulo de actividad de retroalimentación permite que un profesr pueda personalizar la retroalimentación de los participantes utilizando una variedad de tipos de preguntas como opción múltiple, V/F o entrada de texto.

Los comentarios de retroalimentación pueden ser anónimos si así lo desea, y los resultados se pueden mostrar a todos los participantes o estar restringidos sólo los profesores. Las actividades de retroalimentación en la página principal del sitio también pueden ser realizadas por usuarios no registrados.

Las Actividades de retroalimentación se puede usar

* Para las evaluaciones del curso, ayudando a mejorar el contenido para  los participantes posteriores
 * Permitir a los participantes inscribirse en los módulos del curso, eventos, etc
* Para las encuestas de invitados sobre la elección de cursos, las políticas escolares, etc
* Para encuesta anti acoso en las que los estudiantes pueden reportar incidentes de forma anónima';
