...
/**
 * Strings for component 'qformat_xml', language 'es', branch 'MOODLE_23_STABLE'
 *
 * @package   qformat_xml
...
$string['xmltypeunsupported'] = 'El tipo de pregunta {$a} no es soportado por la importación a XML';
