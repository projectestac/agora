...
$string['enabled_help'] = 'Si está activado, el profesor podrá crear archivos pdf editando el entregado por el alumno. El profesor podrá añadir comentarios, dibujos y sellos directamente sobre el trabajo de los estudiantes. La Anotación se realiza en el navegador y no se requiere ningún software adicional.';
...
$string['jsrequired'] = 'Para realizar anotaciones en documentos PDF se requiere javascript. Por favor, active javascript en su navegador para poder utilizar esta función.';
