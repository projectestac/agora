...
/**
 * Strings for component 'assign', language 'sv', branch 'MOODLE_24_STABLE'
 *
 * @package   assign
...
$string['defaultplugins'] = 'Förvalda inställningar för inlämningsuppgift';
$string['defaultplugins_help'] = 'Dessa inställningar anger vad som är förvalt för alla nya inlämningsuppgifter.';
$string['defaultteam'] = 'Förvald grupp';
$string['deleteallsubmissions'] = 'Ta bort alla inlämningar';
$string['deletepluginareyousure'] = 'Ta bort insticksmodul för inlämningsuppgift {$a}: är du säker?';
$string['deletepluginareyousuremessage'] = 'Du håller på att totalt ta bort insticksmodulen för inlämningsuppgift {$a}. Detta kommer att radera allt i databasen som associeras med denna insticksmodul. Är du SÄKER på att du vill fortsätta?';
$string['deletingplugin'] = 'Tar bort insticksmodul {$a}.';
...
$string['gradingstudentprogress'] = 'Betygssätter elev {$a->index} av {$a->count}';
...
$string['requiresubmissionstatementassignment'] = 'Kräv att elever godkänner inlämningsförsäkran';
$string['requiresubmissionstatementassignment_help'] = 'Kräv att eleverna accepterar inlämningsförsäkran för alla inlämningar till denna inlämningsuppgift.';
...
$string['unlocksubmissionforstudent'] = 'Tillåt inlämning för elev: (id={$a->id}, fullt namn={$a->fullname}).';
