...
/**
 * Strings for component 'enrol', language 'sv', branch 'MOODLE_24_STABLE'
 *
 * @package   enrol
...
$string['expirynotify_help'] = 'Denna inställning avgör om meddelande om registreringens utgång ska sändas.';
...
$string['manageenrols'] = 'Hantera registrerings-plugin';
...
$string['rolefrommetacourse'] = '{$a->role} (ärvd från förälderkurs)';
$string['rolefromsystem'] = '{$a->role} (Tilldelad på site nivå)';
$string['rolefromthiscourse'] = '{$a->role} (Tilldelad på site nivå)';
$string['startdatetoday'] = 'I dag';
...
$string['uninstallconfirm'] = 'Du håller på att avinstallera insticksmodulen för registrering \'{$a}\'. Detta kommer innebära att all data som associeras med denna registreringstyp raderas, inklusive användarnas betyg, gruppmedlemskap, forumprenumerationer och all annan kursrelaterad data.

Är du SÄKER på att du vill fortsätta?';
$string['uninstalldelete'] = 'Ta bort alla registreringar och avinstallera';
$string['uninstalldeletefiles'] = 'All data associerad med insticksmodulen för registrering \'{$a->plugin}\' har tagits bort från databasen. För att slutföra borttagningen (och förhindra insticksmodulen från att återinstallera sig själv), ska du nu ta bort denna katalog från din server: {$a->directory}';
$string['uninstallmigrate'] = 'Avinstallera men behåll alla registreringar';
