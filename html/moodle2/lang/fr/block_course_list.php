...
/**
 * Strings for component 'block_course_list', language 'fr', branch 'MOODLE_24_STABLE'
 *
...
$string['course_list:myaddinstance'] = 'Ajouter un bloc cours à la page Mon Moodle';
