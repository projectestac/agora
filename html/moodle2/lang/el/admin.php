...
/**
 * Strings for component 'admin', language 'el', branch 'MOODLE_24_STABLE'
 *
 * @package   admin
...
$string['deletefilterareyousure'] = 'Είστε βέβαιοι ότι θέλετε να διαγράψετε το φίλτρο \'{$a}';
$string['deletefilterareyousuremessage'] = 'Είστε έτοιμοι να διαγράψετε τελείως το φίλτρο \'{$a}\'. Είστε βέβαιοι ότι θέλετε να το απεγκαταστήσετε;';
