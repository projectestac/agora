...
/**
 * Strings for component 'auth_db', language 'el', branch 'MOODLE_26_STABLE'
 *
 * @package   auth_db
...
$string['auth_dbdescription'] = 'Αυτή η μέθοδος χρησιμοποιεί έναν εξωτερικό πίνακα βάσης δεδομένων για να ελέγξει εάν τα δοσμένα όνομα χρήστη και κωδικός πρόσβασης ισχύουν.  Εάν ο λογαριασμός είναι καινούργιος, τότε οι πληροφορίες από άλλα πεδία μπορούν επίσης να αντιγραφούν στο Moodle.';
