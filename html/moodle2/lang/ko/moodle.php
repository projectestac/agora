...
/**
 * Strings for component 'moodle', language 'ko', branch 'MOODLE_24_STABLE'
 *
 * @package   moodle
...
$string['action'] = '동작';
$string['actionchoice'] = '파일 \'{$a}\' 로 무엇을 하시겠습니까?';
$string['actions'] = '동작들';
$string['active'] = '활성';
...
$string['availability_help'] = '이 설정은 강좌목록에 강좌가 나타나도록 할 것인지를 결정합니다. 선생님과 관리자를 제외하고, 일반 사용자는 강좌에 입장할 수 없습니다.';
...
$string['blockdeleteconfirm'] = '\'{$a}\'블록을 완전히 지우려고 합니다. 이 블록과 관계된 모든 것이 데이터베이스에서 완전히 삭제됩니다. 정말 지우시겠습니까?';
$string['blockdeletefiles'] = '\'{$a->block}\' 블록과 관계된 모든 정보가 삭제되었습니다. 삭제를 완료하기 위해(그리고 다시 설치되는 것을 막기위해) 서버에서 {$a->directory} 를 삭제하셔야 합니다.';
$string['blocks'] = '블록';
...
$string['category_help'] = '이 설정은 강좌가 강좌목록에 나타날 범주를 결정합니다.';
...
$string['changesmadereallygoaway'] = '변경된 사항이 있습니다. 변경사항을 잃게 되어도 빠져 나가겠습니까?';
...
$string['coursedisplay_help'] = '본 설정은 전체 강좌를 한 화면에 표시할 것인지 아니면 여러 화면에 표시할 것인지를 정하는 것입니다. 하지만 스콤과 같은 일부 강좌 유형에는 영향을 주지 않습니다.';
$string['coursedisplay_multi'] = '한 페이지에 한 섹션 보기';
$string['coursedisplay_single'] = '한  페이지에 모든 섹션 보임';
...
$string['coursehelpnewsitemsnumber'] = '강좌 홈페이지의 오른쪽 새소식난에 게시될 새소식 항목 수<br/>(0 은 새소식난이 나타나지 않음)';
...
$string['deletechecktype'] = '정말 유형 {$a->type} 를 지우시렵니까?';
$string['deletechecktypename'] = '정말 {$a->type}의 "{$a->name}" 를 지우시렵니까?';
...
$string['dndenabled'] = '끌어다 놓기 가능';
$string['dndenabled_help'] = '여러분 컴퓨터에서 여러개의 파일을 하단 박스에 끌어다 놓으면 업로드 할 수 있습니다.<br />주: 어떤 브라우저에서는 작동하지 않을 수 있습니다.';
$string['dndenabled_inbox'] = '파일을 끌어다 놓아 추가할 수 있음';
$string['dndenabled_insentence'] = '끌어다 놓기 가능';
...
$string['force'] = '강제지정';
$string['forcedmodeinbrackets'] = '{$a} (강제 모드)';
...
$string['grade'] = '성적';
$string['grades'] = '성적';
$string['gravatarenabled'] = '이 사이트는 <a href="http://www.gravatar.com/">Gravatar</a> 가 활성화되어 있습니다. 만일 프로필 사진을 올리지 않으면 무들이 Gravatar에서 여러분의 사진을 자동으로 탑재하려 할 것입니다.';
$string['group'] = '모둠';
...
$string['local'] = '로컬';
$string['localplugindeleteconfirm'] = '로컬 플러그인 \'{$a}\'을 삭제하려고 합니다. 그렇게 하면 이 플러그인과 관련된 모든 데이터베이스가 완전히 제거되고 맙니다. 정말 이 플러그인을 삭제하겠습니까?';
...
$string['makethismyhome'] = '내 기본 홈페이지로 만듬';
...
$string['nameforpage'] = '이 페이지의 이름을 무엇으로 할까요?';
...
$string['orphanedactivities'] = '고립된 활동';
$string['other'] = '기타';
$string['outline'] = '요약';
...
$string['returntomaincoursepage'] = '주 강좌 화면으로 복귀';
...
$string['sections'] = '섹션';
$string['sectionusedefaultname'] = '기본 섹션 이름 사용';
