...
/**
 * Strings for component 'assign', language 'ko', branch 'MOODLE_24_STABLE'
 *
 * @package   assign
...
$string['defaultplugins'] = '기본 과제 설정';
$string['defaultplugins_help'] = '이 설정은 모든 새로운 과제에 대한 기본 설정을 정의합니다.';
$string['defaultteam'] = '기본 모둠';
$string['deleteallsubmissions'] = '모든 제출물 삭제';
$string['deletepluginareyousure'] = '과제 플러그인 {$a} 삭제: 확실합니까?';
$string['deletingplugin'] = '플러그인 {$a} 삭제';
...
$string['gradingstudentprogress'] = '{$a->count} 중 {$a->index} 채점';
...
$string['submitassignment_help'] = '일단 과제가 제출되면 더 이상 변경을 할 수 없습니다.';
