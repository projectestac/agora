...
/**
 * Strings for component 'scorm', language 'ko', branch 'MOODLE_24_STABLE'
 *
 * @package   scorm
...
$string['allowtypeimsrepository'] = 'IMS 콘덴츠 팩키지 유형 활성화';
...
$string['duedate'] = '마감일';
$string['element'] = '요소';
$string['elementdefinition'] = '요소 정의';
$string['enter'] = '입력';
...
$string['hidenav'] = '찾아가기 버튼 감춤';
$string['hidenavdesc'] = '이 환경설정은 찾아가기 버튼을 보이게 할 것인지 숨길 것인지에 대한 기본값을 설정합니다.';
...
$string['interactionscorrectcount'] = '질문에 대한 올바른 결과의 수';
$string['interactionsid'] = '요소의 아이디';
$string['interactionslearnerresponse'] = '학습자 반응';
$string['interactionspattern'] = '올바른 응답의 패턴';
$string['interactionsresponse'] = '학생들의 응답';
$string['interactionsresult'] = '학생의 응답과 맞는 결과에 기반한 결과';
$string['interactionsscoremax'] = '원시 점수의 범위에서 최대 값';
$string['interactionsscoremin'] = '원시 점수의 범위에서 최소값';
$string['interactionssuspenddata'] = '학습자 세션 간 데이터를 저장하고 가져올 공간을 제공하십시요.';
$string['interactionstime'] = '시도가 시작된 시간';
$string['interactionstype'] = '질문 유형';
$string['interactionsweight'] = '가중치가 요소에 부여되었습니다.';
...
$string['lastattempt'] = '마지막으로 완료된 시도';
...
$string['typeimsrepository'] = '로컬 IMS 콘텐츠 저장소';
