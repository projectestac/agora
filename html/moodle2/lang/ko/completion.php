...
/**
 * Strings for component 'completion', language 'ko', branch 'MOODLE_24_STABLE'
 *
 * @package   completion
...
$string['activitiescompleted'] = '활동 이수됨';
$string['activitycompletion'] = '활동 이수';
$string['afterspecifieddate'] = '지정일 이후';
...
$string['completion-alt-auto-enabled'] = '조건 {$a}에 의해 시스템이 항목 완료를 표시합니다.';
$string['completion-alt-auto-fail'] = '완료: {$a} (통과 성적을 획득하지 못함)';
$string['completion-alt-auto-n'] = '완료되지 않음: {$a}';
$string['completion-alt-auto-pass'] = '완료: {$a} (통과 성적 획득)';
$string['completion-alt-auto-y'] = '완료: {$a}';
$string['completion-alt-manual-enabled'] = '학습자는 수동으로 항목 완료를 표시할 수 있습니다: {$a}';
...
$string['completiononunenrolment'] = '등록해지시 완료';
$string['completion-pass'] = '완료됨(통과 성적 얻음)';
$string['completionsettingslocked'] = '이수 설정 잠김';
$string['completionstartonenrol'] = '등록과 동시 이수 추적 시작';
$string['completionstartonenrolhelp'] = '강좌 등록 이후부터  강좌이수완료에 학생의 진도 추적';
$string['completion-title-manual-n'] = '완료로 표시: {$a}';
$string['completion-title-manual-y'] = '완료되지 않음으로 표시: {$a}';
...
$string['fraction'] = '분수';
$string['graderequired'] = '성적이 필요합니다.';
$string['gradexrequired'] = '{$a} 가 필요합니다.';
$string['inprogress'] = '진행 중';
$string['manualcompletionby'] = '수동 완료';
...
$string['overallcriteriaaggregation'] = '전체적인 기준 유형 집합';
$string['pending'] = '유예';
