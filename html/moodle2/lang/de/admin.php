...
$string['allowguestmymoodle'] = 'Zugang für Gäste zu MyMoodle erlauben';
...
$string['cachesessionhelp'] = 'Nutzerspezifischer Cache, der mit der Nutzersession abläuft. Er mindert das Aufblähen des Cache bei Sessions.';
...
$string['configallowguestmymoodle'] = 'Die Funktion erlaubt Gast-Nutzern den Zugriff auf die Seite MyMoodle, andernfalls werden sie auf die Startseite geleitet';
...
$string['configmodchooserdefault'] = 'Soll die Aktivitätenauswahl den Endnutzern als Standardeinstellung gezeit werden?';
...
$string['courselistshortnames_desc'] = 'In der Kursliste werden sowohl die Kurznamen wie auch die vollständigen Namen der Kurse angezeigt. Nach der Aktivierung dieser Einstellung wird der \'courseextendednamedisplay\' Sprachstring verwendet. Sie können dann über die Sprachverwaltung die Anzeige abhängig von der gewählten Sprache anpassen.';
...
$string['googlemapkey3'] = 'Google Maps API V3 Schlüssel';
$string['googlemapkey3_help'] = 'Sie benötigen einen speziellen Schlüssel für die Visualisierung von IP-Adressen durch Google-Maps. Sie erhalten diesen kostenfrei unter: <a href="https://developers.google.com/maps/documentation/javascript/tutorial#api_key" target="_blank">https://developers.google.com/maps/documentation/javascript/tutorial#api_key</a>';
...
$string['modchooserdefault'] = 'Aktivitätenauswahl-Standard';
