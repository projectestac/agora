...
$string['dodeletesite'] = 'Ja, Website entfernen';
$string['donotdeletesite'] = 'Nein, Website behalten!';
...
$string['forcelangsync'] = 'Sprache synchronisieren';
...
$string['help'] = 'Hilfe';
$string['helpmelogin'] = '<p>Die App \'Moodle Mobile\' kann sich nur mit Moodle verbinden, denn der mobile Zugriff durch den Administrator aktiviert wurde.</p>
<p>Wenn Sie sich nicht mit der App bei Ihrem Moodle anmelden können, informieren Sie Ihren Administrator über dieses Problem. Informationen finden Sie in der <a href=\'http://docs.moodle.org/de/Mobile_app\' target=\'_blank\'>Dokumentation zu \'Moodle Mobile\'</a>.
<p>Um die App mit einer Demoinstallation von Moodle zu testen, geben Sie <i>teacher</i> oder <i>student</i> in das Feld <i>URL der Website</i> ein und klicken Sie auf die Taste <b>Hinzufügen</b>.</p>';
...
$string['notificationsnotsupported'] = 'Mitteilungen werden für Android nicht unterstützt.';
...
$string['reportbuginfo'] = 'Tippen Sie auf E-Mail, um einen Fehlerbericht zu senden.<br />Beschreiben Sie das Problem bitte möglichst genau.</b> <br />Debug-Daten werden automatisch angehängt (keine persönlichen Daten!)';
