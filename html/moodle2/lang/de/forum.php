...
$string['forcedreadtracking'] = 'Vorgegebenes Lesetrackings erlauben';
$string['forcedreadtracking_desc'] = 'Diese Option ermöglicht es bei Foren, die Prüfung des Lesestatus für alle Nutzer/innen zu erzwingen. In Kursen mit vielen Foren und Beiträgen wird die Ladezeit der Seite deutlich erhöht, da die Werte für alle Nutzer/innen neu berechnet werden müssen. Nach der Deaktivierung dieser Option wird in jedem Forum, dass zuvor die Lesekennzeichnung erzwungen hat, dies zu einer optionalen Einstellung.';
