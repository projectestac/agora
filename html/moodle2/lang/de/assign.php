...
/**
 * Strings for component 'assign', language 'de', branch 'MOODLE_23_STABLE'
 *
 * @package   assign
...
$string['deletepluginareyousure'] = 'Sind Sie sicher, dass Sie das Plugin \'{$a}\' löschen möchten?';
...
$string['duedate_help'] = 'Zum Abgabetermin wird die Aufgabe fällig. Wenn spätere Abgaben erlaubt sind, wird jede nach diesem Datum eingereichte Abgabe als verspätet markiert.';
...
$string['preventlatesubmissions'] = 'Spätere Abgabe verhindern';
$string['preventlatesubmissions_help'] = 'Mit der Aktivierung verhindern Sie die Abgabe einer Lösung nach dem Abgabetermin. Ist die Option deaktiviert, wird der Abgabetermin veröffentlich, aber eine Abgabe ist weiter möglich. Die Verspätung wird den Trainer/innen angezeigt.';
