...
/**
 * Strings for component 'repository_googledocs', language 'de', branch 'MOODLE_23_STABLE'
 *
...
$string['oauth2upgrade_message_content'] = 'Im Rahmen des Upgrades auf Moodle 2.3 wurde das Moodle Docs Repository Plugin deaktiviert. Zur Re-Aktivierung muß Ihre Seite bei Google registriert werden. Dies ist in der Dokumentation {$a->docsurl} beschrieben. Sie erhalten dann einen Kunden-ID und einen Schlüssel. Damit können Sie alle Google Docs und Picasa Plugins konfigurieren.';
