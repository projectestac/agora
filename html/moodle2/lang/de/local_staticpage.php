...
/**
 * Strings for component 'local_staticpage', language 'de', branch 'MOODLE_24_STABLE'
 *
...
$string['documentlistentryreachable'] = 'Das Dokument wird unter folgender URL bereitgestellt:<br /><strong>{$a}</strong>';
$string['documentlistentryrewrite'] = 'Das Dokument wird unter folgender griffigen URL bereitgestellt (unter der Bedingung, dass Sie die Apache mod_rewrite Regeln wie in der README Datei beschrieben installiert haben):<br /><strong>{$a}</strong>';
