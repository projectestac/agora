...
/**
 * Strings for component 'error', language 'ja', branch 'MOODLE_24_STABLE'
 *
 * @package   error
...
$string['maxareabytes'] = 'このファイルを保存するための十分なスペースがありません。';
...
$string['requirecorrectaccess'] = '無効なURIまたはポートです。';
