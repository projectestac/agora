...
/**
 * Strings for component 'tool_langimport', language 'ja', branch 'MOODLE_24_STABLE'
 *
...
$string['remotelangnotavailable'] = 'Moodleがmoodle.orgに接続できないため、言語パックを自動インストールすることができません。<a href="http://download.moodle.org/langpack/">download.moodle.org/langpack</a>より適切なzipファイルを手動でダウンロードして、{$a} ディレクトリにコピーおよび解凍してください。';
