...
/**
 * Strings for component 'hub', language 'ja', branch 'MOODLE_26_STABLE'
 *
 * @package   hub
...
$string['registeredon'] = 'あなたが登録されているハブ';
...
$string['siteurl_help'] = 'URLはこのサイトのアドレスです。プライバシー設定にてユーザのサイトアドレス閲覧を許可している場合、このURLが使用されます。';
