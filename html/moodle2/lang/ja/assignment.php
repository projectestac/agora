...
$string['helpoffline'] = '<p>このタイプの課題は、Moodleの外で実施される課題に関して有用です。これはウェブサイト上での課題または対面により課される課題を考えることができます。</p>
...
$string['unsupportedsubplugin'] = '現在、課題タイプ「 {$a} 」はサポートされていません。あなたは課題タイプが利用できるまで待つか、課題を削除することができます。';
