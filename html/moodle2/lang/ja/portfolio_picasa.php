...
/**
 * Strings for component 'portfolio_picasa', language 'ja', branch 'MOODLE_24_STABLE'
 *
...
$string['oauth2upgrade_message_content'] = 'Moodle 2.3へのアップグレードの一環として、Picasaポートフォリオプラグインは無効にされました。プラグインを再度有効にするには、クライアントIDおよび秘密鍵を取得するため、ドキュメンテーション「 {$a->docsurl} 」に記述されているように、あなたのサイトをGoogleに登録する必要があります。クライアントIDおよび秘密鍵はすべてのGoogle DocsおよびPicasaプラグイン設定に使用することができます。';
