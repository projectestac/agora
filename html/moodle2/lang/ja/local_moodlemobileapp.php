...
$string['enableautosynccss'] = '追加CSSスタイルシートの同期を有効にする';
$string['enableautosynclang'] = '言語ファイルの同期を有効にする';
$string['enableautosyncws'] = '操作とデータの同期を有効にする';
...
$string['usernamerequired'] = 'ユーザ名がありません';
$string['video'] = 'ビデオ';
