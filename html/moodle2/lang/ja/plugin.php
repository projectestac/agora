...
$string['pluginchecknotice'] = 'このページではアップグレード中、あなたが注意する必要のあるプラグインを表示しています。ハイライトされた項目にはインストールされる予定の新しいプラグイン、アップグレードされる予定の更新プラグイン、そして不明のプラグインを含みます。アドオンもハイライトされています。さらに新しいバージョンのアドオンがあるか確認して、このMoodleアップグレードを続ける前にソースコードの更新をお勧めします。';
