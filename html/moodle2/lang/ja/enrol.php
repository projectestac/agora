...
/**
 * Strings for component 'enrol', language 'ja', branch 'MOODLE_26_STABLE'
 *
 * @package   enrol
...
本当に続けてもよろしいですか?';
$string['deleteinstanceconfirmself'] = 'あなたがこのコースにアクセスできるインスタンス「 {$a->name} 」を本当に削除してもよろしいですか? 続ける場合、あなたをこのコースにアクセスできなくすることは可能です。';
$string['deleteinstancenousersconfirm'] = 'あなたは登録方法「 {$a->name} 」を削除しようとしています。本当に続けてもよろしいですか?';
$string['disableinstanceconfirmself'] = 'あなたがこのコースにアクセスできるインスタンス「 {$a->name} 」を本当に無効にしてもよろしいですか? 続ける場合、あなたをこのコースにアクセスできなくすることは可能です。';
...
$string['instanceeditselfwarningtext'] = 'あなたはこの登録方法により、このコースに登録されています。変更することにより、このコースに対するあなたのアクセスに影響する可能性があります。';
