...
/**
 * Strings for component 'moodle', language 'ja', branch 'MOODLE_24_STABLE'
 *
 * @package   moodle
...
$string['courseuploadlimit'] = 'コースアップロード上限';
$string['create'] = '作成';
...
$string['dndenabled'] = 'ドラッグ＆ドロップ利用可';
$string['dndenabled_help'] = '1つまたはそれ以上のファイルをアップロードするため、あなたのデスクトップからボックスにドラッグ＆ドロップすることができます。注意: この機能はすべてのブラウザで動作するわけではありません。';
$string['dndenabled_inbox'] = 'ここにドラッグ＆ドロップして、ファイルを追加することができます。';
$string['dndenabled_insentence'] = 'ドラッグ＆ドロップ利用可';
...
$string['nameforpage'] = 'このページを何と呼びますか?';
...
$string['resortcoursesbyname'] = 'コース名で並べ替える';
...
$string['returntomaincoursepage'] = 'メインコースページに戻る';
