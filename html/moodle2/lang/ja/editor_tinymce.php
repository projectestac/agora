...
/**
 * Strings for component 'editor_tinymce', language 'ja', branch 'MOODLE_24_STABLE'
 *
...
$string['advanced_dlg:link_is_email'] = 'あなたが入力したURIはメールアドレスのようです。必須の「mailto:」接頭辞を付加しますか？';
$string['advanced_dlg:link_is_external'] = 'あなたが入力したURIは外部リンクのようです。必須の「http://」接頭辞を付加しますか？';
...
$string['advlink_dlg:is_email'] = 'あなたが入力したURIはメールアドレスのようです。必須の「mailto:」接頭辞を付加しますか？';
$string['advlink_dlg:is_external'] = 'あなたが入力したURIは外部リンクのようです。必須の「http://」接頭辞を付加しますか？';
...
$string['customtoolbar_desc'] = 'それぞれの行にはカンマで区切られたボタン名一覧を含みます。グループのセパレータには「|」を使用します。空白行は無視されます。デフォルトのTinyMCEのボタンに関して、<a href="{$a}" target="_blank">{$a}</a>をご覧ください。';
...
$string['subplugindeleteconfirm'] = 'あなたはTinyMCEサブプラグイン「 {$a} 」を完全に削除しようとしています。これにより、このサブプラグインに関連するデータすべてがデータベース内から削除されます。本当に続けてもよろしいですか?';
