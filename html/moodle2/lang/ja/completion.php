...
/**
 * Strings for component 'completion', language 'ja', branch 'MOODLE_24_STABLE'
 *
 * @package   completion
...
$string['completiondependencies'] = '完了依存関係';
...
$string['completionstartonenrol'] = '受講登録時に完了トラッキングを開始する';
...
$string['dependenciescompleted'] = '完了済み依存関係';
