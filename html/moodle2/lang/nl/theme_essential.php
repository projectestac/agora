...
$string['analyticsclean'] = 'Stuur schone URL\'s';
$string['analyticscleandesc'] = 'Deze fantastische eigenschap is gecreëerd door  <a href="https://moodle.org/user/profile.php?id=281671" target="_blank">Gavin Henrick</a> en <a href="https://moodle.org/user/view.php?id=907814" target="_blank">Bas Brands</a> en is in dit thema ingebouwd. In plaats van de standaard Moodle URL\'s, stuurt dit thema mooie URL\'s, die het makkelijk maken de pagina te identificeren en uitgebreide rapportage te ondersteunen. Meer info hierover kan hier <b><a href="http://www.somerandomthoughts.com/blog/2012/04/18/ireland-uk-moodlemoot-analytics-to-the-front/" target="_blank">gevonden worden</a></b>.';
...
$string['analyticsid'] = 'Je tracking ID';
$string['analyticsiddesc'] = 'Voer je tracking ID in. Ziet er meestal zo uit: UA-XXXXXXXX-X';
...
$string['custommenudesc'] = 'Deze instellingen laten je nieuwe dynamische functionaliteit toevoegen aan je aangepaste menu (ook wel een dropdown menu genoemd)';
$string['custommenuheading'] = 'Aangepast menu';
$string['custommenuheadingsub'] = 'Voeg extra functionaliteit toe aan je aangepaste menu.';
...
$string['displaymydashboarddesc'] = 'Toon dashboard van gebruikerslinks in het aangepaste menu';
