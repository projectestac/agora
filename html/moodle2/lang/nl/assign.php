...
$string['alwaysshowdescription_help'] = 'Indien uitgeschakeld, zal de opdrachtbeschrijving slechts zichtbaar worden zijn bij de';
...
$string['overdue'] = '<font color="red">Opdracht te laat ingestuurd door: {$a}</font>';
...
$string['submissionnoteditable'] = 'Leerling kan zijn ingestuurde opdracht niet bewerken';
...
$string['submissionslocked'] = 'Je kunt voor deze opdracht niets insturen';
