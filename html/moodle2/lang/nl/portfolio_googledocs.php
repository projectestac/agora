...
/**
 * Strings for component 'portfolio_googledocs', language 'nl', branch 'MOODLE_24_STABLE'
 *
...
$string['oauth2upgrade_message_subject'] = 'Belangrijke informatie over de Google Docs portfolio plugin';
