...
/**
 * Strings for component 'enrol', language 'eu', branch 'MOODLE_24_STABLE'
 *
 * @package   enrol
...
$string['custominstancename'] = 'Pertsonalizatu adibidearen izena';
$string['defaultenrol'] = 'Gehitu adibidea ikastaro berrietarako';
...
$string['uninstallconfirm'] = '\'{$a}\' matrikulazio-plugina erabat ezabatzekotan zara. Matrikulazio-mota honekin lotutako guztia ezabatuko da datu-basetik honela. ZIUR aurrera egin nahi duzula?';
$string['uninstalldelete'] = 'Ezabatu matrikulazio guztiak eta desinstalatu';
$string['uninstalldeletefiles'] = '\'{$a->plugin}\' matrikulazio-pluginarekin lotutako datu guztiak ezabatu dira datu-basetik. Ezabaketa osatzeko (eta plugina berez berriz instala ez dadin) zure zerbitzaritik ondorengo direktorioa ezabatu behar duzu: {$a->directory}';
$string['uninstallmigrate'] = 'Desinstalatu baina mantendu matrikulazio guztiak';
