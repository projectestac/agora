...
$string['numextension'] = 'Ekarpenak: {$a}';
...
$string['sourceext'] = 'Ez-estandarra';
...
$string['type_plagiarism'] = 'Plagioa eragozteko plugina';
$string['type_plagiarism_plural'] = 'Plagioa eragozteko pluginak';
