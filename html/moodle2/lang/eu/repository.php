...
$string['cannotdownloaddir'] = 'Ezin da direktorio hau jaitsi.';
...
$string['confirmremove'] = 'Ziur al zaude biltegi-plugin hau ezabatu nahi duzula, aukerak eta <strong>instantzia guztiak</strong> barne - {$a}?';
...
$string['create'] = 'Sortu';
$string['createfolderfail'] = 'Kale egin du direktorio hau sortzean';
$string['createfoldersuccess'] = 'Direktorioa ondo sortu da';
...
$string['enter'] = 'Sartu';
$string['entername'] = 'Mesedez, idatzi direktorioaren izena';
...
$string['newfoldername'] = 'Direktorio berriaren izena:';
