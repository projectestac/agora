...
/**
 * Strings for component 'question', language 'eu', branch 'MOODLE_24_STABLE'
 *
 * @package   question
...
$string['cannotdeletemissingbehaviour'] = 'Ezin duzu ezabatu falta den jokaera. Sistemarentzat beharrezkoa da.';
...
$string['deletebehaviourareyousure'] = '{$a} jokaera ezabatu: ziur al zaude?';
...
$string['exportquestions'] = 'Galderak fitxategira esportatu';
...
$string['matchgrades_help'] = '<p>Inportatutako kalifikazioek bat etorri <b>behar</b> dute
ezarri den kalifikazio egokien zerrendako batekin, adibidez
ondorengoak...</p>
...
<p>goiko zerrendan balore negatiboak ere
ezar daitezke.</p>

<p>Bi ezarpen daude kontu honetarako. Goiko zerrendan dauden
 baloreetako batekin <strong>zuzen-zuzen</strong> bat ez datozen
 baloreekin nola jokatu adierazten dute.</p>

<ul>
  <li><strong>Errorea kalifikazioa ez badago zerrendan</strong><br />
  Galdera batek zerrendan ez dagoen kalifikazioren bat badu errore bat erakutsiko da
  eta galdera hori ez da inportatuko.</li>
  <li><strong>Kalifikazio hurbilena, ez badago zerrendan</strong><br />
  Kalifikazio bat ez badator bat zerrendako baloreekin, kalifikazioa aldatu egingo da
  eta zerrendako balore hurbilena ezarriko zaio</li>
</ul>

<p><i>Oharra: inportatzeko ohiko formatu batzuk zuzenean idazten dute datu-basean eta kontrol honen gainetik pasa daitezke.</i></p>';
...
$string['settingsformultipletries'] = 'Saiakera askotarako ezarpenak';
