...
/**
 * Strings for component 'moodle', language 'eu', branch 'MOODLE_24_STABLE'
 *
 * @package   moodle
...
$string['availability_help'] = 'Ezarpen honek adierazten du ikastaroa nola agertuko den ikastaroen zerrendan. Irakasle eta kudeatzaileez aparte, erabiltzaileek ez dute baimenik ikastaroan sartzeko.';
...
$string['blockdeleteconfirm'] = '\'{$a}\' blokea ezabatzear zaude. Bloke honekin lotutako edozer ezabatuko da datu-basean. ZIUR al zaude jarraitu nahi duzula?';
...
$string['category_help'] = 'Ezarpen honek adierazten du zein kategoriatan agertuko den ikastaroa ikastaroen zerrendan.';
...
$string['coursehelpnewsitemsnumber'] = 'Ikastaroaren hasiera-orrian agertuko diren azken berrien kopurua, eskuin aldeko bloke berrian <br/> (O ezarriz gero, blokea ez da agertu ere egingo)';
$string['coursehelpnumberweeks'] = 'Ikastaroaren atal-kopurua (zenbait ikastaro-formatutan aplikatzen da bakarrik).';
...
$string['courserequestsuccess'] = 'Ikastaro-eskaria ondo gorde da. Gutxi barru erantzuna e-postaz bidaliko zaizu.';
...
$string['courseuploadlimit'] = 'Ikastaro honetara igo daitezkeen fitxategien gehienezko tamaina';
$string['create'] = 'Sortu';
$string['createaccount'] = 'Nire kontu berria sortu';
$string['createcategory'] = 'Kategoria sortu';
$string['createfolder'] = 'Sortu direktorioa hemen: {$a}';
...
$string['deselectall'] = 'Bat ere ez aukeratu';
...
$string['dndenabled'] = 'Hartu eta eraman aukera gaituta';
$string['dndenabled_inbox'] = 'Fitxategiak gehitzeko, hartu eta eraman ahal dituzu.';
$string['dndenabled_insentence'] = 'Hartu eta eraman aukera gaituta';
...
$string['emailcharset'] = 'E-postarako karakter-multzoa';
...
$string['folderclosed'] = 'Direktorio itxia';
$string['folderopened'] = 'Direktorio irekia';
...
$string['forcedmodeinbrackets'] = '{$a} (behartze moduan)';
...
$string['frontpagedescriptionhelp'] = 'Gunearen deskribapen hau hasiera-orrian agertuko da';
...
$string['frontpagetopiconly'] = 'HTML edo ausazko ekintzak erakutsi (gaien atala)';
...
$string['local'] = 'Lokala';
$string['localplugindeleteconfirm'] = '\'{$a}\' plugin lokala ezabatzear zaude. Datu-basean plugin honekin lotutako guztia ezabatuko du honek. ZIUR al zaude aurrera egin nahi duzula?';
...
$string['makeafolder'] = 'Direktorioa sortu';
...
$string['maxnumberweeks'] = 'Gehienezko aste/gai-kopurua';
...
$string['moduledeletefiles'] = '\'{$a->module}\' moduluarekin lotutako datu guztiak datu-basetik ezabatu dira. Prozesua osatzeko (eta moduluak bere burua berriz ez instalatzeko) {$a->directory} direktorioa zure zerbitzaritik ezabatu behar duzu.';
...
$string['notifyloginfailuresmessageend'] = 'Erregistro horiek ikusteko hona jo: {$a}/course/log.php?id=1&chooselog=1&modid=site_errors.';
...
$string['orphanedactivities'] = 'Jarduera umezurtzak';
$string['other'] = 'Beste';
$string['outline'] = 'Laburpena';
$string['outlinereport'] = 'Laburpen-txostena';
$string['page'] = 'Orria';
$string['pageheaderconfigablock'] = 'Blokea hemen konfiguratzen: %fullname%';
...
$string['publicsitefileswarning3'] = 'Oharra: Hemen kokatutako fitxategiak URL-a ezagutzen duen (edo bisita dezakeen) edonoren esku egongo dira. <br />Segurtasunagatik, segurtasun-kopiaren fitxategiak backupdata direktorioan bakarrik gorde beharko lirateke.';
...
$string['returntomaincoursepage'] = 'Itzuli ikastaroaren hasiera-orrira';
...
$string['searchhelp'] = 'Hitz asko batera bila ditzakezu.<p>Hitz bat baino gehiago idaztekotan, bilatzaileak hitz horiek edonon dauzkaten emaitzak bilatuko ditu.<br />Hitz batzuk (+) ikurrak bananduta idatziz gero, hitz horiek guztiak orden berean duten emaitza guztiak erakutsiko dira.';
...
$string['selectdefault'] = 'Berezkoa aukeratu';
$string['selectedfile'] = 'Aukeratutako fitxategia';
$string['selectednowmove'] = '{$a} fitxategi aukeratu duzu mugitzeko. Zoaz orain nahi duzun direktoriora eta sakatu \'Ekarri fitxategiak hona\'';
...
Sakatu bi aldiz jarduera edo baliabide batean zuzenean gehitzeko.';
$string['selectnos'] = 'Denak aukeratu \'ez\'';
...
$string['tagmanagement'] = 'Etiketak gehitu/ezabatu';
...
$string['therearecourses'] = '{$a} ikastaroak daude';
...
$string['uploadextension'] = 'Luzapenak fitxategiaren eguneratzea eten du';
...
$string['userselectorsearchanywhere'] = 'Bilaketa-testua erabiltzailearen izeneko edozein atalekin bat baldin badator, aukeratu';
...
* Zabaldu matrikulazioa (banaka) - Aukeratutako ikasleari ikastarorako sarbidea emateko, matrikulazio tartea ezarrita badago ere
* Zabaldu matrikulazioa (taldeka) - Ikasle bati baino gehiagori ikastarorako sarbidea emateko ';
