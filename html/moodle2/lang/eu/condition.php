...
$string['configenableavailability'] = 'Gaituta, baldintzak (data, kalifikazioa edo osatuta) ezarri ahal izango dituzu jarduera eskuragarri dagoen ala ez kontrolatzeko.';
...
$string['requires_completion_3'] = 'Ez dago eskura, ez bada <strong>{$a}</strong> osatuta eta suspendituta.';
$string['requires_date'] = 'Eskuragarri {$a}-tik aurrera.';
$string['requires_date_before'] = 'Eskuragarri {$a}-ra arte.';
