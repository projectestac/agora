...
$string['showdownloadlinks_help'] = 'If enabled, each PDF.js-based link will be followed by a link to download the PDF.nnThis can be useful on mobile devices where PDF.js may use too much memory or be too slow to work satisfactorily.';
