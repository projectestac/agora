...
/**
 * Strings for component 'block_course_overview_campus', language 'en', branch 'MOODLE_26_STABLE'
 *
...
$string['categorycoursefilter'] = 'Activate category filter';
$string['categorycoursefilter_desc'] = 'Allow users to filter courses by category';
$string['categorycoursefilterdisplayname'] = 'Display name for category filter';
$string['categorycoursefilterdisplayname_desc'] = 'This display name is shown above the category filter<br /><em>This setting is only processed when the category filter is activated</em>';
$string['categorycoursefiltersettingheading'] = 'Category filter: Filter activation';
...
$string['mergehomonymouscategories'] = 'Merge homonymous categories';
$string['mergehomonymouscategories_desc'] = 'If there are multiple categories with different parent categories, but with the same name, the category filter will be filled with multiple categories with the same name by default. This can be confusing to the user. If you want to merge all homonymous categories into one category when using the category filter, activate this setting<br /><em>This setting is only processed when the category filter is activated</em>';
$string['mergehomonymouscategoriessettingheading'] = 'Category filter: Merge homonymous categories';
...
$string['secondrowshowcategoryname'] = 'Second row: Show category name';
$string['secondrowshowcategoryname_desc'] = 'Show the course\'s category name in a second row of the course overview list entry';
