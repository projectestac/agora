...
/**
 * Strings for component 'qtype_stack', language 'en', branch 'MOODLE_26_STABLE'
 *
 * @package   qtype_stack
...
$string['alg_logarithms_fact'] = 'For any base (c>0) with (c neq 1):
[log_c(a) = b mbox{, means } a = c^b]
[log_c(a) + log_c(b) = log_c(ab)]
[log_c(a) - log_c(b) = log_cleft(frac{a}{c}right)]
[nlog_c(a) = log_cleft(a^nright)]
[log_c(1) = 0]
[log_c(b) = 1]
