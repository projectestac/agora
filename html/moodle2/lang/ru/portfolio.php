...
/**
 * Strings for component 'portfolio', language 'ru', branch 'MOODLE_24_STABLE'
 *
 * @package   portfolio
...
$string['addtoportfolio'] = 'Экспортировть в портфолио';
...
$string['highdbsizethreshold'] = 'Высокий размер передаваемой базы данных';
...
$string['moderatedbsizethresholddesc'] = 'Количество записей БД, превышение которого будет считаться умеренным количеством времени для передачи';
$string['moderatefilesizethreshold'] = 'Умеренный размер передаваемого файла';
$string['moderatefilesizethresholddesc'] = 'Размер файла, превышающий этот порог, будет считаться умеренным количеством времени для передачи';
$string['multipleinstancesdisallowed'] = 'Попытка создать ещё один экземпляр плагина, у которого есть запрет на создание нескольких экземпляров ({$a})';
...
$string['noinstanceyet'] = 'Ещё не выбрано';
...
$string['notimplemented'] = 'Извините, но Вы пытаетесь экспортировать контент в таком формате, который пока ещё не реализован ({$a})';
$string['notyetselected'] = 'Ещё не выбрано';
