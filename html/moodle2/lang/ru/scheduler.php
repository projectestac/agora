...
/**
 * Strings for component 'scheduler', language 'ru', branch 'MOODLE_24_STABLE'
 *
 * @package   scheduler
...
$string['gradingstrategy_help'] = 'Для расписаний, в которых студенты могут иметь несколько записей, выберите, как определяется совокупная оценка.
В журнале оценок может отображаться или <ul><li>средняя или</li><li>максимальная оценка</li></ul> из полученных студентом.';
$string['group'] = 'группа';
...
Чтобы включить данную функцию,  групповой режим этого активного элемента должен быть установлен в "Доступные группы" или "Изолированные группы" независимо от глобальных настроек.';
...
$string['slotwarning'] = '<b>Предупреждение: </b>Назначение этого приема на указанное время конфликтует с перечисленными ниже приемами. Включите параметр «Игнорировать конфликты в расписании», если Вы все-таки хотите провести этот прием.';
...
$string['xdaysbefore'] = 'дней до приема';
$string['xweeksbefore'] = 'недель до приема';
