...
/**
 * Strings for component 'qtype_numerical', language 'ru', branch 'MOODLE_26_STABLE'
 *
...
$string['pluginnamesummary'] = 'Позволяет оценивать числовые ответы, в том числе с единицами измерения, несколькими способами, в том числе с учетом погрешностей.';
