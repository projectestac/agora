...
/**
 * Strings for component 'questionnaire', language 'ru', branch 'MOODLE_24_STABLE'
 *
...
$string['confirmdelgroupresp'] = 'Вы уверены, что Вы хотите удалить ВСЕ ответы от {$a}?';
...
$string['fieldlength_help'] = 'Для типа вопроса **Текстовое поле** введите *Ширину поля ввода* и *Максимальную длину текста* для текста, который будет вводиться респондентом.
...
$string['id'] = 'ID';
$string['includechoicecodes'] = 'Включить выбранный текст';
$string['includechoicetext'] = 'Включить выбранные коды';
...
$string['noduplicates'] = 'Не дублировать выбор';
...
$string['questionnaire:addinstance'] = 'Добавить новый анкетный опрос';
$string['questionnaireadministration'] = 'Управление анкетным опросом';
$string['questionnairecloses'] = 'Опрос закрывается';
$string['questionnaire:copysurveys'] = 'Копировать шаблон и личные анкетные опросы';
$string['questionnaire:createpublic'] = 'Создавать общий опрос';
$string['questionnaire:createtemplates'] = 'Создавать шаблон опроса';
$string['questionnaire:deleteresponses'] = 'Удалять все ответы';
$string['questionnaire:downloadresponses'] = 'Загружать ответы в файл CSV';
$string['questionnaire:editquestions'] = 'Создавать и редактировать вопросы опроса';
$string['questionnaire:manage'] = 'Создавать и редактировать опросы';
$string['questionnaireopens'] = 'Опрос открывается';
$string['questionnaire:printblank'] = 'Печатать бланк опроса';
$string['questionnaire:readallresponseanytime'] = 'Всегда видеть все ответы';
$string['questionnaire:readallresponses'] = 'Видеть темы и ответы в доступное время';
$string['questionnaire:readownresponses'] = 'Видеть свои ответы';
$string['questionnairereport'] = 'Отчет Анкетного опроса';
$string['questionnaire:submit'] = 'Завершать и представлять анкетный опрос';
$string['questionnaire:view'] = 'Видеть опрос';
$string['questionnaire:viewsingleresponse'] = 'Видеть полные индивидуальные ответы';
...
$string['rank'] = 'Ранг';
$string['ratescale'] = 'Оценка (шкала 1...5)';
...
$string['required_help'] = 'Если Вы выберете ***Да***, то ответ на этот вопрос будет необходим, то есть респондент не сможет представить результаты анкетного опроса, пока не ответит на этот вопрос.';
$string['requiredparameter'] = 'Отсутствует обязательный параметр.';
$string['reset'] = 'Сброс';
$string['respeligiblerepl'] = '(замененной ролью переопределяется)';
...
$string['submitsurvey'] = 'Отправить результаты опроса';
...
$string['textareacolumns_help'] = 'Этот вопрос выглядит в виде пустого текстового поля с **x** (*ширина* поля) и **y** *Строки текстового поля* (количество *строк* текста).
Если Вы оставите значения и x и y по умолчанию ( = 0 ) или если Вы установите это в 0 , то HTML-редактор будет показан со стандартной высотой и шириной (если редактор выбран в профиле пользователя).';
