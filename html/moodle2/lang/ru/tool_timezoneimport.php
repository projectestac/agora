...
/**
 * Strings for component 'tool_timezoneimport', language 'ru', branch 'MOODLE_24_STABLE'
 *
...
$string['configintrotimezones'] = 'На этой странице можно найти новую информацию о часовых поясах мира (включая правила перехода на летнее и зимнее время) и обновить информацию в локальной базе данных.
