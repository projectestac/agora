...
Если показано пустое поле со сплошной границей, то Вы можете щёлкнуть по нему и установить галочку, чтобы отметить завершение элемента (при повторном щелчке отметка снимается). Отметка не обязательна и является лишь способом отслеживания Вашего продвижения в курсе.';
