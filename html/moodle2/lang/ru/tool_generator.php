...
Этот тест является важным, потому что ранее было много случаев, когда, в реальной жизни столкнувшись с использованием  сложных случаев (например, курс с 1000 элементов), система не работала.
...
**Не используйте эту функцию на рабочей системе.** Используйте только на сервере разработчика. (Чтобы избежать случайного использования, эта функция отключена, если Вы также не выбрали уровень отладки - РАЗРАБОТЧИК).';
...
Вы можете рассмотреть мощность своих серверов при суммарной работе больших испытательных планов, чтобы нагрузка, порожденная JMeter, специально была  большой. Увеличение периода была скорректировано в соответствии с количеством потоков (пользователей), чтобы уменьшить проблемы такого рода, но нагрузка все еще огромна.
