...
/**
 * Strings for component 'auth', language 'ru', branch 'MOODLE_24_STABLE'
 *
 * @package   auth
...
$string['auth_remove_user'] = 'Укажите, что делать с внутренней учётной записью пользователя во время массовой синхронизации, если пользователь будет удален из внешнего источника. Только заблокированные учётные записи могут быть автоматически восстановлены, если они снова появятся во внешнем источнике.';
...
$string['suspended_help'] = 'Пользователь, учётная запись которого заблокирована, не может входить в систему и пользоваться веб-службами. Сообщения, адресованные таким пользователям, не доставляются.';
