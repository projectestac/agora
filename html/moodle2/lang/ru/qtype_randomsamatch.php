...
$string['pluginname'] = 'Случайный ответ на соответствие';
$string['pluginnameadding'] = 'Добавление вопроса "Случайный ответ на соответствие"';
$string['pluginnameediting'] = 'Редактирование вопроса "Случайный ответ на соответствие"';
...
$string['pluginnamesummary'] = 'Подобен вопросу "На соответствие", но создаётся из вопросов типа "Короткий ответ", выбираемых случайным образом из конкретной категории.';
