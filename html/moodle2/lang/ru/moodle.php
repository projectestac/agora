...
$string['eventcontentviewed'] = 'Просмотр содержимого';
...
$string['eventuserlistviewed'] = 'Просмотр списка пользователей';
$string['eventuserloggedout'] = 'Пользователь вышел';
$string['eventuserprofileviewed'] = 'Просмотр профиля пользователя';
...
* Формат одиночного элемента - отображение единственного элемента или ресурса (например, теста или пакета SCORM) на странице курса
* Социальный формат - На главной странице курса отображается форум.
* Тематический формат - Страница курса представляется в виде разделов (тем).
* Еженедельный формат - Страница курса представляется в виде разделов, разбитых по неделям. Первая неделя отсчитывается от даты начала курса.';
