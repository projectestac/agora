...
$string['dndenabled_help'] = 'Чтобы загрузить один или несколько файлов, Вы можете перетащить их с рабочего стола и разместить в расположенном ниже окне.<br />Обратите внимание: эта функция работает не во всех браузерах.';
