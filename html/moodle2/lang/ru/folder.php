...
$string['modulename_help'] = 'Модуль «Каталог» позволяет преподавателю отображать несколько смежных файлов в одной папке, уменьшая прокрутку на странице курса. Папка в архиве ZIP может быть загружена и распакована для отображения; можно создать пустую папку и файлы загрузить в нее.

Каталог может быть использован для:

* серии файлов по одной теме, например, набор прошлых экзаменационных работ в формате PDF или набор файлов изображений для использования в студенческих проектах.
