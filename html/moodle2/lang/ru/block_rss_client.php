...
$string['pluginname'] = 'Отдаленные RSS-ленты';
$string['remotenewsfeed'] = 'Отдаленная новостная лента';
$string['rss_client:addinstance'] = 'Добавлять новый блок Отдаленные RSS-ленты';
...
$string['rss_client:myaddinstance'] = 'Добавлять новый блок RSS-ленты в Мой Moodle';
