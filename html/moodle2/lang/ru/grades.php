...
/**
 * Strings for component 'grades', language 'ru', branch 'MOODLE_24_STABLE'
 *
 * @package   grades
...
$string['exportonlyactive'] = 'Только активные участники';
$string['exportonlyactive_help'] = 'Экспортировать только тех студентов, участие которых в курсе не приостановлено';
