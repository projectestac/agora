...
/**
 * Strings for component 'error', language 'ru', branch 'MOODLE_24_STABLE'
 *
 * @package   error
...
$string['blockcannotinistantiate'] = 'Проблема при создании блока объекта';
...
$string['callbackrejectcomment'] = 'Ответный комментарий отклонил этот комментарий.';
...
$string['cannotmapfield'] = 'Определено противоречие отображения - два отображаемых поля имеют одинаковый элемент оценки {$a}';
...
$string['coursemisconf'] = 'Неправильный курс';
...
$string['destinationcmnotexit'] = 'Модуль назначения курса не существует';
...
$string['hashpoolproblem'] = 'Некорректное содержимое объединённого файла {$a}.';
...
$string['maxareabytes'] = 'Не хватает свободного места для сохранения этого файла';
...
$string['refoundtoorigi'] = 'Возврат оригинального количества: {$a}';
