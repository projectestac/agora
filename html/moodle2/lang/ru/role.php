...
$string['badges:configuredetails'] = 'Настраивать/редактировать значок';
$string['badges:configuremessages'] = 'Настраивать значок сообщения';
$string['badges:createbadge'] = 'Создавать / дублировать значки';
$string['badges:deletebadge'] = 'Удалять значки';
$string['badges:earnbadge'] = 'Заработать значок';
...
$string['calendar:manageownentries'] = 'Управлять записями в своем календаре';
...
$string['eventroleallowassignupdated'] = 'Разрешение назначения роли';
$string['eventroleallowoverrideupdated'] = 'Разрешение переопределения роли';
$string['eventroleallowswitchupdated'] = 'Разрешение переключения между ролями';
$string['eventroleassigned'] = 'Назначение роли';
$string['eventrolecapabilitiesupdated'] = 'Обновление прав для роли';
$string['eventroledeleted'] = 'Удаление роли';
$string['eventroleunassigned'] = 'Снятие назначения роли';
...
$string['user:readuserblogs'] = 'Видеть блоги всех пользователей';
$string['user:readuserposts'] = 'Видеть сообщения форумов всех пользователей';
