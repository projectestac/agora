...
/**
 * Strings for component 'tool_customlang', language 'ru', branch 'MOODLE_24_STABLE'
 *
...
$string['checkoutinprogress'] = 'Идёт загрузка языкового пакета';
$string['confirmcheckin'] = 'Вы собираетесь записать изменённые строки в Ваш языковой пакет. При этом все откорректированные в этом редакторе строки будут сохранены в каталоге данных и в Moodle начнут использоваться их новые значения. Для записи изменений на диск нажмите кнопку "Продолжить".';
