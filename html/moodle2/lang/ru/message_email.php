...
$string['configemailonlyfromnoreplyaddress'] = 'При включенном параметре все письма будут отправляться с пометкой «от» вместо «без ответа (no-reply)». Это может быть применено для остановки использования антиспуфинга во внешних почтовых системах, блокирующих электронные письма.';
...
$string['emailonlyfromnoreplyaddress'] = 'Всегда отправлять электронную почту с пометкой «без ответа (no-reply)»?';
