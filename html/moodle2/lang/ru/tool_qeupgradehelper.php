...
/**
 * Strings for component 'tool_qeupgradehelper', language 'ru', branch 'MOODLE_24_STABLE'
 *
...
$string['convertedattempts'] = 'Обновлённые попытки';
...
$string['gotoquizreport'] = 'Перейти к отчётам этого теста для проверки обновления';
...
$string['listpreupgrade_desc'] = 'В списке отображается отчёт о всех тестах в системе и количестве имеющихся в них попыток. Он даёт представление о масштабах обновления, которое Вы можете сделать.';
...
$string['listtodo_desc'] = 'Список отображает отчёт о всех тестах в системе (если таковые имеются), в которых есть попытки, которые нуждаются в обновлении до новых возможностей вопросов.';
...
$string['listupgraded'] = 'Список уже обновлённых тестов, которые могут быть сброшены';
$string['listupgraded_desc'] = 'Список отображает отчёт о всех тестах в системе с обновлёнными попытками, в которых по-прежнему присутствуют старые данные. Поэтому обновление может быть сброшено и проведено заново.';
$string['listupgradedintro'] = 'Все эти тесты содержат обновлённые попытки, в которых по-прежнему есть старые данные. Поэтому они могут быть сброшены и повторно сделано обновление.';
$string['noquizattempts'] = 'На всём сайте нет ни одной попытки тестов!';
$string['nothingupgradedyet'] = 'Нет обновлённых попыток, которые могут быть сброшены';
...
$string['oldsitedetected'] = 'Этот сайт ещё не был обновлён, чтобы использовать новые возможности вопросов.';
...
$string['quizzesthatcanbereset'] = 'Следующие тесты содержат обновлённые попытки, которые можно сбросить';
...
$string['upgradedsitedetected'] = 'Этот сайт был обновлён для использования новых возможностей вопросов.';
