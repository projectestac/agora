...
$string['lockteachermarks_help'] = 'Если при включенном параметре преподаватель сохранит отметку "Да", то он больше не сможет её изменить. Только пользователи с правом "mod/checklist:updatelocked" будут иметь возможность изменить отметку.';
