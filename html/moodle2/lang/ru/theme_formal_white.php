...
$string['customlogourldesc'] = 'Можно изменить логотип, используемый этой темой, указав URL нового (например: http://www.somesite/animage.png). По умолчанию используется логотип шириной 200 и высотой 50 пикселей. Лучше использовать PNG-файл c прозрачным фоном.';
