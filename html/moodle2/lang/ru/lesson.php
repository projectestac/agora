...
$string['displayreview'] = 'Давать возможность ответить на вопрос еще раз';
...
$string['leftduringtimedsession'] = 'Вы покинули лекцию, ограниченную по времени.';
...
$string['modattempts_help'] = 'При включение этого параметра по окончани лекции у студентов будет возможность просмотреть лекцию сначала (без возможности изменения ответов). Это не будет считаться новой попыткой.';
$string['modattemptsnoteacher'] = 'Только студенты могут осуществлять повторный просмотр лекции.';
...
$string['ongoing_help'] = 'При включении этого параметра студент будет видеть на каждой странице количество полученных и максимум баллов. Пример: ученик ответил правильно на 3 вопроса из 4, каждый с оценкой по 5 баллов. Так как один ответ был неправильным, текущий балл составит 15 из 20.';
...
$string['progressbar_help'] = '<p>При включении этого параметра в нижней части страниц лекции будет отображаться индикатор выполнения.</p><p>На данный момент иникатор выполнения корректно работает только для лекций с линейной последовательностью страниц. При подсчете используется количество пройденных учеником страниц и правильно отвеченных вопросов. Кроме того, кластеры и страницы в них считаются как одна страница, концы кластеров и разделов не учитываются.</p>';
...
$string['randombranch'] = 'Случайная информационная страница / Случайное оглавление раздела';
...
$string['showanunansweredpage'] = 'Показывать страницы без ответа';
...
$string['slideshow_help'] = 'При включенном параметре лекция отображается как слайд-шоу с фиксированной шириной и высотой слайдов.';
...
$string['studentoneminwarning'] = 'Внимание! У Вас осталась меньше минуты на завершение лекции.';
$string['studentresponse'] = 'Ответ студента {$a}';
$string['submit'] = 'Отправить';
$string['submitname'] = 'Отправить имя';
$string['teacherjumpwarning'] = 'В лекции используются переходы «{$a->cluster}» или «{$a->unseen}». Вместо них будет использован переход «Следующая страница». Зайдите как студент, чтобы протестировать эти переходы.';
$string['teacherongoingwarning'] = 'Текущий балл отображается только для студентов. Чтобы протестировать текущий балл, зайдите под именем какого-нибудь студента.';
$string['teachertimerwarning'] = 'Таймер отображается только для студента. Чтобы протестировать таймер, зайдите как студент.';
...
$string['timespenterror'] = 'Вы должны работать с лекцией по крайней мере {$a} минут';
...
$string['youshouldview'] = 'Вы должны ответить, по крайней мере на: {$a}';
