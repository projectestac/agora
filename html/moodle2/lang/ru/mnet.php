...
$string['enterausername'] = 'Пожалуйста, введите имя пользователя или список имён пользователей, разделённых запятыми.';
...
$string['error7023'] = 'Удаленный сайт пытался расшифровать Ваше сообщение со всеми ключами, записанными для Вашего сайта. Они все ошибочны.Вам нужно вручную исправить эту ошибку путём переназначения ключей с удаленного сайта. Это вряд ли произойдёт, если Вы не были связаны с удаленным сайтом в течение нескольких месяцев.';
...
$string['https_verified_help'] = 'Разрешение соединений с помощью SSL-сертификата, подтверждённого на удаленном хосте.';
$string['http_verified_help'] = 'Разрешение соединений через HTTP (не HTTPS) с использованием подтверждённого сертификата SSL в PHP на удаленном хосте.';
$string['id'] = 'ID';
...
$string['keydeleted'] = 'Ваш ключ был успешно удалён и заменён.';
...
$string['remotecourses'] = 'Курсы на удалённых';
$string['remotehost'] = 'Удалённый хост';
$string['remotehosts'] = 'Удалённые хосты';
...
$string['transport_help'] = 'Эти опции - взаимны, т.е. Вы можете вынудить отдалённый хост использовать подписанный сертификат SSL, только если у Вашего сервера тоже есть подписанный сертификат SSL.';
