...
$string['backup_shortnamehelp'] = 'Название курса используется в имени файла резервной копии вместо ID курса.';
...
$string['configmessagingallowemailoverride'] = 'Разрешить пользователям получать сообщения по электронной почте на другой адрес, отличный от адреса электронной почты в их профиле';
...
$string['confignavshowallcourses'] = 'Этот параметр определяет, должны ли пользователи, записанные на какие-то курсы, видеть в блоке навигации кроме элемента "Мои курсы" (список тех курсов, на которые пользователь записан) ещё и элемент "Курсы" (полный список курсов).';
...
$string['linkadmincategories'] = 'Ссылка на управление категориями';
$string['linkadmincategories_help'] = 'При включенном параметре настройка категорий будет отображаться в навигации в виде ссылки на страницу управления категориями.';
...
$string['messagingallowemailoverride'] = 'Отвергать уведомления по электронной почте';
...
$string['navsortmycoursessort'] = 'Упорядочить курсы';
...
$string['registration_help'] = 'Рекомендуется зарегистрироваться в Moodle.org и получать по электронной почте предупреждения о безопасности, внести свой вклад в развитие Moodle и статистики, или иметь возможность делиться курсами с Открытым сообществом.';
...
$string['sort_fullname'] = 'Полное имя';
...
$string['suspenduser'] = 'Заблокировать учётную запись пользователя';
...
$string['unsuspenduser'] = 'Активировать учётную запись пользователя';
...
$string['updateminmaturity_desc'] = 'Уведомлять только о тех обновлениях, стадия разработки которых не ниже указанной. Этот параметр не влияет на уведомления о наличии новых версий плагинов, поскольку поскольку для плагинов не указывается стадия разработки.';
...
* создать новую директорию Moodle, содержащую только файлы из (любого): стандартного пакета Moodle или Moodle CVS или репозитория GIT
...
Это предупреждение может быть вызвано и неполной проверкой или обновления с CVS, SVN или репозитория GIT, в этом случае Вы можете просто ждать завершения операции, или, возможно, отменить команду  и повторить операцию.
