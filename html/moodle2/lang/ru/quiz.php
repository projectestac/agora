...
/**
 * Strings for component 'quiz', language 'ru', branch 'MOODLE_24_STABLE'
 *
 * @package   quiz
...
$string['cannotstartnoquestions'] = 'Не удается начать попытку в этом тесте. Тест ещё не создан. Нет добавленных вопросов.';
...
Вы начали попытку теста "{$a->quizname}" в курсе "{$a->coursename}", но не отправили её. Попытка должна была быть отправлена до {$a->attemptduedate}. Если Вы хотите представить свою попытку для оценивания, то перейдите на {$a->attemptsummaryurl} и нажмите кнопку "Отправить". Вы должны сделать это до {$a->attemptgraceend}, иначе эта попытка не будет зачтена.';
$string['emailoverduesmall'] = 'Вы не отправили свою попытку теста "{$a->quizname}". Если Вы ещё хотите отправить свою попытку, то перейдите на {$a->attemptsummaryurl} до {$a->attemptgraceend}.';
...
$string['notyetgraded'] = 'Ещё не оценено';
$string['notyetviewed'] = 'Ещё не рассмотрено';
...
$string['reviewoverallfeedback_help'] = 'Общий отзыв даётся по окончании попытки в зависимости от оценки студента.';
