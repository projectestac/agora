...
/**
 * Strings for component 'question', language 'ru', branch 'MOODLE_24_STABLE'
 *
 * @package   question
...
$string['orphanedquestionscategory'] = 'Вопросы, сохранённые из удалённых категорий';
$string['orphanedquestionscategoryinfo'] = 'Иногда (в основном, из-за ошибок программного обеспечения) вопросы могут оставаться в базе данных, хотя из соответствующей категории вопрос был удалён. Из курса вопрос не удалён, как было и раньше на этом сайте. Данная категория была создана автоматически и старые вопросы перемещены сюда, чтобы Вы могли управлять ими. Обратите внимание, что, вероятно, были потеряны любые изображения или медиа-файлы, используемые в этих вопросах.';
...
$string['whethercorrect_help'] = 'Предусматривает текстовое описание "Правильно", "Частично правильно" или "Неправильно" и ещё цветовую подсветку, которая передаёт ту же информацию.';
