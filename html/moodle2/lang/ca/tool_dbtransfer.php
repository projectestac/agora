...
$string['dbexport'] = 'Transferència base de dades';
$string['dbtransfer'] = 'Exportació base de dades';
...
$string['transferringdbto'] = 'S\'està transferint aquesta base de dades  a la base de dades {$a->dbname} de tipus  {$a->dbtype} al servidor {$a->dbhost}';
