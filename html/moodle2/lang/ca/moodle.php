...
$string['addfilehere'] = 'Afegeix fitxers ací';
...
$string['addlinkhere'] = 'Afegeix un enllaç ací';
...
$string['coursedisplay_help'] = 'Aquest paràmetre determina si el curs complet es mostra en una pàgina o es divideix en diverses pàgines. El paràmetre no afecta a certs formats de curs, com ara el format SCORM.';
...
$string['coursefilesedit'] = 'Edita els fitxers del curs';
...
$string['courselegacyfiles'] = 'Fitxers del curs';
...
$string['dndenabled'] = 'Disponible Arrossega i deixa anar';
$string['dndenabled_help'] = 'Podeu arrossegar un o més fitxers del vostre escriptori i deixar-los anar dins de la caixa de baix per a penjar-los.<br />Avís: Pot no funcionar amb altres navegadors web';
$string['dndenabled_inbox'] = 'Podeu arrossegar i deixar anar fitxers ací per a afegir-los.';
$string['dndenabled_insentence'] = 'disponible arrossega i deixa anar';
...
$string['errornouploadrepo'] = 'No hi ha un dipòsit de càrrega habilitat per a aquest lloc';
...
$string['policyagreementclick'] = 'Enllaç a la normativa d\'ús del lloc';
...
$string['returntomaincoursepage'] = 'Torna a la pàgina principal del curs';
...
$string['userselectorpreserveselected'] = 'Manté els usuaris sel·leccionats, inclús si no fan cerques.';
