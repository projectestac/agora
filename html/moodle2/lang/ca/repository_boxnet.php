...
/**
 * Strings for component 'repository_boxnet', language 'ca', branch 'MOODLE_23_STABLE'
 *
...
$string['apikey'] = '';
$string['boxnet:view'] = 'Mostra el dipòsit box.net';
...
$string['nullfilelist'] = 'No hi ha fitxers en aquest dipòsit';
$string['password'] = 'Contrasenya';
$string['pluginname'] = 'Box.net';
$string['pluginname_help'] = 'Dipòsit de Box.net';
