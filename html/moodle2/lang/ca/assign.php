...
$string['blindmarking_help'] = 'La qualificació a cegues oculta la identitat dels estudiants als qualificadors. Els arranjaments de la qualificació a cegues quedaran bloquejats quan s\'hagi fet una tramesa o qualificació en relació amb aquesta tasca.';
...
$string['cutoffdate'] = 'Data de tall';
$string['cutoffdatefromdatevalidation'] = 'La data de tall ha de ser posterior a la data inicial del període.';
$string['cutoffdate_help'] = 'Si s\'habilita, la tasca no acceptarà trameses després d\'aquesta data sense una pròrroga.';
$string['cutoffdatevalidation'] = 'La data de tall ha de ser posterior a la de venciment.';
