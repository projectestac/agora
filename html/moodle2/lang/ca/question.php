...
/**
 * Strings for component 'question', language 'ca', branch 'MOODLE_23_STABLE'
 *
 * @package   question
...
$string['matcherror'] = 'Les qualificacions no casen amb les opcions de qualificació - es salta la pregunta.';
