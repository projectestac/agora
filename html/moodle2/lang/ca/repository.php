...
/**
 * Strings for component 'repository', language 'ca', branch 'MOODLE_23_STABLE'
 *
 * @package   repository
...
$string['activaterep'] = 'Dipòsits actius';
$string['activerepository'] = 'Connectors de dipòsit disponibles';
$string['activitybackup'] = 'Còpia de seguretat d\'activitat';
$string['add'] = 'Afegeix';
$string['addfile'] = 'Afegeix...';
$string['addplugin'] = 'Afegeix un connector de dipòsit';
...
$string['cannotaccessparentwin'] = 'Si la finestra mare usa HTTPS, no es pot accedir a l\'objecte window.opener, per tant el dipòsit no es pot refrescar automàticament, tanmateix com que es disposa de la vostra sessió, torneu enrere cap al selector de fitxers i seleccioneu el dipòsit de nou, això hauria de funcionar.';
...
$string['close'] = 'Tanca';
$string['commonrepositorysettings'] = 'Paràmetres del dipòsit comú';
...
$string['configcacheexpire'] = 'Temps (en segons) que es mantenen a la memòria cau els llistats de fitxers quan s\'exploren dipòsits externs.';
$string['configsaved'] = 'Configuració desada!';
$string['confirmdelete'] = 'Esteu segur que voleu suprimir aquest dipòsit - {$a}? Si trieu "Continua i descarrega", les referències de fitxer a continguts externs es descarregaran en moodle, però podria ser molt llarg de processar.';
...
$string['confirmremove'] = 'Esteu segur que voleu suprimir el connector de dipòsit, les seves opcions i <strong>totes les seves instàncies</strong> - {$a}? Si trieu "Continua i descarrega", les referències de fitxer a continguts externs es descarregaran en moodle, però podria ser molt llarg de processar.';
...
$string['createinstance'] = 'Crea la instància del dipòsit';
$string['createrepository'] = 'Crea la instància del dipòsit';
$string['createxxinstance'] = 'Crea la instància "{$a}"';
$string['date'] = 'Data';
$string['datecreated'] = 'Creat';
$string['deleted'] = 'S\'ha esborrat el dipòsit';
$string['deleterepository'] = 'Suprimeix aquest dipòsit';
...
$string['editrepositoryinstance'] = 'Edita la instància del dipòsit';
$string['emptylist'] = 'Llista buida';
$string['emptytype'] = 'No es pot crear el tipus de dipòsit: el nom del tipus està buit';
$string['enablecourseinstances'] = 'Permet als usuaris afegir una instància de dipòsit al curs';
$string['enableuserinstances'] = 'Permet als usuaris afegir una instància de dipòsit en el context de l\'usuari';
...
$string['erroruniquename'] = 'El nom de la instància del dipòsit cal que sigui únic';
$string['existingrepository'] = 'Aquest dipòsit ja existeix';
...
$string['instances'] = 'Instàncies del dipòsit';
...
$string['invalidplugin'] = 'Connector de dipòsit {$a} invàlid';
$string['invalidrepositoryid'] = 'ID de dipòsit invàlida';
...
$string['manage'] = 'Gestiona els dipòsits';
$string['manageurl'] = 'Gestiona';
$string['manageuserrepository'] = 'Gestiona el dipòsit individual';
...
$string['nopermissiontoaccess'] = 'No teniu permís per accedir a aquest dipòsit';
$string['norepositoriesavailable'] = 'Perdoneu, cap dels vostres dipòsits actuals retorna fitxers del format requerit.';
$string['norepositoriesexternalavailable'] = 'Perdoneu, cap dels vostres dipòsits actuals retorna fitxers externs.';
$string['noresult'] = 'Cap resultat a la recerca';
$string['notyourinstances'] = 'No podeu veure/editar instàncies de dipòsit d\'altres usuaris';
...
$string['personalrepositories'] = 'Instàncies de dipòsit disponibles';
$string['plugin'] = 'Connectors de dipòsit';
$string['pluginerror'] = 'Errors al connector del dipòsit';
$string['pluginname'] = 'Nom del connector de dipòsit';
...
$string['removed'] = 'Dipòsit suprimit';
$string['renameall'] = 'Canvia el nom de tot';
$string['renameto'] = 'Canvia el nom a "{$a}"';
$string['repositories'] = 'Dipòsits';
$string['repository'] = 'Dipòsit';
$string['repositorycourse'] = 'Dipòsit del curs';
$string['repositoryerror'] = 'El dipòsit remot ha retornat l\'error: {$a}';
$string['save'] = 'Desa';
...
$string['settings'] = 'Arranjaments';
$string['setupdefaultplugins'] = 'Configuració dels connectors de dipòsit per defecte';
$string['siteinstances'] = 'Instàncies de dipòsit del lloc';
$string['size'] = 'Mida';
$string['submit'] = 'Envia';
$string['sync'] = 'Sync';
...
$string['usercontextrepositorydisabled'] = 'No podeu editar aquest dipòsit en el context de l\'usuari';
