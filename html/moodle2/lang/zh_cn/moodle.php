...
/**
 * Strings for component 'moodle', language 'zh_cn', branch 'MOODLE_26_STABLE'
 *
 * @package   moodle
...
$string['resortbyfullname'] = '依据完整名称';
$string['resortbyidnumber'] = '依据ID编号';
$string['resortbyshortname'] = '依据简称';
$string['resortcourses'] = '课程重新排列';
$string['resortsubcategoriesbyidnumber'] = '依据ID编号排列子类别';
$string['resortsubcategoriesbyname'] = '依据名称排列子类别';
$string['resource'] = '资源';
...
$string['sortcategoriesbyidnumber'] = '根据ID编号对类别排序';
$string['sortcategoriesbyname'] = '根据名称对类别排序';
$string['sortcoursesbyfullname'] = '根据完整名称对课程排序';
$string['sortcoursesbyidnumber'] = '根据ID编号对课程排序';
$string['sortcoursesbyshortname'] = '根据简称对课程排序';
$string['sorting'] = '排序';
