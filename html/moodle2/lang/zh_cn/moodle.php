...
/**
 * Strings for component 'moodle', language 'zh_cn', branch 'MOODLE_24_STABLE'
 *
 * @package   moodle
...
$string['dndenabled'] = '支持拖放';
$string['dndenabled_help'] = '你可以从桌面拖放一个或多个要上传的文件到下面的框。 <br />注：这个在其它浏览器中可能无法正常工作';
$string['dndenabled_inbox'] = '您可以通过拖放文件到此处来添加文件。';
$string['dndenabled_insentence'] = '支持拖放';
...
$string['returntomaincoursepage'] = '回到课程主页面';
