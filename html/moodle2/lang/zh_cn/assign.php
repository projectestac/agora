...
$string['requiresubmissionstatementassignment'] = '要求学生接受交作业条款';
$string['requiresubmissionstatementassignment_help'] = '要求学生在交作业的时候接受一个声明条款，该条款的默认内容是：“整个作品都是我自己完成的，除非在作品中我有声明某些地方有引用他人的成果”。

此声明的内容可以由网站管理员修改，修改方法是进入下面的位置进行重新设置：
网站管理► 插件► 活动模块► 作业';
$string['requiresubmissionstatement_help'] = '对于整个 Moodle 站点中的所有作业，要求学生在交作业的时候接受一个条款声明。如果此项设置没有启用，那么在每个作业的设置功能里面可以单独设定是否要求学生在提交作业的时候接受这么一个条款。';
