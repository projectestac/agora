...
$string['dodeletesite'] = '是的，彻底删除这个网站。';
$string['donotdeletesite'] = '哎呀，不要这么做。';
...
$string['imagestored'] = '您的图片将被存储在您的私人空间。';
$string['info'] = '信息';
...
$string['no'] = '否';
$string['notaskstobesynchronized'] = '没有需要被同步的任务';
$string['noteadded'] = '笔记已经被添加。';
$string['noticelargefile'] = '请注意您正在请求下载的文件很大，可能需要一段时间才能完成。';
$string['notificationpreferencesnotconfigured'] = '您的移动端通知选项可能尚未配置。请使用Web浏览器登录您的Moodle网站，然后在您的“个人资料”处进入“消息”设置。';
$string['notifications'] = '通知';
$string['notificationsdisabled'] = '通知已被禁用';
$string['notificationsenabled'] = '已启用您所有Moodle站点的通知';
$string['notificationsnotsupported'] = '在Android系统上，通知尚未被支持。';
$string['offlinemode'] = '离线模式';
$string['ok'] = '确定';
$string['participants'] = '人员';
$string['password'] = '密码';
