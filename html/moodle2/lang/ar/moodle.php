...
/**
 * Strings for component 'moodle', language 'ar', branch 'MOODLE_24_STABLE'
 *
 * @package   moodle
...
$string['dndenabled'] = 'السحب والإفلات ممكن';
$string['dndenabled_insentence'] = 'السحب والإفلات ممكن';
...
$string['name'] = 'الاسم';
$string['nameforpage'] = 'هل ترغي في استدعاء هذه الصفحة؟';
...
$string['returntomaincoursepage'] = 'إلي صفحة المقرر الدراسي الرئيسية';
