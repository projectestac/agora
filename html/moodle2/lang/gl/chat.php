...
/**
 * Strings for component 'chat', language 'gl', branch 'MOODLE_24_STABLE'
 *
 * @package   chat
...
$string['beep'] = 'Beep';
$string['cantlogin'] = 'Non se puido iniciar sesión na sala de conversa!!';
...
$string['chattime'] = 'Seguinte tempo de conversa';
$string['composemessage'] = 'Redactar unha mensaxe';
$string['configmethod'] = 'O método de conversa ajax fornece unha interface baseada en ajax, contacta regularmente co servidor para actualización. O método normal de conversa implica que os clientes contactan regularmente para as actualizacións. Non require configuración e funciona en calquera sitio pero pode producir unha longa carga no servidor con moitos participantes.  Usar un demo de servidor require acceso ao shell en Unix, mais resulta ser un entorno de conversa rapidamente escalábel.';
...
$string['configserverhost'] = 'O nome de host do computador onde está o demo de servidor';
$string['configserverip'] = 'O enderezo numérico IP que coincide co nome de host anterior';
$string['configservermax'] = 'Número máximo de clientes permitido';
$string['configserverport'] = 'Porto que usar no servidor para o demo';
$string['currentchats'] = 'Sesións activas de chat';
...
$string['explainmethoddaemon'] = 'Esta configuración é efectiva <strong>só</strong> de se seleccionar "Demo de conversa de servidor" para chat_method';
...
$string['messageyoubeep'] = 'Acaba de bipear vostede a {$a}';
$string['method'] = 'Método de conversa';
$string['methodajax'] = 'Método ajax';
$string['methoddaemon'] = 'Demo de servido para conversa';
...
A conversa pode ser unha actividade única ou poder repetirse á mesma hora cada día ou cada semana. As sesións de conversa gárdanse e poden ser dispoñibilizadas por calquera para ser ou restrinxir a usuarios coa capacidade de ver os rexistros de das sesións de conversa.

As conversas son especialmente útiles cando o grupo que conversa non pode realizar encontros cara a cara, tales como

* Reunións regulares dos estudantes que participan en cursos en liña para permitirlles compartir experiencias con outros no mesmo curso mais nunha localización diferente
* Un estudante non pode temporalmente asistir en persoa á soster unha conversa co seu profesor para lograr o seu progreso
* Os estudantes nunha práctica de traballo externa reúnense para discutir as súas experiencias entre eles e co seu profesor
...
* Sesións para para axudar os estudantes a se prepararen para probas nas que o profesor ou outros estudantes lle presentan algunhas preguntas de exemplo';
...
$string['pluginadministration'] = 'Administración de conversa';
...
$string['viewreport'] = 'Ver sesión pasadas de conversa';
