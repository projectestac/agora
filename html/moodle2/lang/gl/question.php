...
$string['categorymove'] = 'A categoría \'{$a->name}\' contén {$a->count} preguntas (algunhas das cales poden ser vellas, estaren agochadas ou seren preguntas que aínda están en uso nalgunhas probas). Escolla outra categoría á cal movelas.';
