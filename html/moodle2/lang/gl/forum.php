...
$string['event_assessable_uploaded'] = 'Algúns contidos foron publicados';
...
$string['markallread'] = 'Marcar todos os comentarios neste foro como lidos.';
...
Os comentarios de foro poden ser ponderados por profesores ou alumnos (avaliación por pares). As clasificacións poden seren engadidas a unha cualificación final que se rexistra no libro de cualificacións.
...
$string['nonews'] = 'Aínda non foi comentada ningunha';
...
$string['subscriptionmode_help'] = 'Cando un participante está subscrito a un foro significa que recibirán copias por correo electrónico dos comentarios do foro.
...
$string['trackingtype_help'] = 'Se está activado, os participantes poden seguir os comentarios lidos e os sen ler no foro e nas discusións. Hai tres opcións:

* Opcional - Os participantes poden escoller entre facer seguimento ou non mediante unha ligazón no bloque de administración. O seguimento do foro tamén debe estar activado na configuración do perfil do usuario.
* Forzado - O seguimento está sempre activado, sen importar a configuración do usuario. Dispoñíbel dependendo da configuración administrativa.
* Apagado - O seguimento está sempre desactivado.';
