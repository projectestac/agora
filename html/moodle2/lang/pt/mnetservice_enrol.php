...
$string['noroamingusers'] = 'Os utilizadores necessitam da capacidade \'{$a}\' no contexto do sistema para serem inscritos em cursos remotos, porém atualmente não existem utilizadores com essa capacidade. Clique no botão de continuar para atribuir a capacidade necessária a um ou mais papéis no seu site.';
