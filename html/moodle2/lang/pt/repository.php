...
$string['confirmdelete'] = 'Tem a certeza de que quer apagar o repositório "{$a}"?';
...
$string['confirmremove'] = 'Tem a certeza de que quer apagar o módulo de repositório "{$a}", incluindo as suas configurações e <strong>todas as suas instâncias</strong>?';
...
$string['errorpostmaxsize'] = 'O ficheiro carregado excede o max_post_size definido no php.ini.';
...
$string['nopermissiontoaccess'] = 'Não tem permissões para aceder a este repositório';
...
$string['popupblockeddownload'] = 'A janela de descarga está bloqueada. Desbloqueie as janelas de pop-up no browser e tente novamente.';
