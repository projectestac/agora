...
$string['auth_changepasswordurl_expl'] = 'Especifique o URL a enviar aos utilizadores que perderam a sua {$a} senha. Selecione <strong>Não</strong> no campo <strong>Usar página standard para alteração de senha</strong>';
$string['auth_changingemailaddress'] = 'Foi pedida uma alteração do e-mail  {$a->oldemail} para {$a->newemail}. Por questões de segurança, é enviada uma mensagem para o novo e-mail garantir que este lhe pertence. A alteração de e-mail terá efeito assim que abrir o URL enviado nessa mensagem.';
...
$string['informpasswordpolicy'] = 'A palavra-chave tem que ter {$a}';
...
$string['selfregistration'] = 'Autoregisto';
$string['selfregistration_help'] = 'Se estiver selecionado um módulo de autenticação como, por exemplo, o Autoregisto com confirmação por e-mail, então é possível aos utilizadores potenciais se registarem e criarem a sua conta de utilizador. Todavia isto torna também possível que spammers criem para usar os fóruns, blogs, etc. para inserir mensagens de spam (publicidade por exemplo). Para evitar estas situações, o autoregisto deve ser desativado ou limitado através da opção <em>Domínios de e-mail permitidos</em>';
...
$string['stdchangepassword'] = 'Usar a página standard para alterar a palavra-chave';
...
$string['suspended_help'] = 'Utilizadores com contas suspendidas não podem autenticar-se nem usar serviços Web e as mensagens que lhes forem enviadas serão eliminadas.';
