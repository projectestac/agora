...
$string['basicltisettings'] = 'Configuração do Basic Learning Tool Interoperability';
...
$string['configpassword'] = 'Senha predefinida da ferramenta';
...
$string['default_launch_container'] = 'Modo de visualização predefinido';
...
$string['extensions'] = 'Extension Services do LTI';
...
$string['launchinpopup'] = 'Pop-up de arranque';
...
$string['modulename'] = 'Ferramenta LTI';
...
$string['noltis'] = 'Não existem instâncias lti';
$string['noservers'] = 'Não foram encontrados servidores';
$string['notypes'] = 'De momento não existem ferramentas LTI configuradas no Moodle. Clique no link Instalar acima para adicionar algumas.';
...
$string['preferwidget'] = 'Widget de arranque predefinido';
