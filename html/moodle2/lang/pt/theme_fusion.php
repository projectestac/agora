...
/**
 * Strings for component 'theme_fusion', language 'pt', branch 'MOODLE_26_STABLE'
 *
...
$string['choosereadme'] = '<div class="clearfix">
	...
	<div class="theme_description">
		...
		<h2>Descrição</h2>
		<p>Fusion é um tema de duas colnas criado para o Moodle 2.0. Pode inserir menus personalizados que aparecem acima do título do site em cada página. Também inclui uma página de configurações básicas que lhe permite alterar a cor do link, adicionar um slogan acima do nome do site na página principal e adicionar texto para o rodapé.</p>
		...
		<h2>Autores</h2>
		<p>Este projecto foi originalmente criado por Natureza Digital (hello@digitalnature.ro) antes de ser criado para o Moodle por Patrick Malley (patrick@newschoollearning.com).
		<h2>Licença</h2>
...
$string['configtitle'] = 'Configurações do tema Fusion';
...
$string['linkcolordesc'] = 'Isto define a cor dos links para o tema.';
