...
$string['additionalinfo_help'] = 'Texto a exibir no topo da primeira página do questionário. (Ex. instruções, informação geral, etc.)';
$string['addnewquestion'] = 'A adicionar questão {$a}';
$string['addselqtype'] = 'Adicionar tipo de questão selecionada';
$string['alignment'] = 'Alinhamento dos botões';
...
$string['by'] = 'por';
$string['checkallradiobuttons'] = 'Selecione todos os <strong>{$a}</strong> botões de rádio!';
...
Se deixar tanto x como y com o seu valor predefinido de 0 (ou se o configurar para 0), então será exibido um editor HTML com valores standard de altura e largura (se estiver disponível no contexto disciplina/aluno & perfil do participante).';
...
$string['myresponsetitle'] = 'Suas {$a} resposta(s)';
$string['myresults'] = 'Resultados';
$string['name'] = 'Nome';
$string['next'] = 'Seguinte';
$string['nextpage'] = 'Página Seguinte';
$string['noanswer'] = 'Sem respostas';
...
$string['other'] = 'Outro:';
$string['otherempty'] = 'Se selecionar esta opção, deve introduzir um texto na caixa!';
