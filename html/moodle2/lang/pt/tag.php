...
/**
 * Strings for component 'tag', language 'pt', branch 'MOODLE_24_STABLE'
 *
 * @package   tag
...
$string['deletedcoursetags'] = 'Apagada(s) - palavras-chave da disciplina';
$string['description'] = 'Descrição';
$string['edittag'] = 'Editar esta palavra-chave';
$string['entertags'] = 'Inserir palavras-chave separadas por vírgulas';
$string['errordeleting'] = 'Ocorreu um erro ao apagar a palavra-chave com o id {$a},por favor informe o administrador da plataforma.';
...
$string['seeallblogs'] = 'Ver todos os blogues com esta palavra-chave';
$string['select'] = 'Selecionar';
$string['tag'] = 'Palavra-chave';
$string['tagdescription'] = 'Descrição de palavra-chave';
...
$string['thistaghasnodesc'] = 'Esta palavra-chave não contém, atualmente, qualquer descrição';
