...
$string['deadline'] = 'Até';
$string['defaultessayresponse'] = 'A sua resposta à pergunta de desenvolvimento será avaliada pelo professor da disciplina.';
...
$string['maximumnumberofanswersbranches_help'] = 'Esta opção define o número máximo de opções de resposta que podem ser definidas nas perguntas da lição. Se forem usadas apenas perguntas verdadeiro/falso, pode ser configurado para 2. Pode alterar esta opção a qualquer momento uma vez que afeta apenas o que o professor vê, e não a informação já guardada.';
...
$string['noanswer'] = 'Não foi dada qualquer resposta. Volte atrás e submeta uma resposta.';
