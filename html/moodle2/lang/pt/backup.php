...
/**
 * Strings for component 'backup', language 'pt', branch 'MOODLE_24_STABLE'
 *
 * @package   backup
...
$string['dependenciesenforced'] = 'As suas definições foram alteradas devido a dependências em falta';
