...
/**
 * Strings for component 'cohort', language 'pt', branch 'MOODLE_24_STABLE'
 *
 * @package   cohort
...
$string['cohort:assign'] = 'Atribuir membros ao grupo global';
$string['cohort:manage'] = 'Gerir grupos globais';
$string['cohorts'] = 'Grupos globais';
$string['cohortsin'] = '{$a}: grupos globais disponíveis';
$string['cohort:view'] = 'Usar grupos globais e ver membros';
