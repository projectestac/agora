...
$string['filtercontribonly'] = 'Mostrar apenas contribuições';
$string['filtercontribonlyactive'] = 'A mostrar apenas contribuições';
...
$string['notwritable_help'] = 'Ativou as atualizações automáticas de módulos através do navegador e está disponível uma atualização para este módulo. No entanto, os ficheiros do módulo não permitem a escrita pelo servidor web, por isso a atualização não pode ser instalada de momento.
...
$string['numextension'] = 'Contributos: {$a}';
