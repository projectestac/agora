...
/**
 * Strings for component 'group', language 'pt', branch 'MOODLE_24_STABLE'
 *
 * @package   group
...
$string['badnamingscheme'] = 'Tem de conter exatamente um carater \'@\' ou \'#';
...
$string['groupingsection_help'] = 'Um agrupamento é uma coleção de grupos dentro de uma disciplina. Se um agrupamento for aqui selecionado, unicamente os estudantes que pertençam a esse agrupamento terão acesso à seção.';
...
$string['selectfromrole'] = 'Selecionar membros com base no seu papel';
