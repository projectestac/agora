...
$string['groupingsection_help'] = 'Um agrupamento é uma coleção de grupos dentro de uma disciplina. Se um agrupamento for aqui selecionado, unicamente os alunos que pertençam a esse agrupamento terão acesso à seção.';
