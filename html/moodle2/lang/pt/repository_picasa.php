...
/**
 * Strings for component 'repository_picasa', language 'pt', branch 'MOODLE_24_STABLE'
 *
...
$string['oauthinfo'] = 'Para utilizar este modulo será necessário registar o seu site com o Google, como descrito na documentação  <a href="{$a->docsurl}">Google OAuth 2.0 setup</a>.</p><p>Como parte do processo de registo, será necessário digitar o seguinte URL \'Authorized Redirect URIs\':</p><p>{$a->callbackurl}</p>Uma vez registado, você será provido um utilizador e de uma senha que podem ser utilizados para configurar todos os módulos do Google Docs e do Picasa.</p>';
