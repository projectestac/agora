...
/**
 * Strings for component 'completion', language 'pt', branch 'MOODLE_24_STABLE'
 *
 * @package   completion
...
$string['activitiescompleted'] = 'Conclusão de atividades da disciplina';
$string['activitycompletion'] = 'Conclusão da atividade';
$string['afterspecifieddate'] = 'Após';
...
$string['completiondependencies'] = 'Pré-requisitos';
...
$string['completiononunenrolment'] = 'Conclusão com fim da inscrição';
...
$string['completionstartonenrol'] = 'Verificação da conclusão inicia com a inscrição';
$string['completionstartonenrolhelp'] = 'Inicie a verificação da conclusão da disciplina de um aluno numa disciplina logo após a sua inscrição na mesma.';
...
$string['coursesavailableexplaination'] = '<i>Os critérios de conclusão da disciplina devem estar definidos para que a mesma possa aparecer nesta lista</i>';
$string['criteria'] = 'Critérios';
$string['criteriagradenote'] = 'Note que nota exigida que aqui definir não altera a nota exigida para obter aprovação na disciplina.';
...
$string['days'] = 'Dias';
$string['daysafterenrolment'] = 'Tempo decorrido';
$string['deletecompletiondata'] = 'Apagar informação sobre conclusão';
$string['dependencies'] = 'Dependências';
$string['dependenciescompleted'] = 'Dependências completas';
$string['durationafterenrolment'] = 'Tempo decorrido após a inscrição';
...
$string['enrolmentduration'] = 'Dias remanescentes';
...
$string['err_noroles'] = 'Não existem papéis com a capacidade \'moodle/course:markcomplete\' nesta disciplina. Pode ativar este tipo de critério adicionando esta capacidade aos papéis.';
...
$string['err_settingslocked'] = 'Um ou mais alunos já verificaram uma das condições definidas por isso as opções de configuração foram bloqueadas.Desbloquear as opções de conclusão apagará as informações sobre conclusão até ao momento e poderá causar alguma confusão.';
...
$string['overallcriteriaaggregation'] = 'Forma de agregação dos diferentes conjuntos de critérios abaixo';
