...
$string['enablecompletion_help'] = 'Uma vez ativada, as definições de controlo de conclusão são exibidas na página de controlo de conclusão e das configurações da atividade.';
...
$string['manualselfcompletionnote'] = 'Nota: O bloco Autoconclusão deverá ser adicionado à disciplina se a auto-conclusão manual estiver ativada.';
