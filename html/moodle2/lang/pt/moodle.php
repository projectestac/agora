...
/**
 * Strings for component 'moodle', language 'pt', branch 'MOODLE_24_STABLE'
 *
 * @package   moodle
...
$string['availability_help'] = 'Esta configuração determina se a disciplina aparece na lista de disciplinas. Se a disciplina não estiver disponível para alunos, apenas os utilizadores com os papéis de "Professor" e "Administrador" poderão entrar na disciplina.';
...
$string['blockdeleteconfirm'] = 'Está a ponto de apagar completamente o bloco \'{$a}\'. Isso faz com que todos os dados relacionados com esse bloco sejam apagados da base de dados. Tem a certeza que quer continuar?';
$string['blockdeletefiles'] = 'Todos os dados associados ao bloco {$a->block} foram eliminados da base de dados. Para completar o processo de limpeza (e evitar que o bloco se re-instale), deverá agora apagar o seguinte pasta no seu servidor: {$a}->directory';
...
$string['category_help'] = 'Esta configuração determina a categoria em que a disciplina vai aparecer na lista de disciplinas.';
...
$string['courseuploadlimit'] = 'Tamanho máximo definido nas configurações da disciplina';
$string['create'] = 'Criar';
...
$string['dndenabled'] = 'Drag and drop disponivel';
$string['dndenabled_help'] = 'Pode arrastar um ou mais ficheiros do seu desktop e largá-los na caixa abaixo para envio. <br />Nota: Esta opção pode não funcionar em todos os navegadores';
$string['dndenabled_inbox'] = 'arraste para aqui os ficheiros para os carregar';
$string['dndenabled_insentence'] = 'drag and drop disponivel';
...
$string['errortoomanylogins'] = 'Desculpe, mas excedeu o número permitido de tentativas de acesso. Terá que reiniciar o seu browser.';
...
$string['format_help'] = 'O formato da disciplina determina o layout da página principal. Pode ser:

* Formato SCORM - Para a exibição de um pacote SCORM no primeiro tópico da página da disciplina (como uma alternativa ao uso do módulo SCORM AICC)
* Formato Social - É mostrado um fórum na página principal da disciplina
* Formato Tópicos - A página da disciplina é organizada por tópicos
...
$string['local'] = 'Local';
$string['localplugindeleteconfirm'] = 'Está prestes a apagar completamente o módulo local \'{$a}\'. Irá apagar completamente todos os dados na base de dados associados a este módulo. Tem a certeza que quer continuar?';
...
$string['loginusing'] = 'Para aceder tem de inserir o seu nome de utilizador e a sua senha';
$string['logout'] = 'Sair';
...
$string['maxnumberweeks_desc'] = 'Número máximo disponível na opção "Número de Semanas/Tópicos" nas configurações da disciplina.';
...
$string['moduledeleteconfirm'] = 'Está prestes a apagar completamente o módulo \'{$a}\'. Esta ação irá apagar tudo na base de dados associado com esta atividade. Tem a certeza que pretende continuar?';
$string['moduledeletefiles'] = 'Todos os dados associados ao módulo \'{$a->module}\' foram apagados da base de dados. Para completar a eliminação (e prevenir que o módulo se reinstale), deverá apagar agora esta pasta do seu servidor: {$a->directory}';
...
$string['nameforpage'] = 'Que nome deseja dar a esta página?';
...
$string['orphanedactivities'] = 'Atividades sem legado';
...
$string['returntomaincoursepage'] = 'Voltar à pagina principal';
...
$string['searchhelp'] = 'Pode procurar várias palavras de uma só vez.<br />palavra: procurar ocorrências desta palavra, isolada ou dentro de outras.<br />+palavra: procura apenas ocorrências que contenham a palavra exata.<br />-palavra: procura apenas ocorrências em que palavra não aparece.';
...
$string['updatethis'] = 'Atualizar este(a) {$a}';
