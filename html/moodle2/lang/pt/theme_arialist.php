...
/**
 * Strings for component 'theme_arialist', language 'pt', branch 'MOODLE_26_STABLE'
 *
...
$string['logodesc'] = 'Insira o URL de uma imagem para usar como logotipo para este site. Deve ser http://www.yoursite.com/path/to/logo.png';
...
$string['taglinedesc'] = 'Insira um curto slogan para ser exibido acima do nome do site na página inicial. <br /><em>(Não será exibido como logotipo.)</em>';
