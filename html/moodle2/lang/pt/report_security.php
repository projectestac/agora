...
$string['check_openprofiles_details'] = '<p>Os perfis de utilizador que permitem acesso público podem ser utilizados de forma abusiva por <em>spammers</em>. É recomendado que se Ative a configuração<br /> <strong>Apenas utilizadores autenticados podem aceder a perfis de outros utilizadores</strong> <br />ou <br /><strong>Apenas utilizadores autenticados podem aceder ao site</strong>.</p>';
