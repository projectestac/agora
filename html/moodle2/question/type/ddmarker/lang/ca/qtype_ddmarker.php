...
$string['confirmimagetargetconversion'] = 'Estàs apunt de convertir la pregunta basada en imatges de sota a una pregunta d\'arrossegar marcadors.';
...
$string['followingarewrongandhighlighted'] = 'Els marcadrod següents estan mal col·locats:  {$a}. El(s) marcador(s) destacats es mostren al lloc correcte .<br /> Fes clci al marcador per destacar l\'àrea permesa.';
$string['formerror_nobgimage'] = 'Has de triar una imatge de fons per fer servir a l\àrea d\'arrossegar i deixar anar.';
$string['formerror_noitemselected'] = 'Has triat una zona de destí però no has triat cap marcadro per arrossegar-hi';
...
$string['formerror_onlyusewholepositivenumbers'] = 'Si us plau fes servir només nombres sencers positius per especificar les coordeandes x,y i/o l\'amplada i alçada de les formes. Les coordenades per a {$a->shape} Les coordenades per a  - {$a->coordsstring}.';
...
$string['formerror_unrecognisedwidthheightpart'] = 'L\'amplada i alçada que has especificat no són vàlides. Les coordenades per a {$a->shape} s\'han d\'expressar - {$a->coordsstring}.';
