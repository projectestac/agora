...
class com_wiris_quizzes_impl_AssertionCheck extends com_wiris_util_xml_SerializableImpl {
	...
	public function newInstance() {
		return new com_wiris_quizzes_impl_AssertionCheck();
	}
	public function onSerialize($s) {
		$s->beginTag(com_wiris_quizzes_impl_AssertionCheck::$tagName);
	...
	function __toString() { return 'com.wiris.quizzes.impl.AssertionCheck'; }
}
