...
class com_wiris_quizzes_wrap_Wrapper {
	...
	static function getInstance() {
		if(com_wiris_quizzes_wrap_Wrapper::$wrapper === null) {
			com_wiris_quizzes_wrap_Wrapper::$wrapper = new com_wiris_quizzes_wrap_Wrapper();
		}
		return com_wiris_quizzes_wrap_Wrapper::$wrapper;
	}
	function __toString() { return 'com.wiris.quizzes.wrap.Wrapper'; }
}
