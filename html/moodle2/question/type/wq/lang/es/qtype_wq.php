...
$string['wirisquestionincorrect'] = 'Disculpe! El sistema no ha podido generar una de las preguntas del questionario.<br />Quizá hay ahora mismo un problema temporal de conexión.<br />Quizá el algoritmo de la pregunta tienen un error, y falla a veces.<br />Quizá fallará siempre.<br />No se preocupe...<br />Puede reintentar el questionario, sin penalización, simplemente clicando Continuar.<br />También puede avisar a los Profesores de que hay un problema con la pregunta titulada: \'{$a->questionname}\'';
