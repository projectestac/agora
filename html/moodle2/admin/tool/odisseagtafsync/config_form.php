...
class tool_odisseagtafsync_config_form extends moodleform {
    public function definition() {
        ...
        $mform->setType('inputpath', PARAM_TEXT);

        $mform->addElement('text', 'outputpath', get_string('outputfolderpath', 'tool_odisseagtafsync'));
        $mform->addHelpButton('outputpath', 'outputfolderpath', 'tool_odisseagtafsync');
        $mform->setType('outputpath', PARAM_TEXT);
