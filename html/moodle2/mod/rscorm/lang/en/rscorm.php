...
/**
 * Strings for component 'rscorm', language 'en'
 *
 * @package   rscorm
...
$string['dnduploadscorm'] = 'Add a SCORM/AICC package';
...
$string['mode'] = 'Mode';
$string['modulename'] = 'Remote SCORM/AICC';
$string['modulename_help'] = 'A SCORM/AICC is a collection of files which are packaged according to an agreed standard for learning objects. The RSCORM activity module enables SCORM/AICC or AICC packages to be uploaded as a zip file and added to a course.

Content is usually displayed over several pages, with navigation between the pages. There are various options for displaying content in a pop-up window, with a table of contents, with navigation buttons etc. SCORM/AICC activities generally include questions, with grades being recorded in the gradebook.

RSCORM activities may be used

* For presenting multimedia content and animations
* As an assessment tool';
$string['modulename_link'] = 'mod/rscorm/view';
$string['modulenameplural'] = 'Remote SCORMs/AICCs';
...
$string['noscriptnoscorm'] = 'Your browser does not support JavaScript or it has JavaScript support disabled. This SCORM/AICC may not play or save data correctly.';
...
$string['page-mod-rscorm-x'] = 'Any SCORM/AICC module page';
...
$string['packageurl_help'] = 'This setting enables a URL for the SCORM/AICC package to be specified, rather than choosing a file via the file picker.';
$string['passed'] = 'Passed';
$string['php5'] = 'PHP 5 (DOMXML native library)';
$string['pluginadministration'] = 'Remote SCORM/AICC administration';
$string['pluginname'] = 'Remote SCORM/AICC package';
...
$string['score'] = 'Score';
// MARSUPIAL ********** AFEGIT - to set it operative
$string['rscorm:deleteresponses'] = 'Delete SCORM attempts';
// ********** FI
$string['rscorm:addinstance'] = 'Add a new SCORM/AICC';
$string['rscormclose'] = 'Until';
$string['rscormcourse'] = 'Learning course';
$string['rscorm:deleteresponses'] = 'Delete SCORM attempts';
$string['rscormloggingoff'] = 'API logging is off';
$string['rscormloggingon'] = 'API logging is on';
$string['rscormopen'] = 'Open';
$string['rscormresponsedeleted'] = 'Deleted user attempts';
$string['rscorm:deleteownresponses'] = 'Delete own attempts';
// MARSUPIAL ********** MODIFICAT - to set it operative
$string['rscorm:savetrack'] = 'Save tracks';
$string['rscorm:skipview'] = 'Skip overview';
$string['rscorm:viewreport'] = 'View reports';
$string['rscorm:viewscores'] = 'View scores';
// ********** FI

$string['rscormtype'] = 'Type';
$string['rscormtype_help'] = 'This setting determines how the package is included in the course. There are up to 4 options:

* Uploaded package - Enables a SCORM/AICC package to be chosen via the file picker
* External RSCORM manifest - Enables an imsmanifest.xml URL to be specified. Note: If the URL has a different domain name than your site, then "Downloaded package" is a better option, since otherwise grades are not saved.
* Downloaded package - Enables a package URL to be specified. The package will be unzipped and saved locally, and updated when the external SCORM/AICC package is updated.
...
$string['typeexternal'] = 'External SCORM/AICC manifest';
...
$string['validationtype'] = 'This preference set the DOMXML library used for validating SCORM/AICC Manifest. If you don\'t know leave the selected choice.';
$string['value'] = 'Value';
...
$string['errorloadinstancebd']='Can not load instance form bd';
$string['errorloadcoursebd']='Can not load course id form bd';
$string['wsautenticationerror']='Authentication web services responsed with a error';
$string['documentdomain'] = "Document domain";
// ********** FI
