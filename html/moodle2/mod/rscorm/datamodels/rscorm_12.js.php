...
?>
//
// RSCORM 1.2 API Implementation
//
function RSCORMapi1_2() {
...
<?php
    ...
    require_once($CFG->dirroot.'/mod/rscorm/datamodels/callback.js.php');
?>
    ...
    function StoreData(data,storetotaltime) {
        ...
        //alert('going to:' + "<?php p($CFG->wwwroot) ?>/mod/rscorm/datamodel.php" + "id=<?php p($id) ?>&a=<?php p($a) ?>&sesskey=<?php echo sesskey() ?>"+datastring);
        result = DoRequest(myRequest,"<?php p($CFG->wwwroot) ?>/mod/rscorm/datamodel.php","id=<?php p($id) ?>&a=<?php p($a) ?>&sesskey=<?php echo sesskey() ?>"+datastring);
...
var API = new RSCORMapi1_2();

<?php
// pull in the debugging utilities
if (rscorm_debugging($scorm)) {
    include_once($CFG->dirroot.'/mod/rscorm/datamodels/debug.js.php');
    echo 'AppendToLog("Moodle RSCORM 1.2 API Loaded, Activity: '.$scorm->name.', SCO: '.$sco->identifier.'", 0);';
}
