<?php
$output = 'Wiris plugin is correctly installed.';
...
if (!file_exists($filterwiris)) {
    ...
    $output = $title . '<br />WIRIS plugin for TinyMCE needs that WIRIS plugin for Moodle 2.x is installed on your Moodle. ' . $info;
}
