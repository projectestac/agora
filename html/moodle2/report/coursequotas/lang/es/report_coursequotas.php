...
$string['disk_consume_repofiles'] = '<strong>{$a->figure} {$a->unit}</strong> utilizados en el repositorio "Fitxers"';
...
$string['disk_consume_temp'] = '<strong>{$a->figure} {$a->unit}</strong> utilizados en la carpeta temp (ficheros temporales pendientes de ser borrados por el cron)';
$string['disk_consume_trash'] = '<strong>{$a->figure} {$a->unit}</strong> utilizados en la carpeta trashdir (ficheros marcados como borrados y pendientes de ser borrados por el cron)';
