...
$string['disk_consume_repofiles'] = '<strong>{$a->figure} {$a->unit}</strong> utilitzats al repositori "Fitxers"';
...
$string['disk_consume_temp'] = '<strong>{$a->figure} {$a->unit}</strong> utilitzats a la carpeta temp (fitxers temporals pendents de ser esborrats pel cron)';
$string['disk_consume_trash'] = '<strong>{$a->figure} {$a->unit}</strong> utilitzats a la carpeta trashdir (fitxers marcats com a esborrats i pendents de ser esborrats pel cron)';
