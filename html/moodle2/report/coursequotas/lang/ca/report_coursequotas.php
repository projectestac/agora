...
$string['disk_consume_repofiles'] = '<strong>{$a->figure} {$a->unit}</strong> són al repositori "Fitxers"';
$string['disk_consume_courses'] = '<strong>{$a->figure} {$a->unit}</strong> són als cursos';
