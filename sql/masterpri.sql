...
-- Temps de generació: 25-01-2016 a les 18:35:10
...
(1, 2, 'members', 'last_activity', '', '', '', 0, NULL, '2016-01-25 15:30:12', 0, 0, 0, 0),
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1756 ;
...
(837, '_transient_random_seed', '25824d014915eb9fa7d509bd3afc3cf1', 'yes'),
(840, 'WPLANG', 'ca', 'yes'),
(841, 'db_upgraded', '', 'yes'),
...
(1746, '_transient_timeout_gce_feed_145', '1453736112', 'no'),
(1747, '_transient_gce_feed_145', 'a:0:{}', 'no'),
...
CREATE TABLE `wp_postmeta` (
  ...
  KEY `post_id` (`post_id`),
  KEY `meta_key` (`meta_key`(191))
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1185 ;
...
(28, 2, 'last_activity', '2016-01-25 15:30:12'),
