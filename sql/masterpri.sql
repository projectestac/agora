...
-- Temps de generació: 12-07-2016 a les 13:56:41
...
(1, 2, 'members', 'last_activity', '', '', '', 0, NULL, '2016-07-04 11:48:03', 0, 0, 0, 0),
(2, 1, 'members', 'last_activity', '', '', '', 0, NULL, '2016-06-06 13:41:00', 0, 0, 0, 0),
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=3302 ;
...
CREATE TABLE `wp_postmeta` (
  ...
  KEY `post_id` (`post_id`),
  KEY `meta_key` (`meta_key`(191))
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1204 ;
...
(704, 145, '_edit_lock', '1467632754:2'),
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=459 ;
...
(28, 2, 'last_activity', '2016-07-04 11:48:03'),
(29, 1, 'last_activity', '2016-06-06 13:41:00'),
...
(81, 2, 'session_tokens', 'a:1:{s:64:"c6b9fa08403b2f5b0ba601d383ab1da15b4530bbc701fd2b09332447f027a96d";a:4:{s:10:"expiration";i:1467793564;s:2:"ip";s:11:"10.155.7.35";s:2:"ua";s:76:"Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:47.0) Gecko/20100101 Firefox/47.0";s:5:"login";i:1467620764;}}');
