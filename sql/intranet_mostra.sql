...
--
-- Bolcant dades de la taula `zk_categories_mapmeta`
--
...
--
-- Bolcant dades de la taula `zk_content_content`
--
...
--
-- Bolcant dades de la taula `zk_content_history`
--
...
--
-- Bolcant dades de la taula `zk_content_page`
--
...
--
-- Bolcant dades de la taula `zk_content_pagecategory`
--
...
--
-- Bolcant dades de la taula `zk_content_searchable`
--
...
--
-- Bolcant dades de la taula `zk_content_translatedcontent`
--
...
--
-- Bolcant dades de la taula `zk_content_translatedpage`
--
...
--
-- Bolcant dades de la taula `zk_downloads_downloads`
--
...
--
-- Bolcant dades de la taula `zk_downloads_modrequest`
--
...
--
-- Bolcant dades de la taula `zk_group_applications`
--
...
--
-- Bolcant dades de la taula `zk_iw_agendas`
--
...
--
-- Bolcant dades de la taula `zk_iw_agendas_subs`
--
...
--
-- Bolcant dades de la taula `zk_iw_bookings`
--
...
--
-- Bolcant dades de la taula `zk_iw_books`
--
...
--
-- Bolcant dades de la taula `zk_iw_forms`
--
...
--
-- Bolcant dades de la taula `zk_iw_forms_cat`
--
...
--
-- Bolcant dades de la taula `zk_iw_forms_note`
--
...
--
-- Bolcant dades de la taula `zk_iw_forms_validator`
--
...
--
-- Bolcant dades de la taula `zk_iw_forums_msg`
--
...
--
-- Bolcant dades de la taula `zk_iw_forums_temes`
--
...
--
-- Bolcant dades de la taula `zk_iw_jclic`
--
...
--
-- Bolcant dades de la taula `zk_iw_jclic_activities`
--
...
--
-- Bolcant dades de la taula `zk_iw_jclic_groups`
--
...
--
-- Bolcant dades de la taula `zk_iw_jclic_sessions`
--
...
--
-- Bolcant dades de la taula `zk_iw_jclic_users`
--
...
--
-- Bolcant dades de la taula `zk_iw_messages`
--
...
--
-- Bolcant dades de la taula `zk_iw_moodle`
--
...
--
-- Bolcant dades de la taula `zk_iw_noteboard`
--
...
--
-- Bolcant dades de la taula `zk_iw_noteboard_public`
--
...
--
-- Bolcant dades de la taula `zk_iw_qv`
--
...
--
-- Bolcant dades de la taula `zk_iw_qv_assignments`
--
...
--
-- Bolcant dades de la taula `zk_iw_qv_messages`
--
...
--
-- Bolcant dades de la taula `zk_iw_qv_messages_read`
--
...
--
-- Bolcant dades de la taula `zk_iw_qv_sections`
--
...
--
-- Bolcant dades de la taula `zk_iw_users_aux`
--
...
--
-- Bolcant dades de la taula `zk_iw_users_friends`
--
...
--
-- Bolcant dades de la taula `zk_iw_users_import`
--
...
--
-- Bolcant dades de la taula `zk_iw_webbox`
--
...
--
-- Bolcant dades de la taula `zk_module_deps`
--
...
--
-- Bolcant dades de la taula `zk_objectdata_log`
--
...
--
-- Bolcant dades de la taula `zk_objectdata_meta`
--
...
--
-- Bolcant dades de la taula `zk_pagelock`
--
...
--
-- Bolcant dades de la taula `zk_pages`
--
...
--
-- Bolcant dades de la taula `zk_quotes`
--
...
--
-- Bolcant dades de la taula `zk_referer`
--
...
--
-- Bolcant dades de la taula `zk_sc_anticracker`
--
...
--
-- Bolcant dades de la taula `zk_sc_log_event`
--
...
--
-- Bolcant dades de la taula `zk_search_result`
--
...
--
-- Bolcant dades de la taula `zk_search_stat`
--
...
--
-- Bolcant dades de la taula `zk_userblocks`
--
...
--
-- Bolcant dades de la taula `zk_users_temp`
--
...
--
-- Bolcant dades de la taula `zk_workflows`
--
