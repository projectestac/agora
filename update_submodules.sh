...
if [[ $execmoodle == true ]]; then
    ...
    gitcheckout "html/moodle2/mod/hvp" "release" "https://github.com/h5p/h5p-moodle-plugin.git"
    gitcheckout "html/moodle2/mod/hvp/editor" "release" "https://github.com/h5p/h5p-editor-php-library.git"
    gitcheckout "html/moodle2/mod/hvp/library" "release" "https://github.com/h5p/h5p-php-library.git"
    ...
    gitcheckout "html/moodle2/question/type/ordering" "master" "https://github.com/toniginard/moodle-qtype_ordering.git"
