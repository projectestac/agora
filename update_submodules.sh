...
if [[ $execmoodle == true ]]; then
    ...
    gitcheckout "html/moodle2/blocks/grade_me" "MOODLE_405_STABLE" "https://github.com/remotelearner/moodle-block_grade_me.git"
    gitcheckout "html/moodle2/blocks/importrubric" "main" "https://github.com/ingrichardrangel/moodle-block_importrubric.git"
    ...
    gitcheckout "html/moodle2/lib/editor/tiny/plugins/fontfamily" "main" "https://github.com/mediamaisteri/moodle-tiny_fontfamily.git"
    ...
    gitcheckout "html/moodle2/mod/board" "MOODLE_405_STABLE" "https://github.com/brickfield/moodle-mod_board.git"
    ...
    gitcheckout "html/moodle2/question/bank/purgecategory" "master" "https://github.com/vadimonus/moodle-qbank_purgecategory.git"
    gitcheckout "html/moodle2/question/behaviour/adaptive_adapted_for_coderunner" "master" "https://github.com/trampgeek/moodle-qbehaviour_adaptive_adapted_for_coderunner.git"
    gitcheckout "html/moodle2/question/format/hotpot" "master" "https://github.com/gbateson/moodle-qformat_hotpot.git"
    gitcheckout "html/moodle2/question/type/coderunner" "master" "https://github.com/trampgeek/moodle-qtype_coderunner.git"
    ...
    gitcheckout "html/moodle2/report/questionbankoverview" "master" "https://github.com/projectestac/moodle-report_questionbankoverview.git"
...
if [[ $execwordpress == true ]]; then
    ...
    gitcheckout "html/wordpress/wp-content/plugins/bp-classic" "master" "https://github.com/projectestac/wordpress-bp-classic.git"
    ...
    gitcheckout "html/wordpress/wp-content/plugins/enllacos-educatius" "master" "https://github.com/projectestac/wordpress-enllacos-educatius.git"
