...
if [[ $execmoodle == true ]]; then
    ...
    gitcheckout "html/moodle2/blocks/configurable_reports" "MOODLE_401_STABLE" "https://github.com/jleyva/moodle-block_configurablereports.git"
    ...
    gitcheckout "html/moodle2/course/format/tiles" "moodle41b" "https://bitbucket.org/dw8/moodle-format_tiles.git"
