...
--
-- Servidor: localhost
-- Temps de generació: 07-03-2012 a les 13:12:07
...
--
-- Bolcant dades de la taula `zk_Files`
--

INSERT INTO `zk_Files` (`fileId`, `userId`, `diskUse`, `obj_status`, `cr_date`, `cr_uid`, `lu_date`, `lu_uid`) VALUES
(1, 10, 0, 'A', '2012-03-06 15:56:18', 10, '2012-03-06 15:56:18', 10);
...
--
-- Bolcant dades de la taula `zk_IWstats`
--

INSERT INTO `zk_IWstats` (`iw_statsid`, `iw_datetime`, `iw_ip`, `iw_moduleid`, `iw_params`, `iw_uid`, `iw_isadmin`, `iw_skippedModule`, `iw_skipped`) VALUES
(1, '2012-03-06 15:56:11', '192.168.56.1', 12, 'ccentre=usu2&module=users&func=login', 0, 0, 0, 0),
(2, '2012-03-06 15:56:18', '192.168.56.1', 108, 'ccentre=usu2&module=Files', 10, 1, 0, 0),
(3, '2012-03-06 15:56:25', '192.168.56.1', 27, 'ccentre=usu2&op=logout', 10, 1, 0, 0);
...
--
-- Bolcant dades de la taula `zk_iw_main`
--

INSERT INTO `zk_iw_main` (`iw_id`, `iw_module`, `iw_name`, `iw_value`, `iw_uid`, `iw_lifetime`, `iw_nult`, `pn_obj_status`, `pn_cr_date`, `pn_cr_uid`, `pn_lu_date`, `pn_lu_uid`) VALUES
(1, 'iw_agendas', 'calendar', '<script language="javascript">\r\n	<!-- overLIB configuration -->\r\n	ol_fgcolor = "lightyellow"; \r\n	ol_bgcolor = "#FFFFFF"; \r\n	ol_textcolor = "#000000";\r\n	ol_capcolor = "#e7e7e7";\r\n	ol_closecolor = "#000000"; \r\n	ol_textfont = "Verdana,Arial,Helvetica"; \r\n	ol_captionfont = "Verdana,Arial,Helvetica";\r\n	ol_captionsize = 2; \r\n	ol_textsize = 2; \r\n	ol_border = 2; \r\n	ol_width = 350; \r\n	ol_offsetx = 10; \r\n	ol_offsety = 10;\r\n	ol_sticky = 0; \r\n	ol_close = "Tanca"; \r\n	ol_closeclick = 0; \r\n	ol_autostatus = 2; \r\n	ol_snapx = 0; \r\n	ol_snapy = 0;\r\n	ol_fixx = -1; \r\n	ol_fixy = -1; \r\n	ol_background = ""; \r\n	ol_fgbackground = ""; \r\n	ol_bgbackground = "";\r\n	ol_padxl = 1; \r\n	ol_padxr = 1; \r\n	ol_padyt = 1; \r\n	ol_padyb = 1; \r\n	ol_capicon = ""; \r\n	ol_hauto = 1; \r\n	ol_vauto = 1;\r\n	if (document.getElementById(''overDiv'')==null) {\r\n		document.writeln(''<div id="overDiv" style="position:absolute; top:0px; left:0px; visibility:hidden; z-index:1000;"></div>'');\r\n	}\r\n</script>\r\n\r\n<script language="JavaScript" src="modules/iw_main/js/overlib.js"><!-- overLIB (c) Erik Bosrup --></script>\r\n<script language="JavaScript" src="modules/iw_agendas/pnjavascript/iw_agendas.js"></script>\r\n<script type="text/javascript" src="javascript/ajax/prototype.js"></script> \r\n<script type="text/javascript" src="javascript/ajax/pnajax.js"></script>\r\n\r\n<div name="calendarContent" id="calendarContent">\r\n	<table cellpadding="0" style="width:100%; border: 2px solid #FFFFFF; background-color:#E1EBFF">\n		<tr>\n		<td align="center" bgcolor="#DBD4A6" colspan="7">\n			<a href="javascript:calendarBlockMonth(2,2012)">\n				<img src="/agora/usu2/intranet/modules/iw_agendas/pnimages/mesmenys.gif" alt="Mes anterior" title="Mes anterior" width="19" height="10" />\n			</a>\n			<a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012" style="color:#555555">\n				<strong>Març&nbsp;2012</strong>\n			</a>\n			<a href="javascript:calendarBlockMonth(4,2012)">\n				<img src="/agora/usu2/intranet/modules/iw_agendas/pnimages/mesmes.gif" alt="Mes següent" title="Mes següent" width="19" height="10" />\n			</a>\n		</td>\n	</tr>\n		<tr>\n	 <!-- Header with the name of the day abbreviated -->\n		<td style="color:#FFFFFF; background:#FFCC66; text-align:center;">Dl</td>\n	 <!-- Header with the name of the day abbreviated -->\n		<td style="color:#FFFFFF; background:#FFCC66; text-align:center;">Dm</td>\n	 <!-- Header with the name of the day abbreviated -->\n		<td style="color:#FFFFFF; background:#FFCC66; text-align:center;">Dc</td>\n	 <!-- Header with the name of the day abbreviated -->\n		<td style="color:#FFFFFF; background:#FFCC66; text-align:center;">Dj</td>\n	 <!-- Header with the name of the day abbreviated -->\n		<td style="color:#FFFFFF; background:#FFCC66; text-align:center;">Dv</td>\n	 <!-- Header with the name of the day abbreviated -->\n		<td style="color:#FFFFFF; background:#FFCC66; text-align:center;">Ds</td>\n	 <!-- Header with the name of the day abbreviated -->\n		<td style="color:#FFFFFF; background:#FFCC66; text-align:center;">Dg</td>\n		</tr>\n		<tr>\n	 		 	\n			 				<td style="width:14.27%; text-align:center;">&nbsp;</td><td style="width:14.27%; text-align:center;">&nbsp;</td><td style="width:14.27%; text-align:center;">&nbsp;</td> \n				\n				\n							<td style="width:14.27%; background:#99CCFF; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dijous&nbsp;&nbsp;1/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=1">1</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#99CCFF; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Divendres&nbsp;&nbsp;2/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=2">2</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF8484; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dissabte&nbsp;&nbsp;3/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#FFFFFF;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=3">3</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF8484; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Diumenge&nbsp;&nbsp;4/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#FFFFFF;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=4">4</a></span>\n				</td>\n						 		 	\n				\n			 				</tr><tr>\n				\n							<td style="width:14.27%; background:#99CCFF; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dilluns&nbsp;&nbsp;5/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=5">5</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#DBD4A6; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dimarts&nbsp;&nbsp;6/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=6">6</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#99CCFF; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dimecres&nbsp;&nbsp;7/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=7">7</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#99CCFF; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dijous&nbsp;&nbsp;8/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=8">8</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#99CCFF; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Divendres&nbsp;&nbsp;9/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=9">9</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF8484; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dissabte&nbsp;&nbsp;10/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#FFFFFF;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=10">10</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF8484; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Diumenge&nbsp;&nbsp;11/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#FFFFFF;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=11">11</a></span>\n				</td>\n						 		 	\n				\n			 				</tr><tr>\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dilluns&nbsp;&nbsp;12/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=12">12</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dimarts&nbsp;&nbsp;13/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=13">13</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dimecres&nbsp;&nbsp;14/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=14">14</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dijous&nbsp;&nbsp;15/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=15">15</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Divendres&nbsp;&nbsp;16/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=16">16</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF8484; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dissabte&nbsp;&nbsp;17/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#FFFFFF;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=17">17</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF8484; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Diumenge&nbsp;&nbsp;18/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#FFFFFF;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=18">18</a></span>\n				</td>\n						 		 	\n				\n			 				</tr><tr>\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dilluns&nbsp;&nbsp;19/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=19">19</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dimarts&nbsp;&nbsp;20/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=20">20</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dimecres&nbsp;&nbsp;21/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=21">21</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dijous&nbsp;&nbsp;22/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=22">22</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Divendres&nbsp;&nbsp;23/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=23">23</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF8484; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dissabte&nbsp;&nbsp;24/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#FFFFFF;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=24">24</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF8484; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Diumenge&nbsp;&nbsp;25/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#FFFFFF;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=25">25</a></span>\n				</td>\n						 		 	\n				\n			 				</tr><tr>\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dilluns&nbsp;&nbsp;26/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=26">26</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dimarts&nbsp;&nbsp;27/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=27">27</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dimecres&nbsp;&nbsp;28/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=28">28</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dijous&nbsp;&nbsp;29/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=29">29</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Divendres&nbsp;&nbsp;30/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=30">30</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF8484; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dissabte&nbsp;&nbsp;31/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#FFFFFF;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=31">31</a></span>\n				</td>\n							</tr>\n</table></div>', -1, '1331050052', 1, 'A', '2012-03-06 15:55:52', 0, '2012-03-06 15:55:52', 0),
(2, 'iw_agendas', 'month', '', -1, '1336233352', 0, 'A', '2012-03-06 15:55:52', 0, '2012-03-06 15:55:52', 0),
(3, 'iw_agendas', 'next', '<script language="JavaScript1.2">\r\n\r\n	//Translucent scroller- By Dynamic Drive\r\n	//For full source code and more DHTML scripts, visit http://www.dynamicdrive.com\r\n	//This credit MUST stay intact for use\r\n	\r\n	var scroller_width=''95%''\r\n	var scroller_height=''80px''\r\n	var bgcolor=''lightyellow''\r\n	var pause=3000 //SET PAUSE BETWEEN SLIDE (3000=3 seconds)\r\n	\r\n	var scrollercontent=new Array()\r\n	\r\n			var id=0\r\n		scrollercontent[id]=''No tens anotacions a l&acute;agenda per als propers 7 dies''\r\n	\r\n	////NO need to edit beyond here/////////////\r\n	\r\n	var ie4=document.all\r\n	var dom=document.getElementById&&navigator.userAgent.indexOf("Opera")==-1\r\n	\r\n	if (ie4||dom)\r\n	   document.write(''<div style="position:relative;width:''+scroller_width+'';height:''+scroller_height+'';overflow:hidden"><div id="canvas0" style="position:absolute;background-color:''+bgcolor+'';width:''+scroller_width+'';height:''+scroller_height+'';top:''+scroller_height+'';filter:alpha(opacity=20);-moz-opacity:0.2; padding: 5px;"></div><div id="canvas1" style="position:absolute;background-color:''+bgcolor+'';width:''+scroller_width+'';height:''+scroller_height+'';top:''+scroller_height+'';filter:alpha(opacity=20);-moz-opacity:0.2; padding: 5px;"></div></div>'')\r\n	else if (document.layers) {\r\n	   document.write(''<ilayer id=tickernsmain visibility=hide width=''+scroller_width+'' height=''+scroller_height+'' bgColor=''+bgcolor+''><layer id=tickernssub width=''+scroller_width+'' height=''+scroller_height+'' left=0 top=0>''+scrollercontent[0]+''</layer></ilayer>'')\r\n	}\r\n	\r\n	var curpos=scroller_height*(1)\r\n	var degree=10\r\n	var curcanvas="canvas0"\r\n	var curindex=0\r\n	var nextindex=1\r\n	\r\n	function moveslide(){\r\n	   if (curpos>0) {\r\n		  curpos=Math.max(curpos-degree,0)\r\n		  tempobj.style.top=curpos+"px"\r\n	   } else {\r\n		  clearInterval(dropslide)\r\n		  if (crossobj.filters)\r\n		  crossobj.filters.alpha.opacity=100\r\n		  else if (crossobj.style.MozOpacity)\r\n		  crossobj.style.MozOpacity=1\r\n		  nextcanvas=(curcanvas=="canvas0")? "canvas0" : "canvas1"\r\n		  tempobj=ie4? eval("document.all."+nextcanvas) : document.getElementById(nextcanvas)\r\n		  tempobj.innerHTML=scrollercontent[curindex]\r\n		  nextindex=(nextindex<scrollercontent.length-1)? nextindex+1 : 0\r\n		  setTimeout("rotateslide()",pause)\r\n	   }\r\n	}\r\n	\r\n	function rotateslide() {\r\n	   if (ie4||dom){\r\n		  resetit(curcanvas)\r\n		  crossobj=tempobj=ie4? eval("document.all."+curcanvas) : document.getElementById(curcanvas)\r\n		  crossobj.style.zIndex++\r\n		  if (crossobj.filters)\r\n		  document.all.canvas0.filters.alpha.opacity=document.all.canvas1.filters.alpha.opacity=20\r\n		  else if (crossobj.style.MozOpacity)\r\n		  document.getElementById("canvas0").style.MozOpacity=document.getElementById("canvas1").style.MozOpacity=0.2\r\n		  var temp=''setInterval("moveslide()",50)''\r\n		  dropslide=eval(temp)\r\n		  curcanvas=(curcanvas=="canvas0")? "canvas1" : "canvas0"\r\n	   }\r\n	   else if (document.layers){\r\n		  crossobj.document.write(scrollercontent[curindex])\r\n		  crossobj.document.close()\r\n	   }\r\n	   curindex=(curindex<scrollercontent.length-1)? curindex+1 : 0\r\n	}\r\n	\r\n	function resetit(what){\r\n	   curpos=parseInt(scroller_height)*(1)\r\n	   var crossobj=ie4? eval("document.all."+what) : document.getElementById(what)\r\n	   crossobj.style.top=curpos+"px"\r\n	}\r\n	\r\n	function startit(){\r\n	   crossobj=ie4? eval("document.all."+curcanvas) : dom? document.getElementById(curcanvas) : document.tickernsmain.document.tickernssub\r\n	   if (ie4||dom){\r\n		  crossobj.innerHTML=scrollercontent[curindex]\r\n		  rotateslide()\r\n		 crossobj.onclick=new Function("window.open(''index.php?module=iw_agendas'',''_parent'')");\r\n	   }else{\r\n		 document.tickernsmain.visibility=''show''\r\n		 curindex++\r\n		 setInterval("rotateslide()",pause)\r\n	   }\r\n	}\r\n	\r\n	// if (ie4||dom||document.layers)\r\n	// window.onload=startit\r\n	if (ie4||dom||document.layers) startit();\r\n	\r\n</script>\r\n\r\nEn els propers 7 dies\n<div style="height: 20px;"></div>\r', -1, '1331050052', 1, 'A', '2012-03-06 15:55:52', 0, '2012-03-06 15:55:52', 0),
(4, 'iw_vhmenu', 'userMenu', '<script type="text/javascript">\n		// HV Menu by Ger Versluis (http://www.burmees.nl/)\n		// Submitted to Dynamic Drive (http://www.dynamicdrive.com)\n		// Visit http://www.dynamicdrive.com for this script and more\n		function Go(){ return; }\n		var NoOffFirstLineMenus=1;		// Number of first level items\n		var LowBgColor=''#efedde'';						// Background color when mouse is not over\n		var LowSubBgColor=''#efedde'';					// Background color when mouse is not over on subs\n		var HighBgColor=''#b3cadb'';						// Background color when mouse is over\n		var HighSubBgColor=''#b3cadb'';				// Background color when mouse is over on subs\n		var FontLowColor=''#000000'';					// Font color when mouse is not over\n		var FontSubLowColor=''#000000'';				// Font color subs when mouse is not over\n		var FontHighColor=''#000000'';					// Font color when mouse is over\n		var FontSubHighColor=''#000000'';			// Font color subs when mouse is over\n		var BorderColor=''#ffffff'';						// Border color\n		var BorderSubColor=''#ffffff'';				// Border color for subs\n		var BorderWidth=1;						// Border width\n		var BorderBtwnElmnts=1;				// Border between elements 1 or 0\n		var FontFamily=''Tahoma, Verdana, Arial, Helvetica, sans-serif'';						// Font family menu items\n		var FontSize=9;								// Font size menu items\n		var FontBold=0;								// Bold menu items 1 or 0\n		var FontItalic=0;							// Italic menu items 1 or 0\n		var MenuTextCentered=''center'';			// Item text position ''left'', ''center'' or ''right''\n		var MenuCentered=''left'';					// Menu horizontal position ''left'', ''center'' or ''right''\n		var MenuVerticalCentered=''top'';	// Menu vertical position ''top'', ''middle'',''bottom'' or static\n		var ChildOverlap=0.1;						// horizontal overlap child/ parent\n		var ChildVerticalOverlap=0.1;		// vertical overlap child/ parent\n		var StartTop=120;								// Menu offset x coordinate\n		var StartLeft=10;							// Menu offset y coordinate\n		var VerCorrect=0;							// Multiple frames y correction\n		var HorCorrect=0;							// Multiple frames x correction\n		var LeftPaddng=3;							// Left padding\n		var TopPaddng=2;							// Top padding\n		var FirstLineHorizontal=1;		// SET TO 1 FOR HORIZONTAL MENU, 0 FOR VERTICAL\n		var MenuFramesVertical=1;			// Frames in cols or rows 1 or 0\n		var DissapearDelay=1000;					// delay before menu folds in\n		var TakeOverBgColor=1;				// Menu frame takes over background color subitem frame\n		var FirstLineFrame=''navig'';				// Frame where first level appears\n		var SecLineFrame=''space'';					// Frame where sub levels appear\n		var DocTargetFrame=''space'';				// Frame where target documents appear\n		var TargetLoc='''';							// span id for relative positioning\n		var HideTop=0;								// Hide first level when loading new document 1 or 0\n		var MenuWrap=1;								// enables/ disables menu wrap 1 or 0\n		var RightToLeft=0;						// enables/ disables right to left unfold 1 or 0\n		var UnfoldsOnClick=0;					// Level 1 unfolds onclick/ onmouseover\n		var WebMasterCheck=0;					// menu tree checking on or off 1 or 0\n		var ShowArrow=1;							// Uses arrow gifs when 1\n		var KeepHilite=1;							// Keep selected path highligthed\n		var Arrws=[''modules/iw_vhmenu/pnimages/tri.gif'',5,10,''modules/iw_vhmenu/pnimages/tridown.gif'',10,5,''modules/iw_vhmenu/pnimages/trileft.gif'',5,10];	// Arrow source, width and height\n		\n		function BeforeStart(){return}\n		function AfterBuild(){return}\n		function BeforeFirstOpen(){return}\n		function AfterCloseAll(){return}\nMenu1=new Array("Inici", "index.php", "", 0, 23, 80);\n</script>\n<script type="text/javascript" src="modules/iw_vhmenu/javascript/menu_com.js"></script>\n', -1, '1331049952', 1, 'A', '1970-01-01 00:00:00', 0, '1970-01-01 00:00:00', 0),
(5, 'iw_main_block_news', 'news', 'No tens novetats', 10, '1331050079', 1, 'A', '1970-01-01 00:00:00', 0, '1970-01-01 00:00:00', 0),
(6, 'iw_main_block_flagged', 'flagged', '', 10, '1331049979', 1, 'A', '1970-01-01 00:00:00', 0, '1970-01-01 00:00:00', 0),
(7, 'iw_noteboard', 'nbtopics', '	<div style="padding-left: 10px;">\n		<a href="index.php?module=iw_noteboard&amp;tema=2">Comunitat</a>\n	</div>\n<div style="height: 20px">&nbsp;</div>', 10, '1331051372', 1, 'A', '1970-01-01 00:00:00', 0, '1970-01-01 00:00:00', 0),
(8, 'iw_agendas', 'calendar', '<script language="javascript">\r\n	<!-- overLIB configuration -->\r\n	ol_fgcolor = "lightyellow"; \r\n	ol_bgcolor = "#FFFFFF"; \r\n	ol_textcolor = "#000000";\r\n	ol_capcolor = "#e7e7e7";\r\n	ol_closecolor = "#000000"; \r\n	ol_textfont = "Verdana,Arial,Helvetica"; \r\n	ol_captionfont = "Verdana,Arial,Helvetica";\r\n	ol_captionsize = 2; \r\n	ol_textsize = 2; \r\n	ol_border = 2; \r\n	ol_width = 350; \r\n	ol_offsetx = 10; \r\n	ol_offsety = 10;\r\n	ol_sticky = 0; \r\n	ol_close = "Tanca"; \r\n	ol_closeclick = 0; \r\n	ol_autostatus = 2; \r\n	ol_snapx = 0; \r\n	ol_snapy = 0;\r\n	ol_fixx = -1; \r\n	ol_fixy = -1; \r\n	ol_background = ""; \r\n	ol_fgbackground = ""; \r\n	ol_bgbackground = "";\r\n	ol_padxl = 1; \r\n	ol_padxr = 1; \r\n	ol_padyt = 1; \r\n	ol_padyb = 1; \r\n	ol_capicon = ""; \r\n	ol_hauto = 1; \r\n	ol_vauto = 1;\r\n	if (document.getElementById(''overDiv'')==null) {\r\n		document.writeln(''<div id="overDiv" style="position:absolute; top:0px; left:0px; visibility:hidden; z-index:1000;"></div>'');\r\n	}\r\n</script>\r\n\r\n<script language="JavaScript" src="modules/iw_main/js/overlib.js"><!-- overLIB (c) Erik Bosrup --></script>\r\n<script language="JavaScript" src="modules/iw_agendas/pnjavascript/iw_agendas.js"></script>\r\n<script type="text/javascript" src="javascript/ajax/prototype.js"></script> \r\n<script type="text/javascript" src="javascript/ajax/pnajax.js"></script>\r\n\r\n<div name="calendarContent" id="calendarContent">\r\n	<table cellpadding="0" style="width:100%; border: 2px solid #FFFFFF; background-color:#E1EBFF">\n		<tr>\n		<td align="center" bgcolor="#DBD4A6" colspan="7">\n			<a href="javascript:calendarBlockMonth(2,2012)">\n				<img src="/agora/usu2/intranet/modules/iw_agendas/pnimages/mesmenys.gif" alt="Mes anterior" title="Mes anterior" width="19" height="10" />\n			</a>\n			<a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012" style="color:#555555">\n				<strong>Març&nbsp;2012</strong>\n			</a>\n			<a href="javascript:calendarBlockMonth(4,2012)">\n				<img src="/agora/usu2/intranet/modules/iw_agendas/pnimages/mesmes.gif" alt="Mes següent" title="Mes següent" width="19" height="10" />\n			</a>\n		</td>\n	</tr>\n		<tr>\n	 <!-- Header with the name of the day abbreviated -->\n		<td style="color:#FFFFFF; background:#FFCC66; text-align:center;">Dl</td>\n	 <!-- Header with the name of the day abbreviated -->\n		<td style="color:#FFFFFF; background:#FFCC66; text-align:center;">Dm</td>\n	 <!-- Header with the name of the day abbreviated -->\n		<td style="color:#FFFFFF; background:#FFCC66; text-align:center;">Dc</td>\n	 <!-- Header with the name of the day abbreviated -->\n		<td style="color:#FFFFFF; background:#FFCC66; text-align:center;">Dj</td>\n	 <!-- Header with the name of the day abbreviated -->\n		<td style="color:#FFFFFF; background:#FFCC66; text-align:center;">Dv</td>\n	 <!-- Header with the name of the day abbreviated -->\n		<td style="color:#FFFFFF; background:#FFCC66; text-align:center;">Ds</td>\n	 <!-- Header with the name of the day abbreviated -->\n		<td style="color:#FFFFFF; background:#FFCC66; text-align:center;">Dg</td>\n		</tr>\n		<tr>\n	 		 	\n			 				<td style="width:14.27%; text-align:center;">&nbsp;</td><td style="width:14.27%; text-align:center;">&nbsp;</td><td style="width:14.27%; text-align:center;">&nbsp;</td> \n				\n				\n							<td style="width:14.27%; background:#99CCFF; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dijous&nbsp;&nbsp;1/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=1">1</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#99CCFF; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Divendres&nbsp;&nbsp;2/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=2">2</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF8484; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dissabte&nbsp;&nbsp;3/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#FFFFFF;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=3">3</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF8484; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Diumenge&nbsp;&nbsp;4/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#FFFFFF;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=4">4</a></span>\n				</td>\n						 		 	\n				\n			 				</tr><tr>\n				\n							<td style="width:14.27%; background:#99CCFF; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dilluns&nbsp;&nbsp;5/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=5">5</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#DBD4A6; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dimarts&nbsp;&nbsp;6/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=6">6</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#99CCFF; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dimecres&nbsp;&nbsp;7/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=7">7</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#99CCFF; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dijous&nbsp;&nbsp;8/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=8">8</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#99CCFF; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Divendres&nbsp;&nbsp;9/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=9">9</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF8484; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dissabte&nbsp;&nbsp;10/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#FFFFFF;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=10">10</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF8484; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Segon trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Diumenge&nbsp;&nbsp;11/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#FFFFFF;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=11">11</a></span>\n				</td>\n						 		 	\n				\n			 				</tr><tr>\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dilluns&nbsp;&nbsp;12/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=12">12</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dimarts&nbsp;&nbsp;13/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=13">13</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dimecres&nbsp;&nbsp;14/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=14">14</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dijous&nbsp;&nbsp;15/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=15">15</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Divendres&nbsp;&nbsp;16/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=16">16</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF8484; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dissabte&nbsp;&nbsp;17/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#FFFFFF;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=17">17</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF8484; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Diumenge&nbsp;&nbsp;18/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#FFFFFF;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=18">18</a></span>\n				</td>\n						 		 	\n				\n			 				</tr><tr>\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dilluns&nbsp;&nbsp;19/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=19">19</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dimarts&nbsp;&nbsp;20/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=20">20</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dimecres&nbsp;&nbsp;21/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=21">21</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dijous&nbsp;&nbsp;22/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=22">22</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Divendres&nbsp;&nbsp;23/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=23">23</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF8484; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dissabte&nbsp;&nbsp;24/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#FFFFFF;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=24">24</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF8484; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Diumenge&nbsp;&nbsp;25/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#FFFFFF;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=25">25</a></span>\n				</td>\n						 		 	\n				\n			 				</tr><tr>\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dilluns&nbsp;&nbsp;26/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=26">26</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dimarts&nbsp;&nbsp;27/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=27">27</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dimecres&nbsp;&nbsp;28/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=28">28</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dijous&nbsp;&nbsp;29/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=29">29</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF9966; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Divendres&nbsp;&nbsp;30/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#669ACC;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=30">30</a></span>\n				</td>\n						 		 	\n				\n				\n							<td style="width:14.27%; background:#FF8484; text-align:center;" onmouseout="nd();" onmouseover="overlib(''Tercer trimestre<br /><br />No hi ha cap anotació en aquesta data<br />'', CAPTION, ''Dissabte&nbsp;&nbsp;31/03/2012'', BGCOLOR, ''#316ac5'', TIMEOUT, 100000, DELAY, 200, WIDTH, 200)">\n					<span style="color:#FFFFFF;"><a href="index.php?module=iw_agendas&amp;mes=3&amp;any=2012&amp;daid=0&amp;dia=31">31</a></span>\n				</td>\n							</tr>\n</table></div>', 10, '1331050073', 0, 'A', '1970-01-01 00:00:00', 0, '1970-01-01 00:00:00', 0),
(9, 'iw_agendas', 'month', '', 10, '1336233373', 0, 'A', '1970-01-01 00:00:00', 0, '1970-01-01 00:00:00', 0),
(10, 'iw_agendas', 'next', '<script language="JavaScript1.2">\r\n\r\n	//Translucent scroller- By Dynamic Drive\r\n	//For full source code and more DHTML scripts, visit http://www.dynamicdrive.com\r\n	//This credit MUST stay intact for use\r\n	\r\n	var scroller_width=''95%''\r\n	var scroller_height=''80px''\r\n	var bgcolor=''lightyellow''\r\n	var pause=3000 //SET PAUSE BETWEEN SLIDE (3000=3 seconds)\r\n	\r\n	var scrollercontent=new Array()\r\n	\r\n			var id=0\r\n		scrollercontent[id]=''No tens anotacions a l&acute;agenda per als propers 7 dies''\r\n	\r\n	////NO need to edit beyond here/////////////\r\n	\r\n	var ie4=document.all\r\n	var dom=document.getElementById&&navigator.userAgent.indexOf("Opera")==-1\r\n	\r\n	if (ie4||dom)\r\n	   document.write(''<div style="position:relative;width:''+scroller_width+'';height:''+scroller_height+'';overflow:hidden"><div id="canvas0" style="position:absolute;background-color:''+bgcolor+'';width:''+scroller_width+'';height:''+scroller_height+'';top:''+scroller_height+'';filter:alpha(opacity=20);-moz-opacity:0.2; padding: 5px;"></div><div id="canvas1" style="position:absolute;background-color:''+bgcolor+'';width:''+scroller_width+'';height:''+scroller_height+'';top:''+scroller_height+'';filter:alpha(opacity=20);-moz-opacity:0.2; padding: 5px;"></div></div>'')\r\n	else if (document.layers) {\r\n	   document.write(''<ilayer id=tickernsmain visibility=hide width=''+scroller_width+'' height=''+scroller_height+'' bgColor=''+bgcolor+''><layer id=tickernssub width=''+scroller_width+'' height=''+scroller_height+'' left=0 top=0>''+scrollercontent[0]+''</layer></ilayer>'')\r\n	}\r\n	\r\n	var curpos=scroller_height*(1)\r\n	var degree=10\r\n	var curcanvas="canvas0"\r\n	var curindex=0\r\n	var nextindex=1\r\n	\r\n	function moveslide(){\r\n	   if (curpos>0) {\r\n		  curpos=Math.max(curpos-degree,0)\r\n		  tempobj.style.top=curpos+"px"\r\n	   } else {\r\n		  clearInterval(dropslide)\r\n		  if (crossobj.filters)\r\n		  crossobj.filters.alpha.opacity=100\r\n		  else if (crossobj.style.MozOpacity)\r\n		  crossobj.style.MozOpacity=1\r\n		  nextcanvas=(curcanvas=="canvas0")? "canvas0" : "canvas1"\r\n		  tempobj=ie4? eval("document.all."+nextcanvas) : document.getElementById(nextcanvas)\r\n		  tempobj.innerHTML=scrollercontent[curindex]\r\n		  nextindex=(nextindex<scrollercontent.length-1)? nextindex+1 : 0\r\n		  setTimeout("rotateslide()",pause)\r\n	   }\r\n	}\r\n	\r\n	function rotateslide() {\r\n	   if (ie4||dom){\r\n		  resetit(curcanvas)\r\n		  crossobj=tempobj=ie4? eval("document.all."+curcanvas) : document.getElementById(curcanvas)\r\n		  crossobj.style.zIndex++\r\n		  if (crossobj.filters)\r\n		  document.all.canvas0.filters.alpha.opacity=document.all.canvas1.filters.alpha.opacity=20\r\n		  else if (crossobj.style.MozOpacity)\r\n		  document.getElementById("canvas0").style.MozOpacity=document.getElementById("canvas1").style.MozOpacity=0.2\r\n		  var temp=''setInterval("moveslide()",50)''\r\n		  dropslide=eval(temp)\r\n		  curcanvas=(curcanvas=="canvas0")? "canvas1" : "canvas0"\r\n	   }\r\n	   else if (document.layers){\r\n		  crossobj.document.write(scrollercontent[curindex])\r\n		  crossobj.document.close()\r\n	   }\r\n	   curindex=(curindex<scrollercontent.length-1)? curindex+1 : 0\r\n	}\r\n	\r\n	function resetit(what){\r\n	   curpos=parseInt(scroller_height)*(1)\r\n	   var crossobj=ie4? eval("document.all."+what) : document.getElementById(what)\r\n	   crossobj.style.top=curpos+"px"\r\n	}\r\n	\r\n	function startit(){\r\n	   crossobj=ie4? eval("document.all."+curcanvas) : dom? document.getElementById(curcanvas) : document.tickernsmain.document.tickernssub\r\n	   if (ie4||dom){\r\n		  crossobj.innerHTML=scrollercontent[curindex]\r\n		  rotateslide()\r\n		 crossobj.onclick=new Function("window.open(''index.php?module=iw_agendas'',''_parent'')");\r\n	   }else{\r\n		 document.tickernsmain.visibility=''show''\r\n		 curindex++\r\n		 setInterval("rotateslide()",pause)\r\n	   }\r\n	}\r\n	\r\n	// if (ie4||dom||document.layers)\r\n	// window.onload=startit\r\n	if (ie4||dom||document.layers) startit();\r\n	\r\n</script>\r\n\r\nEn els propers 7 dies\n<div style="height: 20px;"></div>\r', 10, '1331050073', 0, 'A', '1970-01-01 00:00:00', 0, '1970-01-01 00:00:00', 0),
(11, 'iw_jclic', 'jclicBlock', '\n\n	No tens accés a cap activitat Jclic\n<div style="height: 20px;">&nbsp;</div>', 10, '1331050323', 0, 'A', '1970-01-01 00:00:00', 0, '1970-01-01 00:00:00', 0),
(12, 'iw_qv', 'qvsummary', '', 10, '1331051373', 0, 'A', '1970-01-01 00:00:00', 0, '1970-01-01 00:00:00', 0);
INSERT INTO `zk_iw_main` (`iw_id`, `iw_module`, `iw_name`, `iw_value`, `iw_uid`, `iw_lifetime`, `iw_nult`, `pn_obj_status`, `pn_cr_date`, `pn_cr_uid`, `pn_lu_date`, `pn_lu_uid`) VALUES
(13, 'iw_vhmenu', 'userMenu', '<script type="text/javascript">\n		// HV Menu by Ger Versluis (http://www.burmees.nl/)\n		// Submitted to Dynamic Drive (http://www.dynamicdrive.com)\n		// Visit http://www.dynamicdrive.com for this script and more\n		function Go(){ return; }\n		var NoOffFirstLineMenus=5;		// Number of first level items\n		var LowBgColor=''#efedde'';						// Background color when mouse is not over\n		var LowSubBgColor=''#efedde'';					// Background color when mouse is not over on subs\n		var HighBgColor=''#b3cadb'';						// Background color when mouse is over\n		var HighSubBgColor=''#b3cadb'';				// Background color when mouse is over on subs\n		var FontLowColor=''#000000'';					// Font color when mouse is not over\n		var FontSubLowColor=''#000000'';				// Font color subs when mouse is not over\n		var FontHighColor=''#000000'';					// Font color when mouse is over\n		var FontSubHighColor=''#000000'';			// Font color subs when mouse is over\n		var BorderColor=''#ffffff'';						// Border color\n		var BorderSubColor=''#ffffff'';				// Border color for subs\n		var BorderWidth=1;						// Border width\n		var BorderBtwnElmnts=1;				// Border between elements 1 or 0\n		var FontFamily=''Tahoma, Verdana, Arial, Helvetica, sans-serif'';						// Font family menu items\n		var FontSize=9;								// Font size menu items\n		var FontBold=0;								// Bold menu items 1 or 0\n		var FontItalic=0;							// Italic menu items 1 or 0\n		var MenuTextCentered=''center'';			// Item text position ''left'', ''center'' or ''right''\n		var MenuCentered=''left'';					// Menu horizontal position ''left'', ''center'' or ''right''\n		var MenuVerticalCentered=''top'';	// Menu vertical position ''top'', ''middle'',''bottom'' or static\n		var ChildOverlap=0.1;						// horizontal overlap child/ parent\n		var ChildVerticalOverlap=0.1;		// vertical overlap child/ parent\n		var StartTop=120;								// Menu offset x coordinate\n		var StartLeft=10;							// Menu offset y coordinate\n		var VerCorrect=0;							// Multiple frames y correction\n		var HorCorrect=0;							// Multiple frames x correction\n		var LeftPaddng=3;							// Left padding\n		var TopPaddng=2;							// Top padding\n		var FirstLineHorizontal=1;		// SET TO 1 FOR HORIZONTAL MENU, 0 FOR VERTICAL\n		var MenuFramesVertical=1;			// Frames in cols or rows 1 or 0\n		var DissapearDelay=1000;					// delay before menu folds in\n		var TakeOverBgColor=1;				// Menu frame takes over background color subitem frame\n		var FirstLineFrame=''navig'';				// Frame where first level appears\n		var SecLineFrame=''space'';					// Frame where sub levels appear\n		var DocTargetFrame=''space'';				// Frame where target documents appear\n		var TargetLoc='''';							// span id for relative positioning\n		var HideTop=0;								// Hide first level when loading new document 1 or 0\n		var MenuWrap=1;								// enables/ disables menu wrap 1 or 0\n		var RightToLeft=0;						// enables/ disables right to left unfold 1 or 0\n		var UnfoldsOnClick=0;					// Level 1 unfolds onclick/ onmouseover\n		var WebMasterCheck=0;					// menu tree checking on or off 1 or 0\n		var ShowArrow=1;							// Uses arrow gifs when 1\n		var KeepHilite=1;							// Keep selected path highligthed\n		var Arrws=[''modules/iw_vhmenu/pnimages/tri.gif'',5,10,''modules/iw_vhmenu/pnimages/tridown.gif'',10,5,''modules/iw_vhmenu/pnimages/trileft.gif'',5,10];	// Arrow source, width and height\n		\n		function BeforeStart(){return}\n		function AfterBuild(){return}\n		function BeforeFirstOpen(){return}\n		function AfterCloseAll(){return}\nMenu1=new Array("Inici", "index.php", "", 0, 23, 80);\nMenu2=new Array("El meu compte", "index.php?module=Profile", "", 0, 24, 120);\nMenu3=new Array("Bústia", "index.php?module=iw_messages", "", 0, 24, 80);\nMenu4=new Array("Administració", "admin.php", "", 4, 24, 100);\nMenu4_1=new Array("Continguts", "index.php?module=Admin&type=admin&func=adminpanel&acid=4", "", 4, 24, 120);\nMenu4_1_1=new Array("Continguts", "index.php?module=content&type=admin", "", 0, 24, 150);\nMenu4_1_2=new Array("Descàrregues", "index.php?module=Downloads&type=admin", "", 0, 24, 120);\nMenu4_1_3=new Array("Notícies", "index.php?module=News&type=admin", "", 0, 24, 120);\nMenu4_1_4=new Array("Pàgines", "index.php?module=Pages&type=admin", "", 0, 24, 120);\nMenu4_2=new Array("Mòduls IW", "index.php?module=Admin&type=admin&func=adminpanel&acid=2", "", 12, 24, 120);\nMenu4_2_1=new Array("Agendes", "index.php?module=iw_agendas&type=admin", "", 0, 24, 120);\nMenu4_2_2=new Array("Fitxers del lloc", "index.php?module=Files", "", 0, 24, 120);\nMenu4_2_3=new Array("Formularis", "index.php?module=iw_forms&type=admin", "", 0, 24, 120);\nMenu4_2_4=new Array("Fòrums", "index.php?module=iw_forums&type=admin", "", 0, 24, 80);\nMenu4_2_5=new Array("Grups", "index.php?module=iw_groups&type=admin", "", 0, 24, 150);\nMenu4_2_6=new Array("Llibres", "index.php?module=iw_books&type=admin", "", 0, 24, 150);\nMenu4_2_7=new Array("Menú", "index.php?module=iw_vhmenu&type=admin", "", 0, 24, 60);\nMenu4_2_8=new Array("Missatges", "index.php?module=iw_messages&type=admin", "", 0, 24, 150);\nMenu4_2_9=new Array("Portal", "index.php?module=iw_webbox&type=admin", "", 0, 24, 150);\nMenu4_2_10=new Array("Reserves", "index.php?module=iw_bookings&type=admin", "", 0, 23, 150);\nMenu4_2_11=new Array("Tauler", "index.php?module=iw_noteboard&type=admin", "", 0, 24, 150);\nMenu4_2_12=new Array("Usuaris", "index.php?module=iw_users&type=admin", "", 0, 24, 120);\nMenu4_3=new Array("Sistema", "index.php?module=Admin&type=admin&func=adminpanel&acid=1", "", 4, 24, 120);\nMenu4_3_1=new Array("Blocs", "index.php?module=Blocks&type=admin", "", 0, 24, 120);\nMenu4_3_2=new Array("Configuració", "index.php?module=Settings&type=admin", "", 0, 24, 120);\nMenu4_3_3=new Array("Mòduls", "index.php?module=Modules&type=admin", "", 0, 24, 120);\nMenu4_3_4=new Array("Permisos", "index.php?module=permissions&type=admin&func=view", "", 0, 24, 120);\nMenu4_4=new Array("Utilitats", "index.php?module=Admin&type=admin&func=adminpanel&acid=5", "", 0, 24, 150);\nMenu5=new Array("Surt", "user.php?op=logout", "", 0, 24, 120);\n</script>\n<script type="text/javascript" src="modules/iw_vhmenu/javascript/menu_com.js"></script>\n', 10, '1331049973', 1, 'A', '1970-01-01 00:00:00', 0, '1970-01-01 00:00:00', 0),
(14, 'iw_main_block_news', 'have_news', '0', 10, '1336233385', 0, 'A', '1970-01-01 00:00:00', 0, '2012-03-06 15:56:25', 10),
(15, 'iw_main_block_flagged', 'have_flags', '0', 10, '1336233385', 0, 'A', '1970-01-01 00:00:00', 0, '2012-03-06 15:56:25', 10);
...
(56, '/PNConfig', 'sitename', 's:8:"Centre 2";'),
(58, '/PNConfig', 'slogan', 's:20:"Intranet de Centre 2";'),
(59, '/PNConfig', 'metakeywords', 's:95:"zikula, comunitat, portal, programari lliure, gestor de continguts, educació, intraweb, Àgora";'),
(61, '/PNConfig', 'startdate', 's:7:"03/2012";'),
(62, '/PNConfig', 'adminmail', 's:17:"a8000002@xtec.cat";'),
...
(116, '/PNConfig', 'sessionname', 's:6:"ZKSID2";'),
...
(181, '/PNConfig', 'log_last_rotate', 'i:1331049350;'),
(185, 'iw_main', 'url', 's:31:"http://phobos.xtec.cat/intraweb";'),
(186, 'iw_main', 'email', 's:17:"intraweb@xtec.cat";'),
(187, 'iw_main', 'documentRoot', 's:31:"/srv/www/agora/zkdata/usu2/data";'),
...
(344, 'downloads', 'screenshotlink', 's:54:"/srv/www/agora/zkdata/usu2/data/descarregues/captures/";'),
(345, 'downloads', 'upload_folder', 's:45:"/srv/www/agora/zkdata/usu2/data/descarregues/";'),
(346, 'downloads', 'captcha_cache', 's:51:"/srv/www/agora/zkdata/usu2/data/descarregues/cache/";'),
...
(374, 'downloads', 'notifymail', 's:17:"a8000002@xtec.cat";'),
...
(549, 'iw_main', 'URLBase', 's:33:"http://agora/agora/usu2/intranet/";'),
...
--
-- Bolcant dades de la taula `zk_session_info`
--

INSERT INTO `zk_session_info` (`pn_sessid`, `pn_ipaddr`, `pn_lastused`, `pn_uid`, `pn_remember`, `pn_vars`) VALUES
('s6fnqtu87l5d571i2259lk4m0i1mboit', 'bb645a76287f3dbccf9f33841bcd11aa', '2012-03-06 15:56:26', 0, 0, 'PNSVrand|a:1:{s:5:"users";s:34:"H=sxI8t~-[3|jKO-n}z#p4*M5U~Uzb$7}d";}PNSVuseragent|s:40:"3308672b8f947ad24e3b905d1077275c1e79fd82";PNSV_PNErrorMsg|a:0:{}PNSV_PNStatusMsg|a:1:{i:0;s:29:"No hi ha notícies publicades";}iwSecure|s:0:"";');
...
(10, 'xtecadmin', 'agora@xtec.cat', '1970-01-01 00:00:00', 0, '', '6142bfd56a583d891f0b1dcdbb2a9ef8', 5, 0, '', '', 0, 1, '2012-03-06 15:56:11', 0, 0, 1),
