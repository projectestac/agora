...
if (isset($_REQUEST['theme']) && !empty($_REQUEST['theme'])) { $theme = $_REQUEST['theme']; }
else { $theme = 'iw_xtec'; }
...
if (!file_exists($fileName)) {
	if ($type == 'css') { $fileName  = "themes/$theme/style/style.css"; }
	if ($type == 'logo') { $fileName  = "themes/$theme/images/logo.png"; }
	if ($type == 'footer') { $fileName  = "themes/$theme/templates/footer.htm"; }
}
