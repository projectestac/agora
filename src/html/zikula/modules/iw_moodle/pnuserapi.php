...
*/
function iw_moodle_userapi_getallpre_ins($args)
{
...
*/
function iw_moodle_userapi_delete_pre($args)
{
	$dom = ZLanguage::getModuleDomain('iw_moodle');
	// Security check
	if (!pnSecAuthAction( 0 , 'iw_moodle:coursesblock:' , "::" ,ACCESS_READ)){ 
	...
	// Delete item
	if (!DBUtil::deleteObjectByID('iw_moodle', $args['mid'], 'mid')) {
...
*/
function iw_moodle_userapi_is_enroled($args)
{
	$dom = ZLanguage::getModuleDomain('iw_moodle');
	// Security check
	if (!pnSecAuthAction( 0 , 'iw_moodle:coursesblock:' , "::" ,ACCESS_READ)){ 
...
*/
function iw_moodle_userapi_is_user($args)
{
	$dom = ZLanguage::getModuleDomain('iw_moodle');
	// Security check
	if (!pnSecAuthAction( 0 , 'iw_moodle:coursesblock:' , "::" ,ACCESS_READ)){ 
...
*/
function iw_moodle_userapi_getcourse($args)
{
	$dom = ZLanguage::getModuleDomain('iw_moodle');
	// Security check
	if (!pnSecAuthAction( 0 , 'iw_moodle:coursesblock:' , "::" ,ACCESS_READ)){ 
 ...
 * 
 * @author  Albert Perez Monfort (intraweb@xtec.cat)
 * @author  Toni Ginard
 * 
 * @param	 Username of the user in the intranet
 * 
 * @return  Array User information in Moodle
*/
function iw_moodle_userapi_getuserMDuid($args)
{
	// Security check
	if (!pnSecAuthAction( 0 , 'iw_moodle:coursesblock:' , "::" ,ACCESS_READ)){ 
		return false; 
...
*/
function iw_moodle_userapi_getusercourses($args)
{
	$dom = ZLanguage::getModuleDomain('iw_moodle');
	// Security check
	if (!pnSecAuthAction( 0 , 'iw_moodle:coursesblock:' , "::" ,ACCESS_READ)){ 
	...
	$user_array = pnModAPIFunc('iw_moodle','user','getuserMDuid',array('username' => $args['user']));
...
*/
function iw_moodle_userapi_is_preenroled($args)
{
	$dom = ZLanguage::getModuleDomain('iw_moodle');
	// Security check
	if (!pnSecAuthAction( 0 , 'iw_moodle:coursesblock:' , "::" ,ACCESS_READ)){ 
