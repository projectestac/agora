    ...
    while ($i<$p_size) {
      ...
      switch ($p_options_list[$i]) {
        ...
        case PCLZIP_OPT_ADD_PATH :
          ...
          if (($i+1) >= $p_size) {
            // ----- Error log
            PclZip::privErrorLog(PCLZIP_ERR_MISSING_OPTION__('Value', $dom), "Missing parameter value for option '".PclZipUtilOptionText($p_options_list[$i])."'");
        ...
        case PCLZIP_OPT_BY_NAME :
          ...
          if (is_string($p_options_list[$i+1])) {
            ...
            // ----- Error log
            PclZip::privErrorLog(PCLZIP_ERR_INVALID_OPTION__('Value', $dom), "Wrong parameter value for option '".PclZipUtilOptionText($p_options_list[$i])."'");
        ...
        case PCLZIP_OPT_PREPEND_COMMENT :
          ...
          if (($i+1) >= $p_size) {
            // ----- Error log
            PclZip::privErrorLog(PCLZIP_ERR_MISSING_OPTION__('Value', $dom),
          ...
          if (is_string($p_options_list[$i+1])) {
            ...
            // ----- Error log
            PclZip::privErrorLog(PCLZIP_ERR_INVALID_OPTION__('Value', $dom),
        ...
        case PCLZIP_OPT_BY_INDEX :
          ...
          if (is_string($p_options_list[$i+1])) {
            ...
            // ----- Error log
            PclZip::privErrorLog(PCLZIP_ERR_INVALID_OPTION__('Value', $dom), "Value must be integer, string or array for option '".PclZipUtilOptionText($p_options_list[$i])."'");
          ...
          for ($j=0; $j<sizeof($v_work_list); $j++) {
              ...
              elseif ($v_size_item_list == 2) {
                  ...
                  // ----- Error log
                  PclZip::privErrorLog(PCLZIP_ERR_INVALID_OPTION__('Value', $dom), "Too many values in index range for option '".PclZipUtilOptionText($p_options_list[$i])."'");
              ...
              if ($v_result_list[$p_options_list[$i]][$j]['start'] < $v_sort_value) {
                  ...
                  // ----- Error log
                  PclZip::privErrorLog(PCLZIP_ERR_INVALID_OPTION__('Value', $dom), "Invalid order of index range for option '".PclZipUtilOptionText($p_options_list[$i])."'");
        ...
        */
          ...
          if (!function_exists($v_function_name)) {
            // ----- Error log
            PclZip::privErrorLog(PCLZIP_ERR_INVALID_OPTION__('Value', $dom), "Function '".$v_function_name."()' is not an existing function for option '".PclZipUtilOptionText($p_options_list[$i])."'");
      ...
      switch ($v_key) {
        case PCLZIP_ATT_FILE_NAME :
          if (!is_string($v_value)) {
            PclZip::privErrorLog(PCLZIP_ERR_INVALID_ATTRIBUTE__('Value', $dom), "Invalid type ".gettype($v_value).". String expected for attribute '".PclZipUtilOptionText($v_key)."'");
            //--(MAGIC-PclTrace)--//PclTraceFctEnd(__FILE__, __LINE__, PclZip::errorCode(), PclZip::errorInfo());
            return PclZip::errorCode();
          }
          ...
          if ($p_filedescr['filename'] == '') {
            PclZip::privErrorLog(PCLZIP_ERR_INVALID_ATTRIBUTE__('Value', $dom), "Invalid empty filename for attribute '".PclZipUtilOptionText($v_key)."'");
            //--(MAGIC-PclTrace)--//PclTraceFctEnd(__FILE__, __LINE__, PclZip::errorCode(), PclZip::errorInfo());
            return PclZip::errorCode();
          }
        ...
        case PCLZIP_ATT_FILE_NEW_SHORT_NAME :
          ...
          if ($p_filedescr['new_short_name'] == '') {
            PclZip::privErrorLog(PCLZIP_ERR_INVALID_ATTRIBUTE__('Value', $dom), "Invalid empty short filename for attribute '".PclZipUtilOptionText($v_key)."'");
            //--(MAGIC-PclTrace)--//PclTraceFctEnd(__FILE__, __LINE__, PclZip::errorCode(), PclZip::errorInfo());
            return PclZip::errorCode();
          }
        break;
        ...
        case PCLZIP_ATT_FILE_NEW_FULL_NAME :
          ...
          if ($p_filedescr['new_full_name'] == '') {
            PclZip::privErrorLog(PCLZIP_ERR_INVALID_ATTRIBUTE__('Value', $dom), "Invalid empty full filename for attribute '".PclZipUtilOptionText($v_key)."'");
            //--(MAGIC-PclTrace)--//PclTraceFctEnd(__FILE__, __LINE__, PclZip::errorCode(), PclZip::errorInfo());
            return PclZip::errorCode();
          }
        break;
        ...
        case PCLZIP_ATT_FILE_MTIME :
          if (!is_integer($v_value)) {
            PclZip::privErrorLog(PCLZIP_ERR_INVALID_ATTRIBUTE__('Value', $dom), "Invalid type ".gettype($v_value).". Integer expected for attribute '".PclZipUtilOptionText($v_key)."'");
            //--(MAGIC-PclTrace)--//PclTraceFctEnd(__FILE__, __LINE__, PclZip::errorCode(), PclZip::errorInfo());
            return PclZip::errorCode();
          }
...
// TBC : Removed    $p_header['stored_filename'] = $v_stored_filename;
    ...
    if (isset($p_options[PCLZIP_CB_PRE_ADD])) {
      ...
      // header.
      eval('$v_result = '.$p_options[PCLZIP_CB_PRE_ADD].'(PCLZIP_CB_PRE__('Add', $dom), $v_local_header);');
      if ($v_result == 0) {
...
//      if (is_file($p_filename))
    ...
    if (isset($p_options[PCLZIP_CB_POST_ADD])) {
      ...
      // Here I do not use call_user_func() because I need to send a reference to the
      // header.
      eval('$v_result = '.$p_options[PCLZIP_CB_POST_ADD].'(PCLZIP_CB_POST__('Add', $dom), $v_local_header);');
      if ($v_result == 0) {
        // ----- Ignored
        $v_result = 1;
      }
    ...
    if (file_exists($p_entry['filename']))
    {
      ...
      if (is_dir($p_entry['filename']))
      {
        ...
        if (   (isset($p_options[PCLZIP_OPT_STOP_ON_ERROR]))
            ...
            PclZip::privErrorLog(PCLZIP_ERR_ALREADY_A__('Directory', $dom),
			                     "Filename '".$p_entry['filename']."' is "
