 ...
 */
function IWmoodle_adminapi_getallpreins($args) {
 ...
 */
function IWmoodle_adminapi_delete($args) {
    $dom = ZLanguage::getModuleDomain('IWmoodle');
    extract($args);
    // Security check
    if (!SecurityUtil::checkPermission('IWmoodle::', '::', ACCESS_ADMIN)) {
 ...
 * @return:	true if success
 */
function IWmoodle_adminapi_activate($args) {
    $dom = ZLanguage::getModuleDomain('IWmoodle');
    extract($args);
    // Security check
    if (!SecurityUtil::checkPermission('IWmoodle::', '::', ACCESS_ADMIN)) {
 ...
 */
function IWmoodle_adminapi_getallusersbyrole($args) {
    $dom = ZLanguage::getModuleDomain('IWmoodle');
    extract($args);
    // Security check
    if (!SecurityUtil::checkPermission('IWmoodle::', '::', ACCESS_ADMIN)) {
 ...
 */
function IWmoodle_adminapi_getallroles() {
    $dom = ZLanguage::getModuleDomain('IWmoodle');
    // Security check
    if (!SecurityUtil::checkPermission('IWmoodle::', '::', ACCESS_ADMIN)) {
        return LogUtil::registerPermissionError();
 ...
 */
function IWmoodle_adminapi_getuserPNuid($args) {
    // Security check
    if (!SecurityUtil::checkPermission('IWmoodle::', '::', ACCESS_ADMIN)) {
        return LogUtil::registerPermissionError();
    }
 ...
 * @return:	true if success
 */
function IWmoodle_adminapi_enrol_user($args) {
    $dom = ZLanguage::getModuleDomain('IWmoodle');
    extract($args);
    // Security check
    ...
    $enrolid = pnModAPIFunc('IWmoodle', 'admin', 'getEnrolId', array('courseid' => $course));
 ...
 */
function IWmoodle_adminapi_nombre($args) {
    $dom = ZLanguage::getModuleDomain('IWmoodle');
    extract($args);
    // Security check
    if (!SecurityUtil::checkPermission('IWmoodle::', '::', ACCESS_ADMIN)) {
 ...
 * @return:	true if success
 */
function IWmoodle_adminapi_change($args) {
    $dom = ZLanguage::getModuleDomain('IWmoodle');
    extract($args);
    // Security check
    if (!SecurityUtil::checkPermission('IWmoodle::', '::', ACCESS_ADMIN)) {
    ...
    if ($user_connect == 1) {
        ...
        $result = pnModAPIFunc('IWmoodle', 'admin', 'inscriu', array('uid' => $user_id));
    }
    if (!$result) {
        $connect->close();
        return LogUtil::registerError(__('Error! Update attempt failed.', $dom));
 ...
 * @return:	true if success
 */
function IWmoodle_adminapi_inscriu($args) {
    $dom = ZLanguage::getModuleDomain('IWmoodle');
    extract($args);
    // Security check
    if (!SecurityUtil::checkPermission('IWmoodle::', '::', ACCESS_ADMIN) && pnUserGetVar('uid') != $uid) {
        //return LogUtil::registerPermissionError();
    }
    if (!isset($uid)) {
    ...
    $dfl_description = (pnModGetVar('IWmoodle', 'dfl_description') != '') ? pnModGetVar('IWmoodle', 'dfl_description') : ' ';
    $dfl_language = (pnModGetVar('IWmoodle', 'dfl_language') != '') ? pnModGetVar('IWmoodle', 'dfl_language') : ' ';
    $dfl_country = (pnModGetVar('IWmoodle', 'dfl_country') != '') ? pnModGetVar('IWmoodle', 'dfl_country') : ' ';
    $dfl_city = (pnModGetVar('IWmoodle', 'dfl_city') != '') ? pnModGetVar('IWmoodle', 'dfl_city') : ' ';
    $dfl_gtm = (pnModGetVar('IWmoodle', 'dfl_gtm') != '') ? pnModGetVar('IWmoodle', 'dfl_gtm') : ' ';
    ...
    $userAdmin = pnModAPIFunc('IWmoodle', 'user', 'getuserMDuid', array('username' => 'admin'));
    // let's proceed
    $time = time();
    $sql = "INSERT INTO
 ...
 */
function IWmoodle_adminapi_getusers($args) {
    $dom = ZLanguage::getModuleDomain('IWmoodle');
    extract($args);
    // Security check
    $registres = array();
 ...
 * @return:	True if success
 */
function IWmoodle_adminapi_preenrol_user($args) {
    $dom = ZLanguage::getModuleDomain('IWmoodle');
    ...
    // Security check
    if (!pnSecAuthAction(0, 'IWmoodle::', "::", ACCESS_ADMIN)) {
        return false;
    }
 ...
 * @return:	True if success
 */
function IWmoodle_adminapi_getMoodleUsers($args) {
    $dom = ZLanguage::getModuleDomain('IWmoodle');
    extract($args);
    // Security check
    $registres = array();
 ...
 */
function IWmoodle_adminapi_createUser($args) {
    $dom = ZLanguage::getModuleDomain('IWmoodle');
