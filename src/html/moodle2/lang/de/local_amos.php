...
/**
 * Strings for component 'local_amos', language 'de', branch 'MOODLE_23_STABLE'
 *
 * @package   local_amos
...
$string['amos:importfile'] = 'Datei hochladen und Texte importieren';
...
$string['confirmaction'] = 'Sind Sie sicher, dass dieser Vorgang ausgeführt werden soll?';
...
$string['diffmode1'] = 'Der englische Text wurde verändert, aber nicht die Übersetzung';
$string['diffmode2'] = 'Der englische Text wurde nicht verändert, aber die Übersetzung';
$string['diffmode3'] = 'Entweder wurde der englische Text verändert oder die Übersetzung (aber nicht beides)';
$string['diffmode4'] = 'Sowohl der englische Text wie auch die Übersetzung wurden geändert';
