...
/**
 * Strings for component 'quizaccess_openclosedate', language 'ca', branch 'MOODLE_23_STABLE'
 *
...
$string['pluginname'] = 'Regla d\'accés al qüestionari per data d\'apertura i tancament';
