...
/**
 * Strings for component 'portfolio_picasa', language 'ca', branch 'MOODLE_23_STABLE'
 *
...
$string['nooauthcredentials_help'] = 'Per utilitzar el connector de portafolis de Picasa heu de configurar les credencials OAuth en la configuració del portafolis.';
$string['oauth2upgrade_message_content'] = 'Com a part de l\'actualització a Moodle 2.3, el connector de portafolis de Picasa s\'ha desactivat. Per tornar a activar-lo, el vostre lloc Moodle ha d\'estar registrat amb Google, tal i com es descriu en la documentació {$a->docsurl}, per tal d\'obtenir un ID de client secret. L\'ID de client secret podrà utilitzar-se llavors per configurar tots els connectors Google Docs i Picasa.';
...
$string['oauth2upgrade_message_subject'] = 'Informació important quant al connector de portafolis de Picasa';
