...
/**
 * Strings for component 'mimetypes', language 'es', branch 'MOODLE_23_STABLE'
 *
 * @package   mimetypes
...
$string['application/vnd.openxmlformats-officedocument.presentationml.slideshow'] = 'proyección PowerPoint';
$string['application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'] = 'hoja de cálculo de Excel';
$string['application/vnd.openxmlformats-officedocument.spreadsheetml.template'] = 'plantilla de Excel';
$string['application/vnd.openxmlformats-officedocument.wordprocessingml.document'] = 'documento de Word';
