...
/**
 * Strings for component 'hub', language 'fr', branch 'MOODLE_23_STABLE'
 *
 * @package   hub
...
$string['registeredon'] = 'Serveurs d\'échange où votre site est enregistré';
$string['registeredsites'] = 'Sites enregistrés';
$string['registermoochtips'] = 'Pour être enregistré sur le serveur d\'échange Moodle.org Open Community Hub (MOOCH), votre site doit être enregistré sur Moodle.org.';
$string['registersite'] = 'Enregistrer sur {$a}';
$string['registerwith'] = 'S\'enregistrer sur un serveur d\'échange';
