...
/**
 * Strings for component 'admin', language 'fr', branch 'MOODLE_23_STABLE'
 *
 * @package   admin
...
$string['configgooglemapkey'] = 'Vous devez saisir une clef spéciale pour utiliser Google Maps pour la localisation des adresses IP. Vous pouvez obtenir gratuitement une telle clef sur <a href="https://developers.google.com/maps/documentation/javascript/v2/introduction#Obtaining_Key">https://developers.google.com/maps/documentation/javascript/v2/introduction#Obtaining_Key</a>.<br />.<br />L\'URL de votre site est {$a}';
...
$string['confignavshowallcourses'] = 'Si ce réglage est activé, les cours auxquels sont inscrits les utilisateurs seront affichés dans Mes cours, ainsi que dans l\'arbre de tous les cours. Dans le cas contraire, ces cours ne seront affichés que dans Mes cours.';
...
$string['googlemapkey'] = 'Clef de Google Maps API v2';
...
$string['updatenotificationsubject'] = 'Il n\'y a pas de mise à jour disponible pour votre site Moodle';
