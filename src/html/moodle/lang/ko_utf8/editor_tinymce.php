...
$string['common:clipboard_msg'] = '복사/잘라내기/붙이기는 Mozilla 및Firefox 에서 사용되지 않습니다.\\n상세정보를 표시합니까?';
...
$string['iespell:download'] = 'ieSpell이 발견되지 않았습니다.\\n인스톨 하시겠습니까?';
...
$string['table_dlg:cell_cell'] = '현재의 셀을 갱신';
$string['table_dlg:cell_row'] = '행의 전셀을 갱신';
$string['table_dlg:cell_all'] = '테이블의 모든 셀을 갱신';
$string['table_dlg:row_row'] = '현재의 행을 갱신';
$string['table_dlg:row_odd'] = '홀수행을 갱신';
$string['table_dlg:row_even'] = '짝수행을 갱신';
$string['table_dlg:row_all'] = '전행을 갱신';
...
$string['template_dlg:warning'] = '경고: 템플릿을 갱신하면 이전의 데이터는 없어집니다.';
...
$string['advanced:clipboard_msg'] = '복사/잘라내기/붙이기는 Mozilla 및Firefox 에서 사용되지 않습니다.\\n상세정보를 표시합니까?';
...
$string['advanced_dlg:about_license'] = '라이센스';
...
$string['advanced_dlg:link_is_email'] = '메일주소가 입력되었습니다.\\n메일주소의 앞에 mailto:를 붙입니까?';
$string['advanced_dlg:link_is_external'] = '외부URL이 입력되었습니다.\\nURL의 앞에 http://를 붙입니까?';
