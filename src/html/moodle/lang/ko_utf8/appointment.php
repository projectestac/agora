<?PHP // $Id$ 
      // appointment.php - created with Moodle 1.7 dev (2006092800)


$string['allowresubmit'] = '재제출 허용';
$string['appointmentdetails'] = '자세한 약속';
...
$string['newsubmissions'] = '약속 제출됨';
$string['notgradedyet'] = '아직 등급 없음';
$string['notsubmittedyet'] = '아직 제출되지 않음';
$string['overwritewarning'] = '경고 : 다시 전송한다면 최근 제출한 것이 지금 올린 것으로 대체됩니다.';
$string['saveallfeedback'] = '나의 피드백을 모두 저장하기';
$string['submissionfeedback'] = '피드팩 제출';
$string['submissions'] = '제출하기';
$string['submitappointment'] = '이 형식에 맞게 약속을 제출하세요';
$string['submitted'] = '제출됨';
$string['timeend'] = '약속 끝';
$string['timestart'] = '약속 시작';
$string['typeoffline'] = '오프라인 제출';
$string['typeuploadsingle'] = '하나의 파일 제출';
$string['uploadbadname'] = '파일이름이 이상한 문자를 포함하고 있어 전송할 수 없습니다.';
$string['uploadedfiles'] = '업로드된 파일들';
$string['uploaderror'] = '서버에 파일을 저장하는 동안 오류가 생겼습니다.';
$string['uploadfailnoupdate'] = '파일은 전송되었으나 당신의 제출기록이 갱신되지 않았습니다.';
$string['uploadfiletoobig'] = '죄송합니다. 파일이 너무 큽니다.(제한용량은 $a 바이트입니다)';
$string['uploadnofilefound'] = '파일을 찾을 수가 없습니다. - 업로드할 것을 선택했는지 확인해 주십시오.';
