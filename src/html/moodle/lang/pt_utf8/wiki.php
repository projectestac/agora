<?PHP // $Id$ 
      // wiki.php - created with Moodle 2.0 dev (2007101506)


$string['action'] = '-- Acção --';
$string['administration'] = 'Administação';
$string['allowremovepages'] = 'Permitir \'apagar páginas\'';
$string['allowrevertchanges'] = 'Permitir \'desfazer alterações em massa\'';
$string['allowsetpage'] = 'Permitir \'colocar inidicadores de página\'';
$string['allowstrippages'] = 'Permitir \'purgar páginas\'';
...
$string['disablecamel'] = 'Desactivar apontadores \'CamelCase\'';
$string['disabledpage'] = 'Esta página não está disponível actualmente';
$string['doesnotexist'] = 'Esta página ainda não existe; por favor clique no botão de edição se quiser criá-la agora.';
$string['downloadaszip'] = 'Arquivo zip descarregável';
...
$string['filtername'] = 'Criação automática de apontadores entre páginas Wiki';
$string['flagbin'] = 'BIN';
$string['flaghtm'] = 'HTML';
$string['flagoff'] = 'OFF';
$string['flagro'] = 'RO';
...
$string['linkok'] = 'OK';
$string['linkschecked'] = 'Apontadores verificados';
$string['listall'] = 'Listar todo';
$string['listcandidates'] = 'Listar candidatos';
$string['lockcancelled'] = 'O bloqueio de edição foi sobreposto e alguém está a editar esta página. Se deseja manter as suas alterações, por favor seleccione e copie-as antes de clicar em \"CANCELAR\"; depois tente editar de novo.';
...
$string['nojslockwarning'] = 'Porque o Javasript está desactivado no seu navegador, é possivel que alguém possa editar esta página. Se isso acontecer, não poderá gravar as suas alterações. Por favor, tente ser breve na sua edição, ou active o Javascript e aceda novamente esta página.';
...
$string['of'] = 'de';
$string['offline'] = 'Sem ligação à rede';
...
$string['overrideinfo'] = 'Pode sobrepor o bloqueio deste utilizador, mas ao fazê-lo pode fazer com que perca as suas alterações. Por favor tenha cuidado.';
...
$string['reloadlinkdescription'] = 'Descarrega novamente a página, para que qualquer conteúdo novo seja apresentado.';
$string['reloadlinktext'] = 'Descarregar novamente esta página';
...
$string['updatedwikipages'] = 'Actualizar páginas do wiki';
...
$string['upload0'] = 'Use este formulário para enviar um ficheiro binário arbitrário para o wiki.';
...
$string['wrongversionrange'] = '$a não é um intervalo de valores  correcto!';
