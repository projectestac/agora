<?PHP // $Id$ 
      // wiki.php - created with Moodle 1.9.6 (Build: 20091021) (2007101560)
...
$string['author'] = 'Автор';
$string['authorfieldpattern'] = 'Шаблон поля Автор';
...
$string['howtooperate'] = 'Как выполнять действия';
...
$string['lockcancelled'] = 'Ваша блокировка записи была перекрыта и кто-то другой в данный момент редактирует эту страницу. Если Вы хотите сохранить изменения, пожалуйста, выделите и скопируйте их перед тем как нажать Отмена; после этого попробуйте редактировать снова.';
...
$string['nojslockwarning'] = 'Поскольку Javascript в Вашем браузере отключен, возможно что кто-то другой может редактировать эту страницу. Если это случится, Вы не сможете сохранить свои изменения. Пожалуйста, попытайтесь внесите свои изменения как можно быстрее, или включите Javascript и обновите страницу.';
...
$string['offline'] = 'ОТКЛЮЧЕНО';
$string['optional'] = 'Опционально';
$string['orphanedpage'] = 'Одинокая страница';
$string['orphanedpages'] = 'Одинокие страницы';
$string['otherwikis'] = 'Другие Wiki';
$string['overridebutton'] = 'Перекрыть блокировку';
$string['overrideinfo'] = 'Вы можете перекрыть блокировку этого пользователя, однако из за этого он может потерять сделанные им изменения! Пожалуйста, будьте аккуратны.';
...
$string['pagelocked'] = '<p><strong>Эта страница редактируется $a->name.</strong> Он начал редактирование в $a->since и до сих пор не закрыл окно $a->seen.</p><p>Вы сможете редактировать эту страницу только после того, как это закончит делать он.</p>';
...
$string['refs'] = 'Ссылки';
$string['reloadlinkdescription'] = 'Обновите страницу, чтобы увидеть новое содержимое';
$string['reloadlinktext'] = 'Обновить страницу';
...
$string['revertallsince'] = 'Откатить версию так же отменить все последующие изменения';
...
$string['revertthe'] = 'Откатить версию, но обрабатывать только затронутые ей изменения';
$string['safehtml'] = 'Безопасный HTML';
$string['save'] = 'Сохранить';
$string['savenolock'] = 'Вы не можете сохранить страницу, поскольку не имеете блокировки редактирования. Это может случиться, если Javascript в Вашем браузере отключен, или кто-то другой переопределил Вашу блокировку.<br/><br/> Вы можете возвратиться к предыдущему окну, используя кнопку \"Назад\" Вашего браузера и скопировать текст всех сделанных Вами изменений. После этого снова попробуйте редактировать.';
$string['searchwiki'] = 'Искать Wiki';
$string['setpageflags'] = 'Установить флаги для страницы';
$string['showversions'] = 'Показать версии:';
...
$string['wiki:manage'] = 'Изменение настроек wiki';
$string['wiki:overridelock'] = 'Перекрывать блокировки страниц';
$string['wiki:participate'] = 'Править вики страницы';
$string['wikidefaultpagename'] = 'Wiki страница по умолчанию';
