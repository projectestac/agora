...
$string['binaryincorrectlength'] = 'Λάθος μήκος δυαδικού πεδίου';
...
$string['confirmdeletesentence'] = 'Θέλετε σίγουρα να διαγράψετε την πρόταση';
$string['confirmdeletestatement'] = 'Θέλετε σίγουρα να διαγράψετε τη φράση και όλες τις προτάσεις της:';
...
$string['delete_sentence'] = 'Διαγραφή Πρότασης';
$string['delete_statement'] = 'Διαγραφή Φράσης';
...
$string['edit_sentence'] = 'Επεξεργασία Πρότασης';
$string['edit_statement'] = 'Επεξεργασία Φράσης';
...
$string['missingfieldsinsentence'] = 'Ελλιπή πεδία στην πρόταση';
$string['missingindexes'] = 'Βρέθηκαν ευρετήρια να λείπουν';
$string['missingvaluesinsentence'] = 'Ελλιπείς τιμές στην πρόταση';
...
$string['mysqlextracheckbigints'] = 'Αν χρησιμοποιείτε MySQL γίνεται επιπλέον και έλεγχος για λάθος προσημασμένους αριθμούς, κατόπιν του οποίου δημιουργείται αυτόματα η κατάλληλες εντολές SQL με τις οποίες οι παραπάνω μπορούν να αποκατασταθούν.';
$string['new_statement'] = 'Νέα Πρόταση';
...
$string['newsentence'] = 'Νέα Πρόταση';
$string['newstatement'] = 'Νέα Φράση';
...
$string['sentences'] = 'Προτάσεις';
$string['statements'] = 'Φράσεις';
$string['statementtable'] = 'Πίνακας Φράσης:';
$string['statementtype'] = 'Τύπος Φράσης:';
$string['table'] = 'Πίνακας';
$string['tables'] = 'Πίνακες';
$string['test'] = 'Τεστ';
$string['textincorrectlength'] = 'Λάθος μήκος πεδίου κειμένου';
...
$string['wrongnumberoffieldsorvalues'] = 'Λάθος αριθμός πεδίων ή τιμών στην πρόταση';
