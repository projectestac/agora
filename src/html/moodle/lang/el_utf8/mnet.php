...
$string['authmnetautoadddisabled'] = 'Η <em>αυτόματη προσθήκη χρηστών</em> στην υπομονάδα λογισμικού Πιστοποίησης Δικτύωσης Moodle είναι <strong>απενεργοποιημένη</strong>.';
...
$string['editenrolments'] = 'εγγραφή';
$string['enabled_for_all'] = '(Αυτή η υπηρεσία έχει ενεργοποιηθεί για όλους τους κεντρικούς υπολογιστές).';
$string['enrolcourseenrol_desc'] = 'Εγγραφή/Απεγγραφή χρηστών από αυτό το μάθημα με την χρήση εγγραφών Δικτύου Moodle.
                                    Σημειώστε οτι οι χρήστες μπορεί να έχουν εγγραφεί σε αυτό το μάθημα μέσω άλλης μεθόδου
                                    εγγραφής εάν το επιτρέπουν οι απομακρυσμένοι κεντρικοί υπολογιστές. Τέτοιες εγγραφές αναφέρονται υπό το
                                    <em>Άλλοι εγγεγραμμένοι χρήστες</em>';
$string['enrolcourses_desc'] = 'Μαθήματα τα οποία προσφέρονται για απομακρυσμένη εγγραφή από αυτόν τον κεντρικό υπολογιστή.';
$string['enrollingincourse'] = 'Εγγραφή στο μάθημα $a[0] στον κεντρικό υπολογιστή $a[1]<br />';
...
$string['illegalchar-host'] = 'Το όνομα του κεντρικού υπολογιστή σας περιέχει τον μη έγκυρο χαρακτήρα: $a';
$string['illegalchar-moodlehome'] = 'Η τοποθεσία του Moodle σας περιέχει μη έγκυρους χαρακτήρες';
...
$string['nohostid'] = 'Αυτή η σελίδα απαιτεί ένα αναγνωριστικό κεντρικού υπολογιστή, το οποίο θα έπρεπε να είναι ένας ακέραιος.';
$string['noipmatch'] = 'Η διεύθυνση του απομακρυσμένου υπολογιστή: <br /><em>$a[0]</em><br />δεν αντιστοιχεί αυτή στην εγγραφή:<br /><em>$a[1]</em>.';
...
$string['remoteenrolhosts_desc'] = 'Εγγράψτε και απεγγράψτε χρήστες από την εγκατάσταση του Moodle σας
...
$string['remotemoodles'] = 'Απομακρυσμένα Moodle';
...
$string['themesavederror'] = 'Συνέβη ένα σφάλμα: Η αλλαγή του θέματος δεν αποθηκεύθηκε';
