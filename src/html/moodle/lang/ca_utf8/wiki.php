...
$string['overrideinfo'] = 'Podeu deixar de banda el blocatge d\'aquest usuari, però si feu això podeu provocar que perdi els seus canvis. Procediu amb cura.';
...
$string['pagelocked'] = '<p><strong>Aquesta pàgina l\'està editant $a->name.</strong> Ha començat a editar-la en $a->since i encara té la finestra oberta en $a->seen.</p><p>Haureu d\'esperar que acabi abans d\'editar la pàgina.</p>';
...
$string['save'] = 'Desa';
$string['savenolock'] = 'No podeu desar la pàgina perquè no teniu un blocatge d\'edició. Això pot passar perquè el vostre navegador tingui desactivat el Javascript o perquè un altre usuari hagi deixat de banda el vostre blocatge.<br /><br />Podeu tornar a la pantalla anterior amb el botó Enrere del navegador i copiar el text amb els canvis que hàgiu fet, i després proveu a editar de nou.';
