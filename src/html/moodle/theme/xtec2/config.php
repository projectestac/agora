...
$moodledata_root = '../../../../docs/';

$THEME->sheets = array('styles_layout', 'styles_fonts', 'styles_color', 'styles_css3');

/*if(file_exists($CFG->dataroot.'/theme/1/styles_personal.css')){
   array_push($THEME->sheets, $moodledata_root.$CFG->dbuser.'/theme/styles_personal');
}*/
...
$THEME->custompix = isset($CFG->custompix) ? $CFG->custompix : true;
