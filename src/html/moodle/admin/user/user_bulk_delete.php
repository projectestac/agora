...
if ($confirm and confirm_sesskey()) {
    ...
    //XTEC ************ MODIFICAT - To warn that the deleting of a large number of user does not work
    //2010.06.30
    if(count($userlist) > 100){
    	notice_yesno(get_string('deletecheckfull', '', $usernames) . get_string('deletebulkusers', ''), 'user_bulk_delete.php', 'user_bulk.php', $optionsyes, NULL, 'post', 'get');	
    }
    else{
