...
//XTEC-UPCnet: canviar nom de format
$string['formatsenzill']='Simple Topics format'; // Name to display for format
$string['namesenzill']='topics'; // Name of a section within your format
//XTEC-UPCnet: canviar nom de format
$string['senzill_icon']='Icon for simple format'; // Name of a section within your format
...
$string['math']='Maths';
$string['self']='Self discovering';
$string['music']='Music';
$string['environment']='Enviromental discoverint';
$string['visual']='Arts';
