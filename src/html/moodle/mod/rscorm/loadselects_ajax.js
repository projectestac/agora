	...
	if (levelid!=undefined){
	    var callback = {
	    	...
	    	failure: function(o) {/*failure handler code*/ 
	            ...
	            var url=ajax_config.wwwroot +  '/mod/rscorm/loadselects_ajax.php?action=ajaxresponseerror&bookid='+levelid+'&sesskey=' + ajax_config.sesskey;
	    ...
	    var url=ajax_config.wwwroot +  '/mod/rscorm/loadselects_ajax.php?action=parametererror&bookid='+levelid+'&sesskey=' + ajax_config.sesskey;
	    if(ajax_config.cmid!=undefined) url+='&cmid='+ajax_config.cmid;
        YAHOO.util.Connect.asyncRequest('GET', url);
    }
}
	...
	if (bookid!=undefined){
	    var callback = {
	    	...
	    	failure: function(o) {/*failure handler code*/ 
	        	alert(ajax_config.ajaxresponseerror);
	        	//save error in bd by ajax
	            var url=ajax_config.wwwroot +  '/mod/rscorm/loadselects_ajax.php?action=ajaxresponseerror&bookid='+bookid+'&sesskey=' + ajax_config.sesskey;
	            if(ajax_config.cmid!=undefined) url+='&cmid='+ajax_config.cmid;
	            YAHOO.util.Connect.asyncRequest('GET', url);
	        }
	   	};
		...
		//save error in bd by ajax
		alert(ajax_config.parametererror);
	    var url=ajax_config.wwwroot +  '/mod/rscorm/loadselects_ajax.php?action=parametererror&bookid='+bookid+'&sesskey=' + ajax_config.sesskey;
	    if(ajax_config.cmid!=undefined) url+='&cmid='+ajax_config.cmid;
        YAHOO.util.Connect.asyncRequest('GET', url);
    }
}
...
function fill_select(id,o){
    ...
    if(o.responseText!='[""]'){
        ...
        try{
            ...
            //save error in bd by ajax
    		var url=ajax_config.wwwroot +  '/mod/rscorm/loadselects_ajax.php?action=jsonerror&bookid='+bookid+'&sesskey=' + ajax_config.sesskey;
    		if(ajax_config.cmid!=undefined) url+='&cmid='+ajax_config.cmid;
            YAHOO.util.Connect.asyncRequest('GET', url);
            return;
        }
