...
<body>
    <p>The Moodle release you are using is: <b> <?php echo $release; ?> </b>
    ...
    <p>Your php version: <b> <?php echo phpversion(); ?> </b>
        <span style="color: red;">&nbsp;
        <?php
    ...
    <p>Your database charset is: <b> <?php echo $charset=get_string('thischarset'); ?> </b>
        <span style="color: red;">&nbsp;
        <?php
    ...
    <b> Testing the database charset support</b> <br>You should see an alpha in both cases
        <?php
